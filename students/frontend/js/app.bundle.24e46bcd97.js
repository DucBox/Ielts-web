...
`),n=[];let i=null;const s=()=>{i&&(n.push(`</${i}>`),i=null)};for(const o of e){const a=o.trim();if(!a){s();continue}const l=a.match(/^[-*]\s+(.+)$/),r=a.match(/^\d+\.\s+(.+)$/);if(l||r){const u=l?"ul":"ol";i!==u&&(s(),n.push(`<${u}>`),i=u),n.push(`<li>${renderMarkdownInline((l||r)[1])}</li>`);continue}s();const c=a.match(/^(#{2,4})\s+(.+)$/);c?n.push(`<h5>${renderMarkdownInline(c[2])}</h5>`):n.push(`<p>${renderMarkdownInline(a)}</p>`)}return s(),n.join("")}function btnReset(t){t&&(t.disabled=!1,t.innerHTML=t._origHTML||t.innerHTML)}function micErrorMessageVi(t){const e=t?.name||"";return e==="NotAllowedError"||e==="SecurityError"?"Tr\xECnh duy\u1EC7t \u0111ang ch\u1EB7n quy\u1EC1n truy c\u1EADp microphone. H\xE3y v\xE0o ph\u1EA7n c\xE0i \u0111\u1EB7t trang web (bi\u1EC3u t\u01B0\u1EE3ng kho\xE1/camera tr\xEAn thanh \u0111\u1ECBa ch\u1EC9), cho ph\xE9p Micro, r\u1ED3i t\u1EA3i l\u1EA1i trang.":e==="NotFoundError"||e==="DevicesNotFoundError"?"Kh\xF4ng t\xECm th\u1EA5y microphone tr\xEAn thi\u1EBFt b\u1ECB n\xE0y. H\xE3y ki\u1EC3m tra mic \u0111\xE3 c\u1EAFm/b\u1EADt ch\u01B0a r\u1ED3i th\u1EED l\u1EA1i.":e==="NotReadableError"||e==="TrackStartError"?"Kh\xF4ng th\u1EC3 m\u1EDF microphone \u2014 c\xF3 th\u1EC3 m\u1ED9t \u1EE9ng d\u1EE5ng kh\xE1c \u0111ang d\xF9ng mic. H\xE3y \u0111\xF3ng \u1EE9ng d\u1EE5ng \u0111\xF3 r\u1ED3i th\u1EED l\u1EA1i.":e==="OverconstrainedError"?"Microphone hi\u1EC7n t\u1EA1i kh\xF4ng \u0111\xE1p \u1EE9ng \u0111\u01B0\u1EE3c y\xEAu c\u1EA7u ghi \xE2m. H\xE3y th\u1EED \u0111\u1ED5i mic kh\xE1c n\u1EBFu c\xF3.":e==="AbortError"?"Qu\xE1 tr\xECnh m\u1EDF microphone b\u1ECB gi\xE1n \u0111o\u1EA1n. Vui l\xF2ng th\u1EED l\u1EA1i.":"Kh\xF4ng th\u1EC3 truy c\u1EADp microphone. H\xE3y ki\u1EC3m tra quy\u1EC1n truy c\u1EADp mic c\u1EE7a tr\xECnh duy\u1EC7t r\u1ED3i th\u1EED l\u1EA1i."}function toast(t,e="success"){const n=e==="error"?6e3:3500,i=document.createElement("div");i.className=`toast toast-${e}`,i.setAttribute("role","alert");const s=document.createElement("span");s.textContent=t;const o=document.createElement("button");o.className="toast-close",o.setAttribute("aria-label","\u0110\xF3ng th\xF4ng b\xE1o"),o.textContent="\xD7",o.onclick=()=>i.remove(),i.appendChild(s),i.appendChild(o),i.addEventListener("mouseenter",()=>i.classList.add("toast-paused")),i.addEventListener("mouseleave",()=>i.classList.remove("toast-paused")),$("#toast-container").appendChild(i);const a=setTimeout(()=>i.remove(),n);i.addEventListener("mouseenter",()=>clearTimeout(a)),i.addEventListener("mouseleave",()=>setTimeout(()=>i.remove(),1e3))}function setLoading(t="\u0110ang t\u1EA3i..."){$("#app").innerHTML=`
  ...
  </div>`}function repairImageTokensInBlocks(t){let e=0;function n(){return`cb-repair-${++e}`}const i=[];for(const a of t){let c=function(){const d=r.innerHTML.replace(/^(<br\s*\/?>)+|(<br\s*\/?>)+$/gi,"").trim();d&&i.push({id:n(),type:"text",html:d,text:""}),r=document.createElement("div")},u=function(d){d.nodeType===Node.ELEMENT_NODE&&d.classList?.contains("document-editor-image-token")?(c(),i.push({id:d.dataset.blockId||n(),type:"image",url:d.dataset.url||"",alt:d.dataset.alt||"",width:Math.max(1,Number(d.dataset.width)||100)})):d.nodeType===Node.ELEMENT_NODE&&d.querySelector?.(".document-editor-image-token")?d.childNodes.forEach(m=>u(m)):r.appendChild(d.cloneNode(!0))};var s=c,o=u;if(a.type!=="text"||!a.html?.includes("document-editor-image-token")){i.push(a);continue}const l=document.createElement("div");l.innerHTML=a.html;let r=document.createElement("div");l.childNodes.forEach(d=>u(d)),c()}return i}function normalizeIndentMarkupHtml(t=""){if(!t)return"";const e=document.createElement("div");e.innerHTML=String(t);const n=new Set(["DIV","P","LI","H1","H2","H3","H4","H5","H6","BLOCKQUOTE","PRE"]),i=a=>Array.from({length:Math.max(1,Number(a)||1)},()=>'<span class="document-editor-indent" contenteditable="false" data-indent="1">&nbsp;</span>').join(""),s=(a="")=>{let l=0,r=0,c=0;for(;r<a.length;){const u=a[r];if(u==="	"){if(c)break;l+=1,r+=1;continue}if(u===" "||u==="\xA0"){c+=1,r+=1,c===4&&(l+=1,c=0);continue}break}return r-=c,{units:l,consumedChars:r}},o=a=>{if(!a?.childNodes)return!0;let l=!0;return Array.from(a.childNodes).forEach(r=>{if(r.nodeType===Node.TEXT_NODE){const c=String(r.textContent||"");if(l&&c){const{units:u,consumedChars:d}=s(c);if(u>0){const m=document.createDocumentFragment();m.appendChild(document.createRange().createContextualFragment(i(u)));const p=c.slice(d);p&&m.appendChild(document.createTextNode(p)),r.replaceWith(m),l=!p||!/[^\s\u00a0]/.test(p);return}}/[^\s\u00a0]/.test(c)&&(l=!1);return}if(r.nodeType===Node.ELEMENT_NODE){if(r.tagName==="BR"){l=!0;return}if(!r.classList.contains("document-editor-indent")){if(n.has(r.tagName)){o(r),l=!0;return}l=o(r)}}}),l};return e.querySelectorAll("span").forEach(a=>{const l=String(a.textContent||"").replace(/ /g,"").replace(/\n/g,""),r=l&&/^[\u00a0\t]+$/.test(l),c=/display\s*:\s*inline-block/i.test(a.getAttribute("style")||"");if(!a.classList.contains("document-editor-indent")&&!(c&&r))return;const u=Math.max(1,Math.round(l.length/4)||1);a.replaceWith(document.createRange().createContextualFragment(i(u)))}),o(e),e.innerHTML}function normalizeQuestionContentBlocks(t,e=""){const i=repairImageTokensInBlocks(Array.isArray(t)?t:[]).map((s,o)=>s?.type==="image"&&s?.url?{id:s.id||`cb-${o+1}`,type:"image",url:s.url,alt:s.alt||"",width:Number(s.width)||100}:{id:s?.id||`cb-${o+1}`,type:"text",html:normalizeIndentMarkupHtml(s?.html??(s?.text?escapeHtml(String(s.text)):"")),text:String(s?.text||"")}).filter(Boolean);return i.length>0?i:[{id:"fallback-text",type:"text",html:escapeHtml(e||""),text:e||""}]}function renderQuestionContentHTML(t,e="",n=""){const i=normalizeQuestionContentBlocks(t,e);return`
  ...
  `}function formatAudioPlaybackTime(t){const e=Math.max(0,Math.floor(Number(t)||0)),n=Math.floor(e/60),i=e%60;return`${String(n).padStart(2,"0")}:${String(i).padStart(2,"0")}`}const _activeLockedAudios=new Set;function stopAllLockedAudio(){for(const t of _activeLockedAudios)try{t._lockedListeningStopped=!0,t.pause(),t.src=""}catch{}_activeLockedAudios.clear()}function setupLockedListeningAudio(){const t=Array.from(document.querySelectorAll("[data-locked-audio]"));if(!t.length)return;function e(n=null){const i=n&&!n.paused&&!n.ended;t.forEach(s=>{const o=s._lockedListening;if(o){if(o.finished){o.button.disabled=!0,o.button.textContent="\u2713 \u0110\xE3 nghe xong";return}if(o.started){o.button.disabled=!0,o.button.textContent=i&&s===n?"\u{1F50A} \u0110ang ph\xE1t...":"\u2713 \u0110\xE3 b\u1EAFt \u0111\u1EA7u";return}o.button.disabled=!!i,o.button.textContent="\u25B6 B\u1EAFt \u0111\u1EA7u nghe"}})}t.forEach(n=>{const i=n.dataset.lockedAudio,s=document.querySelector(`[data-locked-audio-start="${i}"]`),o=document.querySelector(`[data-locked-audio-status="${i}"]`),a=document.querySelector(`[data-locked-audio-progress="${i}"]`),l=document.querySelector(`[data-locked-audio-current="${i}"]`),r=document.querySelector(`[data-locked-audio-duration="${i}"]`);if(!s||!o||!a||!l||!r)return;n.controls=!1,n.disablePictureInPicture=!0,n.playbackRate=1;const c=n._lockedListening={button:s,status:o,progressFill:a,currentTimeEl:l,durationEl:r,started:!1,finished:!1,lastTime:0,internalSeek:!1};function u(){const d=Number(n.currentTime)||0,m=Number(n.duration)||0;c.currentTimeEl.textContent=formatAudioPlaybackTime(d),c.durationEl.textContent=Number.isFinite(m)&&m>0?formatAudioPlaybackTime(m):"--:--";const p=m>0?Math.max(0,Math.min(100,d/m*100)):0;c.progressFill.style.width=`${p}%`}_activeLockedAudios.add(n),n.addEventListener("contextmenu",d=>d.preventDefault()),n.addEventListener("loadedmetadata",u),n.addEventListener("timeupdate",()=>{c.started&&!n.seeking&&(c.lastTime=n.currentTime),u()}),n.addEventListener("play",()=>{c.status.textContent="\u0110ang ph\xE1t li\xEAn t\u1EE5c. B\u1EA1n kh\xF4ng th\u1EC3 t\u1EA1m d\u1EEBng ho\u1EB7c tua audio n\xE0y.",e(n),u()}),n.addEventListener("pause",()=>{if(n._lockedListeningStopped||!document.contains(n))return;const d=Number.isFinite(n.duration)&&n.duration>0&&n.currentTime>=n.duration-.1;!c.started||c.finished||n.ended||d||n.play().catch(()=>{})}),n.addEventListener("seeking",()=>{!c.started||c.finished||c.internalSeek||(c.internalSeek=!0,n.currentTime=c.lastTime,u())}),n.addEventListener("seeked",()=>{c.internalSeek=!1,u()}),n.addEventListener("ratechange",()=>{n.playbackRate!==1&&(n.playbackRate=1)}),n.addEventListener("ended",()=>{c.finished=!0,c.status.textContent="\u0110\xE3 ph\xE1t xong audio n\xE0y.",u(),e(null)}),s.addEventListener("click",async()=>{if(!(c.started||c.finished)){c.started=!0,c.lastTime=0,c.status.textContent="\u0110ang chu\u1EA9n b\u1ECB ph\xE1t audio...",e(n);try{c.internalSeek=!0,n.currentTime=0,c.internalSeek=!1,u(),await n.play()}catch{c.started=!1,c.internalSeek=!1,c.status.textContent="Kh\xF4ng th\u1EC3 ph\xE1t audio l\xFAc n\xE0y. Vui l\xF2ng b\u1EA5m l\u1EA1i \u0111\u1EC3 th\u1EED ti\u1EBFp.",e(null)}}}),u()}),e(null)}function audioSeek(t){const e=document.querySelector(".audio-player-box audio");e&&(e.currentTime=Math.max(0,Math.min(e.duration||0,e.currentTime+t)),e.paused&&e.play().catch(()=>{}))}function audioSeekEl(t,e){const n=t?.closest(".audio-player-box")?.querySelector("audio");n&&(n.currentTime=Math.max(0,Math.min(n.duration||0,n.currentTime+e)),n.paused&&n.play().catch(()=>{}))}function startWaveform(t){const e=document.getElementById("waveform-canvas");if(e)try{let l=function(){_waveformAnim=requestAnimationFrame(l),s.getByteTimeDomainData(o);const r=e.width,c=e.height;a.fillStyle="#0d5f58",a.fillRect(0,0,r,c),a.lineWidth=2,a.strokeStyle="#5eead4",a.beginPath();const u=r/o.length;let d=0;for(let m=0;m<o.length;m++){const h=o[m]/128*c/2;m===0?a.moveTo(d,h):a.lineTo(d,h),d+=u}a.lineTo(r,c/2),a.stroke()};var n=l;_audioCtx=_audioCtx||new(window.AudioContext||window.webkitAudioContext);const i=_audioCtx.createMediaStreamSource(t),s=_audioCtx.createAnalyser();s.fftSize=1024,i.connect(s);const o=new Uint8Array(s.frequencyBinCount),a=e.getContext("2d");l()}catch(i){console.warn("Waveform setup failed:",i)}}function stopWaveform(){_waveformAnim&&cancelAnimationFrame(_waveformAnim),_waveformAnim=null}function promptAction({title:t="Nh\u1EADp th\xF4ng tin",message:e="",initialValue:n="",placeholder:i="",confirmText:s="L\u01B0u",cancelText:o="Hu\u1EF7",validate:a}={}){return new Promise(l=>{openModal(t,`
    ...
    `);const r=$("#modal-overlay"),c=r?.querySelector("#prompt-action-input"),u=r?.querySelector("#prompt-action-error"),d=r?.querySelector('[data-prompt-action="cancel"]'),m=r?.querySelector('[data-prompt-action="confirm"]');let p=!1;const h=g=>{p||(p=!0,window._modalCloseCallback=null,closeModal(),l(g))},f=()=>{const g=c?.value??"",y=g.trim(),v=typeof a=="function"?a(y,g):"";if(v){u&&(u.textContent=v),c?.focus(),c?.select?.();return}h(y)};window._modalCloseCallback=()=>h(null),d.onclick=()=>h(null),m.onclick=f,c?.addEventListener("keydown",g=>{g.key==="Enter"&&(g.preventDefault(),f())}),r.onclick=g=>{g.target===r&&h(null)},requestAnimationFrame(()=>{c?.focus(),c?.select?.()})})}function confirmSubmit({title:t,message:e,confirmText:n="V\u1EABn n\u1ED9p",cancelText:i="Quay l\u1EA1i"}){return new Promise(s=>{const o=document.createElement("div");o.className="submit-confirm-overlay",o.innerHTML=`
  ...
  `);const t=$("#login-username")?.value?.trim();if(t){const e=$("#forgot-password-username");e&&(e.value=t)}setTimeout(()=>$("#forgot-password-username")?.focus(),50)}async function submitForgotPassword(t){const e=$("#forgot-password-username")?.value?.trim()||$("#login-username")?.value?.trim()||"";if(!e){toast("Vui l\xF2ng nh\u1EADp username \u0111\u1EC3 g\u1EEDi link \u0111\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u.","error");return}btnLoading(t);try{const n=await api.post("/auth/forgot-password",{username:e});closeModal(),toast(n.message||"Link \u0111\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EEDi qua Gmail.","success")}catch(n){btnReset(t),toast(n.error||"Kh\xF4ng th\u1EC3 g\u1EEDi link \u0111\u1EB7t l\u1EA1i l\xFAc n\xE0y.","error")}}function showResetPasswordPage(t){$("#app").classList.remove("with-header"),$("#app-header").classList.add("hidden"),$("#app").innerHTML=`
    ...
    </div>`}function buildProgressChartSvg(t,e,n,i,s="profile"){const o=s==="profile"?520:320,a=s==="profile"?220:150,l=s==="profile"?42:30,r=14,c=14,u=s==="profile"?28:24,d=o-l-r,m=a-c-u,p="#dbe4ef",h="#94a3b8",f={reading:"#0f766e",listening:"#7c3aed",writing:"#d97706",speaking:"#dc2626"}[i]||"#0f766e",g=new Date;g.setHours(23,59,59,999);const y=new Date(g);y.setDate(g.getDate()-(n-1)),y.setHours(0,0,0,0);const v=Math.max(1,g.getTime()-y.getTime()),w=S=>l+(S.getTime()-y.getTime())/v*d,b=S=>c+(9-S)/9*m,_=[0,3,6,9].map(S=>{const T=b(S).toFixed(1);return`
      <line x1="${l}" y1="${T}" x2="${o-r}" y2="${T}" stroke="${p}" stroke-width="1"/>
    ...
    <line x1="${l}" y1="${b(e).toFixed(1)}" x2="${o-r}" y2="${b(e).toFixed(1)}"
      stroke="${f}" stroke-opacity=".38" stroke-width="1.5" stroke-dasharray="5 5"/>
  `:"",C=t.map(S=>`${w(S.date).toFixed(1)},${b(S.avgScore).toFixed(1)}`).join(" "),L=t.length>=2?`<polyline fill="none" stroke="${f}" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" points="${C}"/>`:"",E=t.map(S=>{const T=w(S.date).toFixed(1),B=b(S.avgScore).toFixed(1);return`
      <circle cx="${T}" cy="${B}" r="5.5" fill="#fff" stroke="${f}" stroke-width="3"
        onmouseenter="showProgressPointTooltip(event, '${i}', '${S.dateKey}')"
        onmousemove="moveProgressTooltip(event)"
        onmouseleave="hideProgressTooltip()"></circle>`}).join(""),M=toDateKey(y).slice(5).replace("-","/"),A=toDateKey(g).slice(5).replace("-","/");return`
    ...
    </div>`}function renderSkillChartCard(t,e,n,i="profile"){const o=getTargetSettings()[e],a=getSkillGradedAssignments(t,e),l=getSubmittedAssignments(t).filter(f=>f.skill===e).length,r=aggregateDailyScores(t,e,n),c={reading:"#0f766e",listening:"#7c3aed",writing:"#d97706",speaking:"#dc2626"}[e]||"#0f766e",u=a.length?a.reduce((f,g)=>f+Number(g.overall_score),0)/a.length:null,d=a.length?Number(a[a.length-1].overall_score):null,m=u!==null?u-o:null,p=m===null?"":m>=0?`<span class="chart-skill-delta ok">+${m.toFixed(2)} vs target</span>`:`<span class="chart-skill-delta gap">${m.toFixed(2)} vs target</span>`,h=r.length?buildProgressChartSvg(r,o,n,e,i):`<div class="chart-empty-state">
      ...
      <div class="skill-chart-top">
        <div>
          ...
          <div class="skill-chart-summary">
            <span class="skill-chart-avg" style="color:${c}">${u!==null?u.toFixed(2):"\u2014"}</span>
            ${p}
          </div>
    ...
    <div class="container">
      ...
      <div class="cal-toolbar">
        ...
        <div class="cal-month-label">${u}</div>
    ...
    </a>`}renderHome=function(t){const e=calculateSubmissionStreak(t,window._cachedVocabSessions||[]),n=t.length,i=getSubmittedAssignments(t).length,s=t.filter(d=>!d.submission_id&&d.is_active).length,o=calculateOverallAverage(t),a=toDateKey(new Date),l=t.filter(d=>d.submission_id||!d.is_active||!d.deadline?!1:toDateKey(d.deadline)===a),r=t.filter(d=>!d.submission_id&&d.is_active).sort((d,m)=>d.deadline?m.deadline?new Date(d.deadline)-new Date(m.deadline):-1:1).slice(0,5),c=[],u=new Set(e.days);for(let d=6;d>=0;d--){const m=new Date;m.setDate(m.getDate()-d);const p=toDateKey(m),h=m.toLocaleDateString("vi-VN",{weekday:"short"});c.push(`<div class="home-streak-day ${u.has(p)?"on":""}" title="${p}">
      <div class="streak-dot">${u.has(p)?"\u{1F525}":"\xB7"}</div>
    ...
    </a>`},renderCalendar=function(t){const[e,n]=_calMonth,i=new Date(e,n,1),s=new Date(e,n+1,0),o=(i.getDay()+6)%7,a=s.getDate(),l={};for(const d of t){if(d.deadline){const m=toDateKey(d.deadline);(l[m]||(l[m]={deadlines:[],submissions:[]})).deadlines.push(d)}if(d.submission_id){const m=toDateKey(d.submitted_at||d.created_at);m&&(l[m]||(l[m]={deadlines:[],submissions:[]})).submissions.push(d)}}const r=["T2","T3","T4","T5","T6","T7","CN"].map(d=>`<div class="cal-weekday">${d}</div>`).join("");let c="";for(let d=0;d<o;d++)c+='<div class="cal-cell empty"></div>';for(let d=1;d<=a;d++){const m=`${e}-${String(n+1).padStart(2,"0")}-${String(d).padStart(2,"0")}`,p=l[m],h=m===toDateKey(new Date);let f="";p&&(p.deadlines.length&&(f+=`<span class="cal-dot deadline" title="${p.deadlines.length} deadline"></span>`),p.submissions.length&&(f+=`<span class="cal-dot submitted" title="${p.submissions.length} \u0111\xE3 n\u1ED9p"></span>`)),c+=`
      <div class="cal-cell${h?" today":""}${p?" has-event":""}" data-day="${m}" onclick="selectCalDay('${m}')">
        <div class="cal-day-num">${d}</div>
        <div class="cal-dots">${f}</div>
      </div>`}const u=i.toLocaleDateString("vi-VN",{month:"long",year:"numeric"});$("#app").innerHTML=`
    <div class="container">
      <div class="page-header">
        <div>
    ...
    ${n.map(s=>`
      <a href="#/${s.submission_id?"result":"assignment"}/${s.id}" class="cal-event-item">
        ...
        <span class="cal-event-title">${escapeHtml(s.title)}</span>
        <span class="cal-event-status">${s.submission_id?"\u2705 \u0110\xE3 n\u1ED9p":"\u23F3 H\u1EA1n"}</span>
      </a>`).join("")}`}},renderProfile=function(t,e){e=e||window._cachedProfileData||{fields:[],answers:{}};const n=(e.fields||[]).find(b=>b.field_key==="notification_email"),i=(e.fields||[]).filter(b=>b.field_key!=="notification_email"),s=_student&&typeof _student.email=="string"&&_student.email.trim()||e.student&&typeof e.student.email=="string"&&e.student.email.trim()||(n?String(e.answers?.[n.id]||"").trim():""),o=calculateSubmissionStreak(t,window._cachedVocabSessions||[]),a=getTargetSettings(),l=getSubmittedAssignments(t),r=calculateOverallAverage(t),c=r!==null?r.toFixed(2):"\u2014",u=SKILL_ORDER.map(b=>{const k=getSkillGradedAssignments(t,b).map(_=>Number(_.overall_score)).filter(Number.isFinite);return{sk:b,best:k.length?Math.max(...k):null}}),d=new Set(l.map(b=>toDateKey(b.submitted_at||b.created_at)).filter(Boolean)),m=new Set(o.days),p=[];for(let b=6;b>=0;b--){const k=new Date;k.setDate(k.getDate()-b);const _=toDateKey(k),x=k.toLocaleDateString("vi-VN",{weekday:"short"});p.push(`<div class="home-streak-day ${m.has(_)?"on":""}" title="${_}">
      <div class="streak-dot">${m.has(_)?"\u{1F525}":"\xB7"}</div>
      <div class="streak-day-label">${x}</div>
    </div>`)}const h=(_myVocabCache||[]).length,f=(_student.full_name||"?").split(" ").map(b=>b[0]).join("").slice(0,2).toUpperCase(),g=o.current>=30?"#dc2626":o.current>=7?"#f59e0b":"#6b7280",y={reading:"#0f766e",listening:"#7c3aed",writing:"#d97706",speaking:"#dc2626"},v=[];u.forEach(({sk:b,best:k})=>{k!==null&&v.push(`<div class="ms-card"><div class="ms-icon">${SKILL_ICONS[b]}</div><div class="ms-val">${k}</div><div class="ms-label">Best ${SKILL_LABELS[b]}</div></div>`)}),l.length>0&&v.push(`<div class="ms-card"><div class="ms-icon">\u{1F4DD}</div><div class="ms-val">${l.length}</div><div class="ms-label">B\xE0i \u0111\xE3 n\u1ED9p</div></div>`),o.best>1&&v.push(`<div class="ms-card"><div class="ms-icon">\u{1F525}</div><div class="ms-val">${o.best}</div><div class="ms-label">Streak k\u1EF7 l\u1EE5c</div></div>`),h>0&&v.push(`<div class="ms-card"><div class="ms-icon">\u{1F4D6}</div><div class="ms-val">${h}</div><div class="ms-label">T\u1EEB \u0111\xE3 l\u01B0u</div></div>`);const w=[["profile-info","\u{1F4CB} Th\xF4ng tin"],["profile-streak","\u{1F525} Streak"],["profile-targets","\u{1F3AF} Target"],["profile-progress","\u{1F4C8} Ti\u1EBFn \u0111\u1ED9"],...v.length>0?[["profile-achievements","\u{1F3C6} Th\xE0nh t\xEDch"]]:[],["profile-next-steps","\u{1F680} Ti\u1EBFp t\u1EE5c h\u1ECDc"]];$("#app").innerHTML=`
    <div class="container profile-page">
      <div class="profile-hero">
        <div class="profile-avatar" style="background:${y.reading}">${f}</div>
      ...
      <div class="profile-nav">
        <div class="profile-nav-list">
          ${w.map(([b,k])=>`
            <button type="button" class="profile-nav-btn" onclick="scrollProfileSection('${b}')">${k}</button>
          `).join("")}
        </div>
      </div>
        ...
        ${i.length===0?"":`<details class="pi-details">
              ...
              <div class="pi-details-body">
                <div class="pi-fields" id="pi-fields">
                  ${i.map(b=>{const k=e.answers[b.id]||"",_=`pi-field-${b.id}`;let x;if(b.field_type==="textarea")x=`<textarea id="${_}" class="form-input pi-input" data-field-id="${b.id}" rows="3" placeholder="Ch\u01B0a c\xF3 d\u1EEF li\u1EC7u">${escapeHtml(k)}</textarea>`;else if(b.field_type==="select"&&Array.isArray(b.options)){const C=b.options.map(L=>`<option value="${escapeHtml(String(L))}" ${k===String(L)?"selected":""}>${escapeHtml(String(L))}</option>`).join("");x=`<select id="${_}" class="form-input pi-input" data-field-id="${b.id}"><option value="">-- Ch\u01B0a ch\u1ECDn --</option>${C}</select>`}else if(b.field_type==="date")x=`<input id="${_}" class="form-input pi-input" type="date" data-field-id="${b.id}" value="${escapeHtml(k)}" />`;else{const C=b.field_key==="notification_email"?"email":"text",L=b.field_key==="notification_email"?"name@example.com":"Ch\u01B0a c\xF3 d\u1EEF li\u1EC7u";x=`<input id="${_}" class="form-input pi-input" type="${C}" data-field-id="${b.id}" value="${escapeHtml(k)}" placeholder="${L}" />`}return`<div class="pi-field">
                      <label class="pi-label" for="${_}">${escapeHtml(b.label)}</label>
                      ${x}
                    </div>`}).join("")}
                </div>
      ...
      <div class="home-streak-card">
        ...
        <div class="home-streak-week">${p.join("")}</div>
      </div>
      </section>
      ...
      ${v.length>0?`
        ...
        <div class="milestones-row">${v.join("")}</div>
        </section>
      `:""}
      ...
      </div>`;openModal(i,s)}let _myVocabCache=null;async function loadMyVocab(){if(_myVocabCache!==null)return _myVocabCache;try{_myVocabCache=(await api.get("/student/vocab")).map(e=>({word:e.word,definition:e.definition,example:e.example,source:e.source,savedAt:e.saved_at}))}catch{_myVocabCache=[]}return _myVocabCache}function _invalidateVocabCache(){_myVocabCache=null}function isWordSaved(t){return _myVocabCache?_myVocabCache.some(e=>e.word===t):!1}window.isWordSaved=isWordSaved;async function toggleSaveWordBtn(t){const{word:e,def:n,pron:i,ex:s,src:o}=t.dataset,a=isWordSaved(e);t.disabled=!0;try{a?(await api.delete(`/student/vocab/${encodeURIComponent(e)}`),_invalidateVocabCache(),t.textContent="\u{1F4BE} L\u01B0u",t.classList.remove("saved"),toast(`\u0110\xE3 xo\xE1 "${e}"`,"info")):(await api.post("/student/vocab",{word:e,definition:n,pronunciation:i||"",example:s||"",source:o||""}),_invalidateVocabCache(),t.textContent="\u2713 \u0110\xE3 l\u01B0u",t.classList.add("saved"),toast(`\u2705 \u0110\xE3 l\u01B0u "${e}"`,"success"))}catch(l){toast("L\u1ED7i l\u01B0u t\u1EEB: "+(l.error||l.message),"error")}finally{t.disabled=!1}}window.toggleSaveWordBtn=toggleSaveWordBtn;let _myVocabSearch="",_myVocabSort="",_gradedResultSub=null,_resultNavContext=null,_gradedResultSortCol="",_gradedResultSortDir="asc",_practiceResultData=null,_practiceResultSortCol="",_practiceResultSortDir="asc";function resetResultNavContext(){_resultNavContext=null}function setResultNavContext(t){_resultNavContext=t||null}function getResultBackHref(){return _resultNavContext?.backHref||"/assignments"}function getResultBackLabel(){return _resultNavContext?.backLabel||"\u2190 Danh s\xE1ch b\xE0i t\u1EADp"}function getPracticeBackHref(t){return _resultNavContext?.backHref||(t?.is_composite_section?`/composite-result/${t.composite_assignment_id}/section/${t.id}`:`/result/${t.assignment_id}`)}function getPracticeHref(t,e){if(t?.is_composite_section)return`/composite-practice/${t.id}?type=${e}`;const n=t?.id?`&sub=${t.id}`:"";return`/practice/${t.assignment_id}?type=${e}${n}`}function canRetakeForScore(t){return!t||t.is_composite_section||!t.assignment_id||t.skill!=="reading"&&t.skill!=="listening"?!1:t.is_active!==!1}async function startScoredRetake(t){if(!(!t||!await confirmSubmit({title:"\u{1F3AF} L\xE0m l\u1EA1i c\xF3 t\xEDnh \u0111i\u1EC3m",message:`<div style="line-height:1.6">
      L\u1EA7n l\xE0m n\xE0y <b>\u0111\u01B0\u1EE3c t\xEDnh \u0111i\u1EC3m</b> v\xE0 s\u1EBD <b>thay th\u1EBF \u0111i\u1EC3m hi\u1EC7n t\u1EA1i</b> c\u1EE7a b\u1EA1n \u2014 gi\xE1o vi\xEAn
      c\u0169ng s\u1EBD th\u1EA5y k\u1EBFt qu\u1EA3 m\u1EDBi thay cho k\u1EBFt qu\u1EA3 c\u0169.<br><br>
      B\xE0i ch\u1EA1y y h\u1EC7t l\u1EA7n \u0111\u1EA7u: n\u1EBFu l\xE0 \u0111\u1EC1 thi c\xF3 gi\u1EDBi h\u1EA1n th\u1EDDi gian th\xEC \u0111\u1ED3ng h\u1ED3 b\u1EAFt \u0111\u1EA7u ch\u1EA1y khi
      b\u1EA1n b\u1EA5m "B\u1EAFt \u0111\u1EA7u l\xE0m b\xE0i", v\xE0 <b>v\u1EABn ch\u1EA1y ti\u1EBFp k\u1EC3 c\u1EA3 khi b\u1EA1n tho\xE1t ra</b>.
    </div>`,confirmText:"B\u1EAFt \u0111\u1EA7u l\xE0m l\u1EA1i",cancelText:"Hu\u1EF7"})))try{await api.post(`/assignments/${t}/retake`,{}),clearAllDrafts(t),invalidateAssignmentsCache(!0),navigate(`/assignment/${t}`)}catch(n){toast("Kh\xF4ng m\u1EDF \u0111\u01B0\u1EE3c l\u01B0\u1EE3t l\xE0m l\u1EA1i: "+(n.error||n.message),"error")}}window.startScoredRetake=startScoredRetake;async function openAttemptHistory(t){if(t){openModal("L\u1ECBch s\u1EED c\xE1c l\u1EA7n l\xE0m",'<div class="loading-screen"><div class="spinner"></div></div>');try{const i=[...await api.get(`/assignments/${t}/my-submissions`)||[]].sort((s,o)=>(o.attempt_number||1)-(s.attempt_number||1)).map((s,o)=>{const a=o===0,l=s.attempt_kind==="retake"?"L\xE0m l\u1EA1i t\xEDnh \u0111i\u1EC3m":s.attempt_kind==="rewrite"?"Theo y\xEAu c\u1EA7u gi\xE1o vi\xEAn":"L\u1EA7n n\u1ED9p \u0111\u1EA7u";return`
        <div class="attempt-history-row${a?" is-latest":""}" role="button" tabindex="0"
             onclick="closeModal();switchGradedVersion('${s.id}','${t}')">
          <div class="attempt-history-main">
            <span class="attempt-history-no">L\u1EA7n ${s.attempt_number}</span>
            ${a?'<span class="attempt-history-badge">\u0110ang t\xEDnh \u0111i\u1EC3m</span>':""}
            ${s.is_overtime?'<span class="attempt-history-late">Qu\xE1 gi\u1EDD</span>':""}
          </div>
          <div class="attempt-history-meta">${l} \xB7 ${formatDateTime(s.submitted_at)}</div>
          <div class="attempt-history-score">${s.overall_score!=null?s.overall_score:"\u2014"}</div>
        </div>`}).join("");$("#modal-body").innerHTML=`
      <div class="attempt-history">
        <div class="attempt-history-note">\u0110i\u1EC3m ch\xEDnh th\u1EE9c lu\xF4n l\xE0 <b>l\u1EA7n m\u1EDBi nh\u1EA5t</b>. B\u1EA5m v\xE0o m\u1ED9t l\u1EA7n \u0111\u1EC3 xem l\u1EA1i b\xE0i l\xE0m v\xE0 t\u1EEBng c\xE2u \u0111\xFAng/sai.</div>
        ${i||'<div class="attempt-history-note">Ch\u01B0a c\xF3 l\u1EA7n n\u1ED9p n\xE0o.</div>'}
      </div>`}catch(e){$("#modal-body").innerHTML=`<p style="color:var(--danger)">${escapeHtml(e.error||e.message||"L\u1ED7i t\u1EA3i l\u1ECBch s\u1EED")}</p>`}}}window.openAttemptHistory=openAttemptHistory;async function switchGradedVersion(t,e){if(!(!t||!e)){setLoading("\u0110ang t\u1EA3i...");try{const[n,i]=await Promise.all([api.get(`/submissions/${t}/by-student`),api.get(`/assignments/${e}/my-submissions`)]);renderGradedResult(n,i)}catch(n){toast("L\u1ED7i t\u1EA3i b\xE0i l\xE0m: "+(n.error||n.message),"error")}}}window.switchGradedVersion=switchGradedVersion;async function showMyVocab(){_myVocabSearch="",_myVocabSort="",setLoading("\u0110ang t\u1EA3i t\u1EEB v\u1EF1ng...");const t=routeToken();await loadMyVocab(),!routeChanged(t)&&renderMyVocabList()}function renderMyVocabList(){const t=_myVocabCache||[],e=_myVocabSearch.toLowerCase();let n=e?t.filter(s=>s.word.toLowerCase().includes(e)||s.definition.toLowerCase().includes(e)):t;_myVocabSort==="az"?n=[...n].sort((s,o)=>s.word.toLowerCase().localeCompare(o.word.toLowerCase())):_myVocabSort==="za"?n=[...n].sort((s,o)=>o.word.toLowerCase().localeCompare(s.word.toLowerCase())):_myVocabSort==="newest"&&(n=[...n].sort((s,o)=>(o.savedAt||"")>(s.savedAt||"")?1:-1));const i=n.length===0?`<div class="empty-state-v2">
    ...
    <div class="container mfc-page">
      <div class="mfc-end">
    ...
    </div>`}window.flipMyFC=flipMyFC,window.mfcAnswer=mfcAnswer;async function showAssignments(){setLoading("\u0110ang t\u1EA3i danh s\xE1ch b\xE0i t\u1EADp...");const t=routeToken();try{const e=await getAssignments();if(routeChanged(t))return;renderAssignments(e)}catch(e){if(routeChanged(t))return;toast("L\u1ED7i t\u1EA3i b\xE0i t\u1EADp: "+(e.error||e.message),"error"),renderRouteError("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c danh s\xE1ch b\xE0i t\u1EADp",e,"/assignments")}}function renderAssignments(t){const e=_assignmentSkillFilter?t.filter(c=>c.skill===_assignmentSkillFilter):t,n=e.filter(c=>c.skill!=="composite"&&c.rewrite_status==="requested"),i=e.filter(c=>c.skill!=="composite"?!c.submission_id&&c.is_active:c.is_active&&!isCompositeAssignmentDone(c)),s=e.filter(c=>c.skill!=="composite"?!c.submission_id&&!c.is_active:!c.is_active&&!isCompositeAssignmentDone(c)),o=e.filter(c=>c.skill!=="composite"?!!c.submission_id&&c.rewrite_status!=="requested":isCompositeAssignmentDone(c));function a(c){const u=c.skill==="composite",d=isOverdue(c.deadline),m=u?isCompositeAssignmentDone(c):!!c.submission_id,p=!c.is_active&&!m,h=SKILL_ICONS[c.skill]||"\u{1F4DD}",f=!m&&!d&&!p?formatCountdown(c.deadline):null;let g,y;if(u){const x=getCompositeSectionsForAssignment(c),C=x.filter(E=>E.submitted).length,L=getCompositeAssignmentAverageScore(c);p?g='<span class="badge badge-closed">\u{1F512} \u0110\xE3 \u0111\xF3ng</span>':m?g=isCompositeAssignmentFullyGraded(c)?'<span class="badge badge-done">\u2705 \u0110\xE3 c\xF3 \u0111i\u1EC3m</span>':'<span class="badge badge-waiting">\u23F3 Ch\u1EDD ch\u1EA5m</span>':C>0?g=`<span class="badge badge-pending">${C}/${x.length} ph\u1EA7n</span>`:g='<span class="badge badge-pending">Ch\u01B0a l\xE0m</span>',y=isCompositeAssignmentFullyGraded(c)&&L!==null?`<div class="score-band">${L.toFixed(2)}</div><div class="score-label">Band</div>`:""}else if(p)g='<span class="badge badge-closed">\u{1F512} \u0110\xE3 \u0111\xF3ng</span>',y="";else if(m){const x=c.overall_score!==null&&c.overall_score!==void 0,C=c.rewrite_status==="requested";c.retake_attempt_number!=null?(g='<span class="badge badge-retaking">\u{1F3AF} \u0110ang l\xE0m l\u1EA1i</span>',y=x?`<div class="score-band retaking-score">${c.overall_score}</div><div class="score-label">Band c\u0169</div>`:'<div class="score-pending-icon">\u{1F3AF}</div>'):C?(g='<span class="badge badge-rewrite">\u270F\uFE0F Y\xCAU C\u1EA6U L\xC0M L\u1EA0I</span>',y=x?`<div class="score-band rewrite-score">${c.overall_score}</div><div class="score-label">Band</div>`:'<div class="score-pending-icon">\u270F\uFE0F</div>'):(g=x?'<span class="badge badge-done">\u2705 \u0110\xE3 c\xF3 \u0111i\u1EC3m</span>':'<span class="badge badge-waiting">\u23F3 Ch\u1EDD ch\u1EA5m</span>',y=x?`<div class="score-band">${c.overall_score}</div><div class="score-label">Band</div>`:'<div class="score-pending-icon">\u23F3</div>')}else d&&c.deadline?(g='<span class="badge badge-overdue">\u26A0\uFE0F Qu\xE1 h\u1EA1n</span>',y=""):(g='<span class="badge badge-pending">Ch\u01B0a l\xE0m</span>',y="");if(p)return`
        ...
        </div>`;const v=!u&&c.rewrite_status==="requested",w=!u&&c.retake_attempt_number!=null,b=u?c.is_active&&!isCompositeAssignmentDone(c):!c.submission_id&&c.is_active,k=u?`#/composite/${c.id}`:m&&!w?`#/result/${c.id}`:`#/assignment/${c.id}`;return`
      <a class="assignment-card ${v?"rewrite":w?"retaking":b?"pending-card":m?"done":""}" href="${k}">
        <div class="assignment-card-icon">${h}</div>
        <div class="assignment-card-body">
          <div class="assignment-card-title">${escapeHtml(c.title)}</div>
          <div class="assignment-card-meta">
          ...
          <div class="assignment-card-deadline-row">
            ${f?`<span class="countdown-chip">${f}</span>`:""}
    ...
    </div>`}async function showAssignment({id:t}){setLoading("\u0110ang t\u1EA3i b\xE0i t\u1EADp...");const e=routeToken();try{const n=await api.get(`/assignments/${t}/question`);if(routeChanged(e))return;try{const s=await api.get(`/submissions?assignment_id=${t}`);if(routeChanged(e))return;if(!(s.rewrite_status==="requested"||s.retake_attempt_number!=null)){clearAllDrafts(t),navigate(`/result/${t}`);return}}catch{}let i=null;if(n.mode==="exam"&&n.time_limit_minutes){let s=null;try{s=(await api.get(`/exam-sessions?ref_type=assignment&ref_id=${encodeURIComponent(t)}`))?.started_at||null}catch{}if(routeChanged(e))return;if(!s){renderExamBriefing(n);return}const o=(Date.now()-new Date(s).getTime())/1e3;i=Math.max(0,n.time_limit_minutes*60-o)}if(routeChanged(e))return;renderAssignment(n,i)}catch(n){if(routeChanged(e))return;const i=String(n?.error||n?.message||"").toLowerCase();(i.includes("\u0111\xF3ng")||i.includes("kh\xF4ng t\xECm th\u1EA5y"))&&clearAllDrafts(t),toast("L\u1ED7i t\u1EA3i b\xE0i t\u1EADp: "+(n.error||n.message),"error"),navigate("/assignments")}}let _pendingExamAssignment=null;function renderExamBriefing(t){_pendingExamAssignment=t,_activeAssignmentId=null,stopAssignmentCountdown(),_removeExamBeforeUnload();const e=t.question_count||0,n=[e>0?`${e} c\xE2u h\u1ECFi`:"",t.deadline?`H\u1EA1n n\u1ED9p: ${formatDateTime(t.deadline)}`:""].filter(Boolean).join(" \xB7 ");$("#app").innerHTML=`
    <div class="container">
      <button class="btn-back" onclick="navigate('/assignments')">\u2190 B\xE0i t\u1EADp c\u1EE7a t\xF4i</button>
      <div class="exam-briefing">
        <div class="exam-briefing-badges">${skillBadge(t.skill)}<span class="badge badge-exam">\u{1F3AF} Ch\u1EBF \u0111\u1ED9 thi</span></div>
        <h2 class="exam-briefing-title">${escapeHtml(t.title)}</h2>
        ${n?`<div class="exam-briefing-meta">${escapeHtml(n)}</div>`:""}

        <div class="exam-briefing-time">
          <div class="exam-briefing-time-value">${t.time_limit_minutes} ph\xFAt</div>
          <div class="exam-briefing-time-label">Th\u1EDDi gian l\xE0m b\xE0i</div>
        </div>

        <ul class="exam-briefing-rules">
          <li>\u0110\u1ED3ng h\u1ED3 b\u1EAFt \u0111\u1EA7u ch\u1EA1y <strong>ngay khi b\u1EA1n b\u1EA5m "B\u1EAFt \u0111\u1EA7u l\xE0m b\xE0i"</strong>.</li>
          <li>Sau khi b\u1EAFt \u0111\u1EA7u, th\u1EDDi gian <strong>v\u1EABn ti\u1EBFp t\u1EE5c tr\xF4i</strong> k\u1EC3 c\u1EA3 khi b\u1EA1n tho\xE1t ra, t\u1EAFt m\xE1y hay m\u1EA5t m\u1EA1ng.</li>
          <li>H\u1EBFt gi\u1EDD, b\xE0i s\u1EBD \u0111\u01B0\u1EE3c <strong>t\u1EF1 \u0111\u1ED9ng n\u1ED9p</strong> v\u1EDBi nh\u1EEFng g\xEC b\u1EA1n \u0111\xE3 l\xE0m.</li>
          <li>Ch\u1EC9 b\u1EA5m b\u1EAFt \u0111\u1EA7u khi b\u1EA1n \u0111\xE3 s\u1EB5n s\xE0ng ng\u1ED3i l\xE0m li\xEAn t\u1EE5c ${t.time_limit_minutes} ph\xFAt.</li>
        </ul>

        <button class="btn btn-primary btn-lg exam-briefing-start" id="begin-exam-btn"
          onclick="beginExamAssignment()">\u25B6 B\u1EAFt \u0111\u1EA7u l\xE0m b\xE0i</button>
      </div>
    </div>`}async function beginExamAssignment(){const t=_pendingExamAssignment;if(!t){navigate("/assignments");return}const e=document.getElementById("begin-exam-btn");e&&(e.disabled=!0,e.textContent="\u0110ang b\u1EAFt \u0111\u1EA7u...");let n;try{const i=await api.post("/exam-sessions",{ref_type:"assignment",ref_id:t.id}),s=(Date.now()-new Date(i.started_at).getTime())/1e3;n=Math.max(0,t.time_limit_minutes*60-s)}catch(i){toast("Kh\xF4ng b\u1EAFt \u0111\u1EA7u \u0111\u01B0\u1EE3c b\xE0i thi: "+(i.error||i.message),"error"),e&&(e.disabled=!1,e.textContent="\u25B6 B\u1EAFt \u0111\u1EA7u l\xE0m b\xE0i");return}_pendingExamAssignment=null,renderAssignment(t,n)}window.beginExamAssignment=beginExamAssignment;function renderAssignment(t,e=null){_activeAssignmentId=t.id,stopAssignmentCountdown(),_removeExamBeforeUnload();const n=loadDraft(t.id,"flags");_flaggedSet=new Set(Array.isArray(n?.data)?n.data:[]);const i=t.skill,s=t.question_count||0;i==="reading"?renderReading(t):i==="listening"?renderListening(t):i==="writing"?renderWriting(t):i==="speaking"&&renderSpeaking(t);const o=document.querySelector(".assignment-toolbar");if(o){const a=o.querySelector("#submit-btn"),l=document.createElement("div");l.id="task-timer",l.className="task-timer",l.title="Th\u1EDDi gian b\u1EA1n \u0111\xE3 l\xE0m b\xE0i",a?o.insertBefore(l,a):o.appendChild(l);const r=document.createElement("div");if(r.id="save-indicator",r.className="save-indicator",a?o.insertBefore(r,a):o.appendChild(r),startTaskTimer(t.id),t.mode==="exam"&&t.time_limit_minutes){const c=document.createElement("div");c.className="assign-countdown-wrap",c.innerHTML='<span class="assign-countdown-label">\u23F1 C\xF2n l\u1EA1i</span><span class="assign-countdown" id="assign-countdown">--:--</span>',a?o.insertBefore(c,a):o.appendChild(c);const u=e!==null?e:t.time_limit_minutes*60;_installExamBeforeUnload(),u<=0?autoSubmitAssignment({assignmentId:t.id,skill:i,qCount:s}):startAssignmentCountdown(u,{assignmentId:t.id,skill:i,qCount:s})}}}let _examBeforeUnloadHandler=null;function _installExamBeforeUnload(){_removeExamBeforeUnload(),_examBeforeUnloadHandler=t=>{t.preventDefault(),t.returnValue="B\u1EA1n \u0111ang trong b\xE0i ki\u1EC3m tra \u2014 th\u1EDDi gian v\u1EABn ti\u1EBFp t\u1EE5c ch\u1EA1y n\u1EBFu r\u1EDDi trang!"},window.addEventListener("beforeunload",_examBeforeUnloadHandler)}function _removeExamBeforeUnload(){_examBeforeUnloadHandler&&(window.removeEventListener("beforeunload",_examBeforeUnloadHandler),_examBeforeUnloadHandler=null)}function renderReading(t){const e=t.question_count||0;let n="";for(let i=1;i<=e;i++){const s=_flaggedSet.has(i)?" flagged":"";n+=`
    ...
    </div>`}}async function requestSpeakingUploadTarget(t,e){return _speakingIsShared?api.post("/uploads/audio/presign",{scope:"student-shared-speaking",pool_id:t,file_name:e.name,content_type:e.type||"application/octet-stream",size:e.size}):api.post("/uploads/audio/presign",{scope:"student-speaking",assignment_id:t,file_name:e.name,content_type:e.type||"application/octet-stream",size:e.size})}function putSpeakingAudioDirect(t,e,n,i){return new Promise((s,o)=>{const a=new XMLHttpRequest,l=Date.now();a.upload.addEventListener("progress",r=>{if(!r.lengthComputable)return;const c=Math.max(0,Math.min(100,Math.round(r.loaded/r.total*100))),u=Math.max((Date.now()-l)/1e3,.001),d=r.loaded/u,m=r.total-r.loaded,p=d>0?Math.ceil(m/d):null;i?.(c,p)}),a.addEventListener("load",()=>{a.status>=200&&a.status<300?s():o(new Error(`HTTP ${a.status}`))}),a.addEventListener("error",()=>o(new Error("Network error"))),a.addEventListener("abort",()=>o(new Error("Upload cancelled"))),a.open("PUT",t),a.setRequestHeader("Content-Type",n||"application/octet-stream"),a.send(e)})}async function submitSpeaking(t,e,n=!1){const i=_speakingSlots.filter(s=>s.status==="done");if(i.length===0&&!n){toast("Vui l\xF2ng thu \xE2m ho\u1EB7c upload \xEDt nh\u1EA5t 1 file audio","error");return}if(!(!n&&!await confirmSubmit({title:"X\xE1c nh\u1EADn n\u1ED9p b\xE0i Speaking",message:`<div>B\u1EA1n \u0111\xE3 s\u1EB5n s\xE0ng n\u1ED9p b\xE0i thu \xE2m?</div>
                <div style="margin-top:8px;color:var(--gray-600);font-size:13px">Sau khi n\u1ED9p b\u1EA1n kh\xF4ng th\u1EC3 thu \xE2m l\u1EA1i.</div>`}))){btnLoading(e);try{const s=i.map(o=>({key:o.key,name:o.displayName||o.name}));setSpeakingSubmitStatus("processing"),await api.post(`/assignments/${t}/submit`,{audio_upload_keys:s}),invalidateAssignmentsCache(!0),await syncNotifUIAfterSubmit(),clearAllDrafts(t),stopAutoSave(),stopTaskTimer(),stopAssignmentCountdown(),_removeExamBeforeUnload(),toast("N\u1ED9p b\xE0i th\xE0nh c\xF4ng! \u{1F389}"),navigate(`/result/${t}`)}catch(s){if(setSpeakingSubmitStatus(null),btnReset(e),n&&unfreezeExamInputs(),s.error?.includes("\u0111\xE3 n\u1ED9p")){navigate(`/result/${t}`);return}toast(n?'\u23F0 H\u1EBFt gi\u1EDD \u2014 n\u1ED9p t\u1EF1 \u0111\u1ED9ng th\u1EA5t b\u1EA1i (c\xF3 th\u1EC3 do m\u1EA5t m\u1EA1ng). B\u1EA5m "N\u1ED9p b\xE0i" \u0111\u1EC3 th\u1EED l\u1EA1i.':"L\u1ED7i n\u1ED9p b\xE0i: "+(s.error||s.message),"error")}}}async function showResult({id:t}){setLoading("\u0110ang t\u1EA3i k\u1EBFt qu\u1EA3...");const e=routeToken();try{resetResultNavContext();const n=await api.get(`/submissions?assignment_id=${t}`);if(routeChanged(e))return;let i=null;if(n.skill==="writing"||n.skill==="speaking"||(n.attempt_number||1)>1){try{i=await api.get(`/assignments/${t}/my-submissions`)}catch{}if(routeChanged(e))return}renderResult(n,i)}catch(n){if(routeChanged(e))return;toast("L\u1ED7i t\u1EA3i k\u1EBFt qu\u1EA3: "+(n.error||n.message),"error"),navigate("/assignments")}}function renderResult(t,e=null){const n=t.skill;n==="reading"||n==="listening"?renderGradedResult(t,e):n==="writing"?renderWritingResult(t,e):n==="speaking"&&renderSpeakingResult(t,e)}function renderGradedResult(t,e=null){_gradedResultSub=t;const n=e?[...e].sort((v,w)=>(v.attempt_number||1)-(w.attempt_number||1)):null,i=n?n[n.length-1].attempt_number||1:t.attempt_number||1,s=(t.attempt_number||1)===i,o=n&&n.length>1?`
    <div class="version-selector">
      <span class="version-selector-label">Xem k\u1EBFt qu\u1EA3:</span>
      ${n.map(v=>`
        <button class="version-btn${v.id===t.id?" active":""}"
          onclick="switchGradedVersion('${v.id}','${t.assignment_id}')">
          L\u1EA7n ${v.attempt_number}${v.overall_score!=null?` \xB7 ${v.overall_score}`:""}
        </button>`).join("")}
    </div>`:"",a=t.questions_data||[],l=t.student_answers||[];let r=0;const c=a.some(v=>v.explanation||v.location),u=a.map(v=>{const b=(l.find(_=>_.q_no===v.q_no)?.answer||"").trim(),k=v.answers.some(_=>_.toLowerCase().trim()===b.toLowerCase());return k&&r++,{...v,_given:b,_correct:k}});_gradedResultSortCol==="result"?u.sort((v,w)=>{const b=v._correct?1:0,k=w._correct?1:0;return _gradedResultSortDir==="asc"?b-k:k-b}):_gradedResultSortCol==="q_no"&&u.sort((v,w)=>_gradedResultSortDir==="asc"?v.q_no-w.q_no:w.q_no-v.q_no);const d=u.map(v=>{const w=v._given,b=v._correct,k=v.explanation||v.location?`
      <td class="result-actions">
        ${v.explanation?`<button class="btn-result-action btn-result-explain" onclick="toggleExplanation('exp-q${v.q_no}')">Explain</button>`:""}
        ${v.location?`<button class="btn-result-action btn-result-locate" data-locate="${escapeHtml(v.location)}" data-locate-meta="${escapeAttrJson(v.location_meta)}" onclick="locateInText(this.dataset.locate, this.dataset.locateMeta)">Locate</button>`:""}
      </td>`:c?"<td></td>":"",_=v.explanation?`
      <tr class="explanation-row hidden" id="exp-q${v.q_no}">
        <td colspan="${c?5:4}">
          <div class="explanation-content"><span class="explanation-label">\u{1F4A1} Gi\u1EA3i th\xEDch:</span>${escapeHtml(v.explanation)}</div>
        </td>
      </tr>`:"";return`
      <tr>
        <td style="font-weight:700;color:var(--gray-400)">Q${v.q_no}</td>
        <td>${escapeHtml(w)||'<em style="color:var(--gray-400)">B\u1ECF tr\u1ED1ng</em>'}</td>
        <td>${escapeHtml(v.answers.join(" / "))}</td>
        <td class="${b?"result-correct":"result-wrong"}">${b?"\u2713":"\u2717"}</td>
        ${k}
      </tr>${_}`}).join(""),m=a.length,p=(t.scoring_scale||"10")==="ielts",h=t.overall_score??(m>0?p?Math.round(r/m*9*10)/10:Math.round(r/m*10*10)/10:0),f=c?5:4,g=t.vocabulary||[],y=g.length===0?"":`
    <div class="section-label" style="margin-top:20px">\u{1F4DA} T\u1EEB v\u1EF1ng trong b\xE0i</div>
    <div class="vocab-result-list">
      ${g.map((v,w)=>{const b=isWordSaved(v.word);return`
        <div class="vocab-result-item">
          <div class="vocab-result-header" onclick="toggleVocabItem(${w})">
            <span class="vocab-result-word">${escapeHtml(v.word)}</span>
            <span class="vocab-result-toggle" id="vocab-toggle-${w}">\u25B6</span>
            ...
            <button class="btn-save-word ${b?"saved":""}"
            ...
            >${b?"\u2713 \u0110\xE3 l\u01B0u":"\u{1F4BE} L\u01B0u"}</button>
          </div>
          <div class="vocab-result-detail hidden" id="vocab-detail-${w}">
    ...
    <div class="assignment-page">
      <div class="assignment-toolbar">
        ...
        <div class="toolbar-actions">
          ${g.length>0&&!t.is_composite_section?`<a href="#/vocab-game/${t.assignment_id||""}" class="btn-vocab-toolbar" title="Luy\u1EC7n t\u1EEB v\u1EF1ng b\xE0i n\xE0y">\u{1F0CF} T\u1EEB v\u1EF1ng</a>`:""}
          ${m-r>0?`<button class="btn-practice btn-practice-wrong" onclick="navigate('${getPracticeHref(t,"retry_wrong")}')">\u{1F4DD} L\xE0m l\u1EA1i c\xE2u sai (${m-r})</button>`:""}
          ...
          ${canRetakeForScore(t)?`<button class="btn-practice btn-practice-scored" onclick="startScoredRetake('${t.assignment_id}')">\u{1F3AF} L\xE0m l\u1EA1i t\xEDnh \u0111i\u1EC3m</button>`:""}
          ${i>1&&!t.is_composite_section?`<button class="btn-practice btn-practice-history" onclick="openAttemptHistory('${t.assignment_id}')">\u{1F4CB} L\u1ECBch s\u1EED c\xE1c l\u1EA7n</button>`:""}
        </div>
      </div>
      <div class="assignment-content">
        <div class="content-pane" id="result-content-pane">
          ...
          ${s?"":`
            <div class="old-attempt-notice">
              B\u1EA1n \u0111ang xem <b>l\u1EA7n ${t.attempt_number}</b> \u2014 \u0111\xE2y kh\xF4ng ph\u1EA3i \u0111i\u1EC3m ch\xEDnh th\u1EE9c.
              \u0110i\u1EC3m \u0111ang \u0111\u01B0\u1EE3c t\xEDnh l\xE0 <b>l\u1EA7n ${i}</b>.
            </div>`}
        ...
        <div class="answer-pane">
          <div class="result-header" style="margin-bottom:16px;">
            <div class="score-display" style="margin-top:0;">
              ...
              <div class="score-band">${p?"Band Score / 9.0":"\u0110i\u1EC3m / 10"}</div>
            </div>
            <div class="result-stats">
              <div class="stat-item">
                <div class="stat-value" style="color:var(--success)">${r}</div>
                <div class="stat-label">\u0110\xFAng</div>
              </div>
              <div class="stat-item">
                <div class="stat-value" style="color:var(--danger)">${m-r}</div>
    ...
    </div>`}function renderWritingFeedback(t,e=null){const n=t.teacher_feedback||{},i=(n.annotations||[]).sort((y,v)=>y.start-v.start),s=n.overall||"",o=t.overall_score??n.score,a=countWords(t.writing_content||""),l=e?[...e].sort((y,v)=>(v.attempt_number||1)-(y.attempt_number||1)):null,c=(l?l[0]:t).rewrite_status==="requested",u=e&&e.length>1,d=s?`
    <div class="section-label">Nh\u1EADn x\xE9t t\u1ED5ng th\u1EC3</div>
    <div class="feedback-overall">${escapeHtml(s)}</div>`:"",m=buildVoiceNotesHtml(n.voice_notes),p=_annColorMap(i),h=_buildAnnSidebar(i,p),f=u?`
    <div class="version-selector">
      <span class="version-selector-label">Xem k\u1EBFt qu\u1EA3:</span>
      ${[...e].sort((y,v)=>(y.attempt_number||1)-(v.attempt_number||1)).map(y=>`
        <button class="version-btn${y.id===t.id?" active":""}"
          onclick="switchWritingVersion('${y.id}','${t.assignment_id}')">
          L\u1EA7n ${y.attempt_number}${y.overall_score!=null?` \xB7 ${y.overall_score}`:""}
        </button>`).join("")}
    </div>`:"",g=c?`
    ...
    </div>`}function buildAnnotatedHtml(t,e){if(!t)return'<span style="color:var(--gray-400)">(Tr\u1ED1ng)</span>';if(!e||e.length===0)return escapeHtml(t);const n=_annColorMap(e),i=[...e].sort((r,c)=>r.start-c.start),s=new Map(i.map((r,c)=>[r.id,c+1]));let o=0;const a=new Map(i.map(r=>(r.type||"highlight")==="highlight"?[r.id,++o]:[r.id,null]));function l(r,c,u){if(r>=c)return"";if(!u.length)return escapeHtml(t.slice(r,c));const d=[...u].sort((f,g)=>f.start-g.start||g.end-g.start-(f.end-f.start));let m="",p=r;const h=new Set;for(const f of d){if(h.has(f.id))continue;const g=Math.max(f.start,p);if(g>=f.end)continue;m+=escapeHtml(t.slice(p,g));const y=d.filter(w=>!h.has(w.id)&&w!==f&&w.start>=f.start&&w.end<=f.end);y.forEach(w=>h.add(w.id)),h.add(f.id);const v=s.get(f.id)-1;if((f.type||"highlight")==="delete")m+=`<span class="ann-delete" id="ann-mark-${v}" title="${escapeHtml(f.comment)}">`,m+=l(g,f.end,y),m+="</span>";else{const w=ANN_COLORS[n.get(f.id)];m+=`<mark class="ann-highlight ${w}" id="ann-mark-${v}" title="${escapeHtml(f.comment)}">`,m+=l(g,f.end,y),m+=`<sup class="ann-marker ann-marker-c${n.get(f.id)}">${a.get(f.id)}</sup>`,m+="</mark>"}p=f.end}return m+=escapeHtml(t.slice(p,c)),m}return l(0,t.length,e)}function scrollToFeedbackMark(t){const e=document.getElementById(`ann-mark-${t}`);if(!e)return;const n=document.getElementById("feedback-content-pane");if(n){const i=e.getBoundingClientRect().top-n.getBoundingClientRect().top;n.scrollTop+=i-n.clientHeight/3}else e.scrollIntoView({behavior:"smooth",block:"center"});e.classList.add("ann-flash"),setTimeout(()=>e.classList.remove("ann-flash"),1500)}function renderSpeakingResult(t,e=null){const n=t.teacher_feedback;t.overall_score!=null||n?.annotations?.length>0||n?.overall?renderSpeakingFeedback(t,e):renderSpeakingPending(t)}function renderSpeakingPending(t){$("#app").innerHTML=`
    <div class="container">
      <button class="btn-back" onclick="navigate('${getResultBackHref()}')">${getResultBackLabel()}</button>
      <div class="result-header">
        <div>${skillBadge(t.skill)}</div>
    ...
    </div>`}function renderSpeakingFeedback(t,e=null){const n=t.teacher_feedback||{},i=(n.annotations||[]).sort((g,y)=>g.start-y.start),s=n.overall||"",o=t.overall_score??n.score,a=e?[...e].sort((g,y)=>(y.attempt_number||1)-(g.attempt_number||1)):null,r=(a?a[0]:t).rewrite_status==="requested",c=e&&e.length>1,u=s?`
    <div class="section-label">Nh\u1EADn x\xE9t t\u1ED5ng th\u1EC3</div>
    <div class="feedback-overall">${escapeHtml(s)}</div>`:"",d=buildVoiceNotesHtml(n.voice_notes),m=_annColorMap(i),p=_buildAnnSidebar(i,m),h=c?`
    <div class="version-selector">
      <span class="version-selector-label">Xem k\u1EBFt qu\u1EA3:</span>
      ${[...e].sort((g,y)=>(g.attempt_number||1)-(y.attempt_number||1)).map(g=>`
    ...
    <div class="assignment-page">
        ...
        <div class="content-pane" id="feedback-content-pane">
          ...
          ${(()=>{const g=Array.isArray(t.speaking_audio_urls)&&t.speaking_audio_urls.length>0?t.speaking_audio_urls:t.speaking_audio_url?[{url:t.speaking_audio_url}]:[];return g.length?`<div class="section-label"${s?' style="margin-top:20px"':""}>Audio ghi \xE2m c\u1EE7a b\u1EA1n</div>
              <div style="margin-bottom:16px">
                ${g.map((y,v)=>`
                  ${g.length>1?`<div style="font-size:12px;color:var(--gray-400);margin-bottom:4px">${escapeHtml(y.name||"Ph\u1EA7n "+(v+1))}</div>`:""}
                  <audio controls src="${escapeHtml(y.url||"")}" style="width:100%;height:36px;outline:none;margin-bottom:${v<g.length-1?"10px":"0"}"></audio>
                `).join("")}
              </div>`:""})()}
    ...
    </div>`;const o=3;let a="";for(const l of i){const r=s[l];if(!r||r.length===0)continue;const c=!!_vocabExpanded[l],u=c?r:r.slice(0,o),d=r.length-o,m=u.map(h=>`
      ...
      </a>`).join(""),p=!c&&d>0?`<button class="vocab-show-more" onclick="vocabToggleSkill('${l}')">+ Xem th\xEAm ${d} b\xE0i</button>`:c&&r.length>o?`<button class="vocab-show-more" onclick="vocabToggleSkill('${l}')">\u2212 Thu g\u1ECDn</button>`:"";a+=`
    ...
    <div class="assignment-page">
    ...
    </div>`,bindReadingTextInteractions("practice-reading-text")}async function submitPractice(t,e){const{assignment:n,questionsToShow:i,attemptType:s}=_practiceData||{};if(!i)return;const o=i.map(a=>({q_no:a.q_no,answer:($(`#pans-${a.q_no}`)?.value||"").trim()}));btnLoading(e);try{if(_practiceData?.localComposite){const l=n.questions_data||[];let r=0;for(const c of i){const u=(o.find(d=>d.q_no===c.q_no)?.answer||"").trim().toLowerCase();c.answers?.some(d=>d.toLowerCase().trim()===u)&&r++}renderPracticeResult({assignment_id:t,correct_count:r,total_count:i.length,questions_data:l},i,o);return}const a=await api.post("/practice/submit",{assignment_id:t,attempt_type:s,student_answers:o});renderPracticeResult(a,i,o)}catch(a){btnReset(e),toast("L\u1ED7i: "+(a.error||a.message),"error")}}function renderPracticeResult(t,e,n){_practiceResultData={result:t,questionsToShow:e,answers:n};const i=t.questions_data||[],s=e.map(r=>{const c=i.find(p=>p.q_no===r.q_no)||r,d=(n.find(p=>p.q_no===r.q_no)?.answer||"").trim(),m=c.answers?.some(p=>p.toLowerCase().trim()===d.toLowerCase())||!1;return{...c,_given:d,_correct:m}});_practiceResultSortCol==="result"?s.sort((r,c)=>{const u=r._correct?1:0,d=c._correct?1:0;return _practiceResultSortDir==="asc"?u-d:d-u}):_practiceResultSortCol==="q_no"&&s.sort((r,c)=>_practiceResultSortDir==="asc"?r.q_no-c.q_no:c.q_no-r.q_no);const o=s.map(r=>{const c=r._given,u=r._correct,d=r.explanation?`
      ...
      <tr>
        ...
        <td class="${u?"result-correct":"result-wrong"}">${u?"\u2713":"\u2717"}</td>
  ...
  `).join(""),o=i.length===0?`<div class="empty-hint">Kh\xF4ng c\xF3 \u0111\u1EC1 n\xE0o${_sharedSkillFilter!=="all"?" cho k\u1EF9 n\u0103ng n\xE0y":""}.</div>`:i.map(a=>{const l=(a.tags||[]).map(u=>`<span class="tag-chip">${escapeHtml(u)}</span>`).join(""),r=a.real_test_count>0&&a.best_score!=null,c=a.real_test_count>0?`<div class="shared-card-stats">
        ...
        <div class="answer-pane">
          <div class="result-header" style="margin-bottom:16px">
            ...
            <div class="result-stats">
              ...
              <div class="stat-item"><div class="stat-value" style="color:var(--danger)">${u}</div><div class="stat-label">Sai</div></div>
          ...
          <div style="margin-bottom:16px">
            <button class="btn-practice btn-practice-wrong" style="width:100%;justify-content:center"
              ...
              \u{1F4DD} L\xE0m l\u1EA1i c\xE2u sai (${u} c\xE2u)
            </button>
          </div>`:""}
          <div class="section-label">Chi ti\u1EBFt \u0111\xE1p \xE1n</div>
          <div class="result-answers">
      ...
      <div class="assignment-page">
        ...
        <div class="assignment-content">
          ...
          <div class="answer-pane">
            ...
            <div class="answer-grid">${u}</div>
          </div>
        </div>
      </div>`,bindReadingTextInteractions("practice-reading-text")}catch(a){if(routeChanged(o))return;toast("L\u1ED7i t\u1EA3i b\xE0i: "+(a.error||a.message),"error"),navigate("/shared-pool")}}async function submitSharedPractice(t,e,n){const i=_sharedCtx?.poolQ,s=i?i.questions_data.filter(c=>t.includes(c.q_no)):t.map(c=>({q_no:c,answers:[]})),o=t.map(c=>({q_no:c,answer:($(`#sprac-${c}`)?.value||"").trim()}));btnLoading(n);let a=0;const l=t.map(c=>{const u=s.find(p=>p.q_no===c)||{q_no:c,answers:[]},d=(o.find(p=>p.q_no===c)?.answer||"").trim(),m=(u.answers||[]).some(p=>p.toLowerCase().trim()===d.toLowerCase());return m&&a++,`
      <tr>
    ...
    </div>`;btnReset(n),openModal("K\u1EBFt qu\u1EA3 luy\u1EC7n t\u1EADp",r)}window.submitSharedPractice=submitSharedPractice,loadAuth(),pruneStudentDrafts();let _authExpiredHandled=!1;window.addEventListener("auth:expired",()=>{_authExpiredHandled||(_authExpiredHandled=!0,flushAutoSave(),stopAutoSave(),stopTaskTimer(),stopAssignmentCountdown(),_removeExamBeforeUnload(),clearAuth(),toast("Phi\xEAn \u0111\u0103ng nh\u1EADp \u0111\xE3 h\u1EBFt h\u1EA1n \u2014 b\xE0i l\xE0m \u0111\xE3 \u0111\u01B0\u1EE3c l\u01B0u t\u1EA1m, vui l\xF2ng \u0111\u0103ng nh\u1EADp l\u1EA1i.","error"),_origNavigate("/login"),setTimeout(()=>{_authExpiredHandled=!1},1e3))}),window.addEventListener("pagehide",flushAutoSave);function startEditProfileName(){const t=document.getElementById("profile-name-text");if(!t)return;const e=t.textContent.trim(),n=t.closest(".profile-name");n.innerHTML=`
  ...
  `;const i=document.getElementById("profile-name-input");i?.focus(),i?.select(),i?.addEventListener("keydown",s=>{s.key==="Enter"&&saveProfileName(),s.key==="Escape"&&renderProfile(window._cachedAssignments||[],window._cachedProfileData)})}async function saveProfileName(){const t=document.getElementById("profile-name-input");if(!t)return;const e=t.value.trim();if(!e){t.focus();return}t.disabled=!0;let n=!1;try{await api.patch("/student/me",{full_name:e}),n=!0}catch(i){t.disabled=!1,t.focus(),toast(i?.error||"Kh\xF4ng th\u1EC3 c\u1EADp nh\u1EADt t\xEAn","error")}if(n){updateStudentState({full_name:e});const i=document.getElementById("header-student-name");i&&(i.textContent=e),renderProfile(window._cachedAssignments||[],window._cachedProfileData)}}window.startEditProfileName=startEditProfileName,window.saveProfileName=saveProfileName;let _compositeExam=null,_activeSectionId=null;function stopCompositeSectionTimer(){stopAssignmentCountdown()}async function showCompositeExam({id:t}){setLoading("\u0110ang t\u1EA3i \u0111\u1EC1 t\u1ED5ng h\u1EE3p...");const e=routeToken();try{const n=await api.get(`/student/assignments/${t}`);if(routeChanged(e))return;n.sections&&(n.sections=n.sections.map(i=>({...i,question_count:Array.isArray(i.questions_data)?i.questions_data.length:0}))),_compositeExam=n,_activeSectionId=null,stopCompositeSectionTimer(),renderCompositeExam(n)}catch(n){if(routeChanged(e))return;toast("L\u1ED7i t\u1EA3i \u0111\u1EC1: "+(n.error||n.message),"error"),navigate("/assignments")}}window.showCompositeExam=showCompositeExam;function renderCompositeExam(t){stopAssignmentCountdown();const e=t.sections||[],n=e.length>0&&e.every(a=>a.submission_id),i=!t.is_active,s=e.map(a=>{const l=!!a.submission_id,r=SKILL_ICONS[a.skill]||"\u{1F4DD}",c=a.question_count>0?`${a.question_count} c\xE2u`:"",u=a.time_limit_minutes?`\u23F1 ${a.time_limit_minutes} ph\xFAt`:"",d=[c,u].filter(Boolean).join(" \xB7 "),m=l?`<span class="badge badge-done" style="font-size:11px">\u2713 \u0110\xE3 n\u1ED9p${n&&a.score!=null?` \xB7 Band ${a.score}`:""}</span>`:i?'<span class="badge badge-closed" style="font-size:11px">\u{1F512} \u0110\xE3 \u0111\xF3ng</span>':'<span class="badge badge-pending" style="font-size:11px">Ch\u01B0a l\xE0m</span>',p=l?n:!i,h=l?n?`#/composite-result/${t.id}/section/${a.submission_id}`:"":i?"":`#/composite/${t.id}/section/${a.id}`,f=l&&!n?'<div style="font-size:12px;color:var(--gray-400);margin-top:6px">\u{1F512} Ho\xE0n th\xE0nh c\xE1c ph\u1EA7n c\xF2n l\u1EA1i \u0111\u1EC3 xem k\u1EBFt qu\u1EA3</div>':"",g=l&&!n?"\u{1F512}":"\u203A";return`
      ...
      </${p&&h?"a":"div"}>`}).join(""),o=n?`<div style="margin-top:24px;text-align:center">
    ...
    </div>`}window.renderCompositeExam=renderCompositeExam;async function showCompositeSectionExam({id:t,sectionId:e}){setLoading("\u0110ang t\u1EA3i...");const n=routeToken();try{if(!_compositeExam||_compositeExam.id!==t){const a=await api.get(`/student/assignments/${t}`);a.sections&&(a.sections=a.sections.map(l=>({...l,question_count:Array.isArray(l.questions_data)?l.questions_data.length:0}))),_compositeExam=a}if(routeChanged(n))return;const i=_compositeExam.sections?.find(a=>a.id===e);if(!i){toast("Kh\xF4ng t\xECm th\u1EA5y ph\u1EA7n thi","error"),navigate(`/composite/${t}`);return}const s=(_compositeExam.sections||[]).length>0&&_compositeExam.sections.every(a=>a.submission_id);if(i.submission_id){if(!s){toast("Ho\xE0n th\xE0nh c\xE1c ph\u1EA7n c\xF2n l\u1EA1i \u0111\u1EC3 xem k\u1EBFt qu\u1EA3 c\u1EE7a ph\u1EA7n n\xE0y.","warning"),navigate(`/composite/${t}`);return}navigate(`/composite-result/${t}/section/${i.submission_id}`);return}if(!_compositeExam.is_active){toast("\u0110\u1EC1 \u0111\xE3 \u0111\xF3ng","error"),navigate(`/composite/${t}`);return}let o=i.time_limit_minutes?i.time_limit_minutes*60:null;if(_compositeExam.mode==="exam"&&i.time_limit_minutes){let a=null;try{a=(await api.get(`/exam-sessions?ref_type=composite_section&ref_id=${encodeURIComponent(e)}&assignment_id=${encodeURIComponent(t)}`))?.started_at||null}catch{}if(routeChanged(n))return;if(!a){renderCompositeSectionBriefing(t,i);return}const l=(Date.now()-new Date(a).getTime())/1e3;if(o=Math.max(0,i.time_limit_minutes*60-l),o<=0){await _autoSubmitCompositeSectionAndBack(t,e);return}}if(routeChanged(n))return;_activeSectionId=e,_renderCompositeSectionFullScreen(t,i,o),o!==null&&_installExamBeforeUnload()}catch(i){if(routeChanged(n))return;toast("L\u1ED7i: "+(i.error||i.message),"error"),navigate(`/composite/${t}`)}}window.showCompositeSectionExam=showCompositeSectionExam;let _pendingExamSection=null;function renderCompositeSectionBriefing(t,e){_pendingExamSection={compositeId:t,sec:e},_activeSectionId=null,stopAssignmentCountdown(),_removeExamBeforeUnload();const n=e.question_count||0;$("#app").innerHTML=`
    <div class="container">
      <button class="btn-back" onclick="navigate('/composite/${t}')">\u2190 C\xE1c ph\u1EA7n thi</button>
      <div class="exam-briefing">
        <div class="exam-briefing-badges">${skillBadge(e.skill)}<span class="badge badge-exam">\u{1F3AF} Ch\u1EBF \u0111\u1ED9 thi</span></div>
        <h2 class="exam-briefing-title">${escapeHtml(e.label)}</h2>
        ${n>0?`<div class="exam-briefing-meta">${n} c\xE2u h\u1ECFi</div>`:""}

        <div class="exam-briefing-time">
          <div class="exam-briefing-time-value">${e.time_limit_minutes} ph\xFAt</div>
          <div class="exam-briefing-time-label">Th\u1EDDi gian cho ph\u1EA7n n\xE0y</div>
        </div>

        <ul class="exam-briefing-rules">
          <li>\u0110\u1ED3ng h\u1ED3 b\u1EAFt \u0111\u1EA7u ch\u1EA1y <strong>ngay khi b\u1EA1n b\u1EA5m "B\u1EAFt \u0111\u1EA7u l\xE0m b\xE0i"</strong>.</li>
          <li>Sau khi b\u1EAFt \u0111\u1EA7u, th\u1EDDi gian <strong>v\u1EABn ti\u1EBFp t\u1EE5c tr\xF4i</strong> k\u1EC3 c\u1EA3 khi b\u1EA1n tho\xE1t ra, t\u1EAFt m\xE1y hay m\u1EA5t m\u1EA1ng.</li>
          <li>H\u1EBFt gi\u1EDD, ph\u1EA7n n\xE0y s\u1EBD \u0111\u01B0\u1EE3c <strong>t\u1EF1 \u0111\u1ED9ng n\u1ED9p</strong> v\u1EDBi nh\u1EEFng g\xEC b\u1EA1n \u0111\xE3 l\xE0m.</li>
          <li>M\u1ED7i ph\u1EA7n c\xF3 \u0111\u1ED3ng h\u1ED3 ri\xEAng \u2014 c\xE1c ph\u1EA7n kh\xE1c ch\u01B0a b\u1EAFt \u0111\u1EA7u s\u1EBD kh\xF4ng b\u1ECB t\xEDnh gi\u1EDD.</li>
        </ul>

        <button class="btn btn-primary btn-lg exam-briefing-start" id="begin-exam-btn"
          onclick="beginCompositeSection()">\u25B6 B\u1EAFt \u0111\u1EA7u l\xE0m b\xE0i</button>
      </div>
    </div>`}async function beginCompositeSection(){const t=_pendingExamSection;if(!t){navigate("/assignments");return}const{compositeId:e,sec:n}=t,i=document.getElementById("begin-exam-btn");i&&(i.disabled=!0,i.textContent="\u0110ang b\u1EAFt \u0111\u1EA7u...");let s;try{const o=await api.post("/exam-sessions",{ref_type:"composite_section",ref_id:n.id,assignment_id:e}),a=(Date.now()-new Date(o.started_at).getTime())/1e3;s=Math.max(0,n.time_limit_minutes*60-a)}catch(o){toast("Kh\xF4ng b\u1EAFt \u0111\u1EA7u \u0111\u01B0\u1EE3c ph\u1EA7n thi: "+(o.error||o.message),"error"),i&&(i.disabled=!1,i.textContent="\u25B6 B\u1EAFt \u0111\u1EA7u l\xE0m b\xE0i");return}_pendingExamSection=null,_activeSectionId=n.id,_renderCompositeSectionFullScreen(e,n,s),_installExamBeforeUnload()}window.beginCompositeSection=beginCompositeSection;function _renderCompositeSectionFullScreen(t,e,n){const i=e.id,s=`${t}_${i}`;_activeAssignmentId=s;const o=loadDraft(s,"flags");_flaggedSet=new Set(Array.isArray(o?.data)?o.data:[]);const a=e.question_count||0,l=n!==null?'<div class="assign-countdown-wrap"><span class="assign-countdown-label">\u23F1 C\xF2n l\u1EA1i</span><span class="assign-countdown" id="assign-countdown">--:--</span></div>':"";let r="",c=null;if(e.skill==="reading"){let u="";for(let d=1;d<=a;d++){const m=_flaggedSet.has(d)?" flagged":"";u+=`<div class="answer-row">
      ...
      <div class="assignment-content">
        ...
        <div class="answer-pane">
          ...
          <div class="section-title">\u0110i\u1EC1n \u0111\xE1p \xE1n</div>
          ${a===0?'<div style="color:var(--gray-400);font-size:13px">Kh\xF4ng c\xF3 c\xE2u h\u1ECFi.</div>':`<div class="answer-grid">${u}</div>`}
        </div>
      </div>`,c=()=>{restoreAnswerDraft(s,a),bindReadingTextInteractions(),updateNavigatorState(),startAutoSave(()=>persistAnswerDraft(s,a))}}else if(e.skill==="listening"){let u="";for(let m=1;m<=a;m++){const p=_flaggedSet.has(m)?" flagged":"";u+=`<div class="answer-row">
        <span class="q-label">Q${m}</span>
        <input class="answer-input" id="ans-${m}" type="text" placeholder="\u0110\xE1p \xE1n c\xE2u ${m}"
          oninput="updateNavigatorState();scheduleAnswerDraftSave('${s}',${a})" />
        <button class="q-flag-btn${p}" data-flag-q="${m}" onclick="toggleFlag(${m})" title="\u0110\xE1nh d\u1EA5u xem l\u1EA1i" aria-label="\u0110\xE1nh d\u1EA5u xem l\u1EA1i">\u{1F6A9}</button>
      </div>`}r=`
      <div class="assignment-content">
        <div class="content-pane">
      ...
      </div>`,c=()=>{restoreAnswerDraft(s,a),_compositeExam.mode!=="practice"&&setupLockedListeningAudio(),bindReadingTextInteractions(),updateNavigatorState(),startAutoSave(()=>persistAnswerDraft(s,a))}}else if(e.skill==="writing"){const u=Number.isFinite(e.min_word_count)?`T\u1ED1i thi\u1EC3u g\u1EE3i \xFD: ${e.min_word_count} t\u1EEB`:"Task 1: ~150 t\u1EEB \u2014 Task 2: ~250 t\u1EEB";r=`
      <div class="assignment-content">
        <div class="content-pane">
          <div class="section-title">\u0110\u1EC1 b\xE0i</div>
        ...
        <div class="answer-pane writing-answer-pane">
          ...
          <div class="form-hint">${escapeHtml(u)}</div>
        </div>
    ...
    <div class="assignment-page">
      ...
      </div>`;const h=c(d),f=h?`<div class="result-score-badge">${h}</div>`:'<span class="badge badge-waiting">\u23F3 Ch\u1EDD ch\u1EA5m</span>';let g="";return d.skill==="writing"&&d.feedback?g=d.feedback:d.skill==="speaking"?g=d.feedback||(d.audio_url?"\u0110\xE3 n\u1ED9p file ghi \xE2m. B\u1EA5m \u0111\u1EC3 xem transcript v\xE0 nh\u1EADn x\xE9t chi ti\u1EBFt.":""):g=d.score!=null?"M\u1EDF \u0111\u1EC3 xem \u0111\xE1p \xE1n \u0111\xFAng/sai, Explain, Locate v\xE0 luy\u1EC7n l\u1EA1i ph\u1EA7n n\xE0y.":"Ph\u1EA7n n\xE0y \u0111\xE3 n\u1ED9p v\xE0 \u0111ang ch\u1EDD ch\u1EA5m \u0111i\u1EC3m.",`<a href="#/composite-result/${t.id}/section/${d.submission_id}" class="result-section-card composite-result-card composite-result-card-link">
      <div class="composite-result-card-top">
        <div class="composite-result-card-title-wrap">
          <div class="composite-result-card-icon">${e[d.skill]||"\u{1F4DD}"}</div>
          <div>
            <div class="composite-result-card-title">${escapeHtml(d.label)}</div>
            <div class="composite-result-card-subtitle">${escapeHtml(m)} \xB7 ${p?"\u0110\xE3 n\u1ED9p b\xE0i":"Ch\u01B0a n\u1ED9p"}</div>
          </div>
        </div>
