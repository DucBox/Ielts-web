...
`),n=[];let i=null;const s=()=>{i&&(n.push(`</${i}>`),i=null)};for(const o of e){const a=o.trim();if(!a){s();continue}const l=a.match(/^[-*]\s+(.+)$/),d=a.match(/^\d+\.\s+(.+)$/);if(l||d){const p=l?"ul":"ol";i!==p&&(s(),n.push(`<${p}>`),i=p),n.push(`<li>${renderMarkdownInline((l||d)[1])}</li>`);continue}s();const c=a.match(/^(#{2,4})\s+(.+)$/);c?n.push(`<h5>${renderMarkdownInline(c[2])}</h5>`):n.push(`<p>${renderMarkdownInline(a)}</p>`)}return s(),n.join("")}function btnReset(t){t&&(t.disabled=!1,t.innerHTML=t._origHTML||t.innerHTML)}function micErrorMessageVi(t){const e=t?.name||"";return e==="NotAllowedError"||e==="SecurityError"?"Tr\xECnh duy\u1EC7t \u0111ang ch\u1EB7n quy\u1EC1n truy c\u1EADp microphone. H\xE3y v\xE0o ph\u1EA7n c\xE0i \u0111\u1EB7t trang web (bi\u1EC3u t\u01B0\u1EE3ng kho\xE1/camera tr\xEAn thanh \u0111\u1ECBa ch\u1EC9), cho ph\xE9p Micro, r\u1ED3i t\u1EA3i l\u1EA1i trang.":e==="NotFoundError"||e==="DevicesNotFoundError"?"Kh\xF4ng t\xECm th\u1EA5y microphone tr\xEAn thi\u1EBFt b\u1ECB n\xE0y. H\xE3y ki\u1EC3m tra mic \u0111\xE3 c\u1EAFm/b\u1EADt ch\u01B0a r\u1ED3i th\u1EED l\u1EA1i.":e==="NotReadableError"||e==="TrackStartError"?"Kh\xF4ng th\u1EC3 m\u1EDF microphone \u2014 c\xF3 th\u1EC3 m\u1ED9t \u1EE9ng d\u1EE5ng kh\xE1c \u0111ang d\xF9ng mic. H\xE3y \u0111\xF3ng \u1EE9ng d\u1EE5ng \u0111\xF3 r\u1ED3i th\u1EED l\u1EA1i.":e==="OverconstrainedError"?"Microphone hi\u1EC7n t\u1EA1i kh\xF4ng \u0111\xE1p \u1EE9ng \u0111\u01B0\u1EE3c y\xEAu c\u1EA7u ghi \xE2m. H\xE3y th\u1EED \u0111\u1ED5i mic kh\xE1c n\u1EBFu c\xF3.":e==="AbortError"?"Qu\xE1 tr\xECnh m\u1EDF microphone b\u1ECB gi\xE1n \u0111o\u1EA1n. Vui l\xF2ng th\u1EED l\u1EA1i.":"Kh\xF4ng th\u1EC3 truy c\u1EADp microphone. H\xE3y ki\u1EC3m tra quy\u1EC1n truy c\u1EADp mic c\u1EE7a tr\xECnh duy\u1EC7t r\u1ED3i th\u1EED l\u1EA1i."}function toast(t,e="success"){const n=e==="error"?6e3:3500,i=document.createElement("div");i.className=`toast toast-${e}`,i.setAttribute("role","alert");const s=document.createElement("span");s.textContent=t;const o=document.createElement("button");o.className="toast-close",o.setAttribute("aria-label","\u0110\xF3ng th\xF4ng b\xE1o"),o.textContent="\xD7",o.onclick=()=>i.remove(),i.appendChild(s),i.appendChild(o),i.addEventListener("mouseenter",()=>i.classList.add("toast-paused")),i.addEventListener("mouseleave",()=>i.classList.remove("toast-paused")),$("#toast-container").appendChild(i);const a=setTimeout(()=>i.remove(),n);i.addEventListener("mouseenter",()=>clearTimeout(a)),i.addEventListener("mouseleave",()=>setTimeout(()=>i.remove(),1e3))}function setLoading(t="\u0110ang t\u1EA3i..."){$("#app").innerHTML=`
  ...
  </div>`}function repairImageTokensInBlocks(t){let e=0;function n(){return`cb-repair-${++e}`}const i=[];for(const a of t){let c=function(){const r=d.innerHTML.replace(/^(<br\s*\/?>)+|(<br\s*\/?>)+$/gi,"").trim();r&&i.push({id:n(),type:"text",html:r,text:""}),d=document.createElement("div")},p=function(r){r.nodeType===Node.ELEMENT_NODE&&r.classList?.contains("document-editor-image-token")?(c(),i.push({id:r.dataset.blockId||n(),type:"image",url:r.dataset.url||"",alt:r.dataset.alt||"",width:Math.max(1,Number(r.dataset.width)||100)})):r.nodeType===Node.ELEMENT_NODE&&r.querySelector?.(".document-editor-image-token")?r.childNodes.forEach(m=>p(m)):d.appendChild(r.cloneNode(!0))};var s=c,o=p;if(a.type!=="text"||!a.html?.includes("document-editor-image-token")){i.push(a);continue}const l=document.createElement("div");l.innerHTML=a.html;let d=document.createElement("div");l.childNodes.forEach(r=>p(r)),c()}return i}function normalizeIndentMarkupHtml(t=""){if(!t)return"";const e=document.createElement("div");e.innerHTML=String(t);const n=new Set(["DIV","P","LI","H1","H2","H3","H4","H5","H6","BLOCKQUOTE","PRE"]),i=a=>Array.from({length:Math.max(1,Number(a)||1)},()=>'<span class="document-editor-indent" contenteditable="false" data-indent="1">&nbsp;</span>').join(""),s=(a="")=>{let l=0,d=0,c=0;for(;d<a.length;){const p=a[d];if(p==="	"){if(c)break;l+=1,d+=1;continue}if(p===" "||p==="\xA0"){c+=1,d+=1,c===4&&(l+=1,c=0);continue}break}return d-=c,{units:l,consumedChars:d}},o=a=>{if(!a?.childNodes)return!0;let l=!0;return Array.from(a.childNodes).forEach(d=>{if(d.nodeType===Node.TEXT_NODE){const c=String(d.textContent||"");if(l&&c){const{units:p,consumedChars:r}=s(c);if(p>0){const m=document.createDocumentFragment();m.appendChild(document.createRange().createContextualFragment(i(p)));const u=c.slice(r);u&&m.appendChild(document.createTextNode(u)),d.replaceWith(m),l=!u||!/[^\s\u00a0]/.test(u);return}}/[^\s\u00a0]/.test(c)&&(l=!1);return}if(d.nodeType===Node.ELEMENT_NODE){if(d.tagName==="BR"){l=!0;return}if(!d.classList.contains("document-editor-indent")){if(n.has(d.tagName)){o(d),l=!0;return}l=o(d)}}}),l};return e.querySelectorAll("span").forEach(a=>{const l=String(a.textContent||"").replace(/ /g,"").replace(/\n/g,""),d=l&&/^[\u00a0\t]+$/.test(l),c=/display\s*:\s*inline-block/i.test(a.getAttribute("style")||"");if(!a.classList.contains("document-editor-indent")&&!(c&&d))return;const p=Math.max(1,Math.round(l.length/4)||1);a.replaceWith(document.createRange().createContextualFragment(i(p)))}),o(e),e.innerHTML}function normalizeQuestionContentBlocks(t,e=""){const i=repairImageTokensInBlocks(Array.isArray(t)?t:[]).map((s,o)=>s?.type==="image"&&s?.url?{id:s.id||`cb-${o+1}`,type:"image",url:s.url,alt:s.alt||"",width:Number(s.width)||100}:{id:s?.id||`cb-${o+1}`,type:"text",html:normalizeIndentMarkupHtml(s?.html??(s?.text?escapeHtml(String(s.text)):"")),text:String(s?.text||"")}).filter(Boolean);return i.length>0?i:[{id:"fallback-text",type:"text",html:escapeHtml(e||""),text:e||""}]}function renderQuestionContentHTML(t,e="",n=""){const i=normalizeQuestionContentBlocks(t,e);return`
  ...
  `);const t=$("#login-username")?.value?.trim();if(t){const e=$("#forgot-password-username");e&&(e.value=t)}setTimeout(()=>$("#forgot-password-username")?.focus(),50)}async function submitForgotPassword(t){const e=$("#forgot-password-username")?.value?.trim()||$("#login-username")?.value?.trim()||"";if(!e){toast("Vui l\xF2ng nh\u1EADp username \u0111\u1EC3 g\u1EEDi link \u0111\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u.","error");return}btnLoading(t);try{const n=await api.post("/auth/forgot-password",{username:e});closeModal(),toast(n.message||"Link \u0111\u1EB7t l\u1EA1i m\u1EADt kh\u1EA9u \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EEDi qua Gmail.","success")}catch(n){btnReset(t),toast(n.error||"Kh\xF4ng th\u1EC3 g\u1EEDi link \u0111\u1EB7t l\u1EA1i l\xFAc n\xE0y.","error")}}function showResetPasswordPage(t){$("#app").classList.remove("with-header"),$("#app-header").classList.add("hidden"),$("#app").innerHTML=`
    ...
    </div>`}function buildProgressChartSvg(t,e,n,i,s="profile"){const o=s==="profile"?520:320,a=s==="profile"?220:150,l=s==="profile"?42:30,d=14,c=14,p=s==="profile"?28:24,r=o-l-d,m=a-c-p,u="#dbe4ef",g="#94a3b8",h={reading:"#0f766e",listening:"#7c3aed",writing:"#d97706",speaking:"#dc2626"}[i]||"#0f766e",v=new Date;v.setHours(23,59,59,999);const f=new Date(v);f.setDate(v.getDate()-(n-1)),f.setHours(0,0,0,0);const _=Math.max(1,v.getTime()-f.getTime()),S=w=>l+(w.getTime()-f.getTime())/_*r,y=w=>c+(9-w)/9*m,C=[0,3,6,9].map(w=>{const k=y(w).toFixed(1);return`
      <line x1="${l}" y1="${k}" x2="${o-d}" y2="${k}" stroke="${u}" stroke-width="1"/>
      <text x="${l-8}" y="${Number(k)+4}" text-anchor="end" font-size="10" fill="${g}">${w}</text>`}).join(""),L=Number.isFinite(e)?`
    <line x1="${l}" y1="${y(e).toFixed(1)}" x2="${o-d}" y2="${y(e).toFixed(1)}"
  ...
  `:"",M=t.map(w=>`${S(w.date).toFixed(1)},${y(w.avgScore).toFixed(1)}`).join(" "),A=t.length>=2?`<polyline fill="none" stroke="${h}" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" points="${M}"/>`:"",H=t.map(w=>{const k=S(w.date).toFixed(1),E=y(w.avgScore).toFixed(1);return`
    ...
    <svg viewBox="0 0 ${o} ${a}" preserveAspectRatio="none" class="progress-chart-svg" aria-hidden="true">
      ...
      ${A}
      ${H}
      <text x="${l}" y="${a-6}" font-size="10" fill="${g}">${B}</text>
      <text x="${o-d}" y="${a-6}" text-anchor="end" font-size="10" fill="${g}">${b}</text>
    ...
    <label class="target-editor-item">
      ...
      <select class="target-editor-select" data-target-key="${o}">
        ${i.map(d=>`<option value="${d}" ${e[o]===d?"selected":""}>${d.toFixed(1)}</option>`).join("")}
      </select>
    </label>`;return`
    ...
    </div>`}function renderSkillChartCard(t,e,n,i="profile"){const o=getTargetSettings()[e],a=getSkillGradedAssignments(t,e),l=getSubmittedAssignments(t).filter(h=>h.skill===e).length,d=aggregateDailyScores(t,e,n),c={reading:"#0f766e",listening:"#7c3aed",writing:"#d97706",speaking:"#dc2626"}[e]||"#0f766e",p=a.length?a.reduce((h,v)=>h+Number(v.overall_score),0)/a.length:null,r=a.length?Number(a[a.length-1].overall_score):null,m=p!==null?p-o:null,u=m===null?"":m>=0?`<span class="chart-skill-delta ok">+${m.toFixed(2)} vs target</span>`:`<span class="chart-skill-delta gap">${m.toFixed(2)} vs target</span>`,g=d.length?buildProgressChartSvg(d,o,n,e,i):`<div class="chart-empty-state">
    ...
    ${n.map(s=>`
    ...
    </svg>`}function C({sk:b,count:w,avg:k,best:E,timeline:I}){const T=f[b],N=k!==null?Math.min(100,Math.round(k/n*100)):0,P=k===null?"":k>=n?"\u2705":k>=n-.5?"\u{1F7E1}":"\u{1F534}",D=x(I,T),F=k!==null?k>=n?`<span class="spc-vs ok">+${(k-n).toFixed(2)} vs target</span>`:`<span class="spc-vs gap">-${(n-k).toFixed(2)} vs target</span>`:"",q=y(b).length;return`
      <button class="skill-progress-card spc-${b}" type="button"
        ...
        <div class="spc-band-row">
          <span class="spc-band" style="color:${T}">${k!==null?k.toFixed(2):"\u2014"}</span>
          ${F}
        </div>
        <div class="spc-bar-wrap">
          <div class="spc-bar" style="width:${N}%;background:${T}"></div>
        </div>
        <div class="spc-bar-label">${k!==null?k.toFixed(2):"\u2014"} / ${n} target</div>
      ...
      <div class="profile-hero">
        ...
        <div class="profile-hero-info">
          ...
          <div class="profile-meta-row">
            ...
            <span>Band TB: <strong>${a}</strong></span>
            <span class="profile-dot">\xB7</span>
    ...
    </a>`},renderCalendar=function(t){const[e,n]=_calMonth,i=new Date(e,n,1),s=new Date(e,n+1,0),o=(i.getDay()+6)%7,a=s.getDate(),l={};for(const r of t){if(r.deadline){const m=toDateKey(r.deadline);(l[m]||(l[m]={deadlines:[],submissions:[]})).deadlines.push(r)}if(r.submission_id){const m=toDateKey(r.submitted_at||r.created_at);m&&(l[m]||(l[m]={deadlines:[],submissions:[]})).submissions.push(r)}}const d=["T2","T3","T4","T5","T6","T7","CN"].map(r=>`<div class="cal-weekday">${r}</div>`).join("");let c="";for(let r=0;r<o;r++)c+='<div class="cal-cell empty"></div>';for(let r=1;r<=a;r++){const m=`${e}-${String(n+1).padStart(2,"0")}-${String(r).padStart(2,"0")}`,u=l[m],g=m===toDateKey(new Date);let h="";u&&(u.deadlines.length&&(h+=`<span class="cal-dot deadline" title="${u.deadlines.length} deadline"></span>`),u.submissions.length&&(h+=`<span class="cal-dot submitted" title="${u.submissions.length} \u0111\xE3 n\u1ED9p"></span>`)),c+=`
    ...
    ${n.map(s=>`
      <a href="#/${s.submission_id?"result":"assignment"}/${s.id}" class="cal-event-item">
        ...
        <span class="cal-event-title">${escapeHtml(s.title)}</span>
        <span class="cal-event-status">${s.submission_id?"\u2705 \u0110\xE3 n\u1ED9p":"\u23F3 H\u1EA1n"}</span>
      </a>`).join("")}`}},renderProfile=function(t,e){e=e||window._cachedProfileData||{fields:[],answers:{}};const n=(e.fields||[]).find(y=>y.field_key==="notification_email"),i=(e.fields||[]).filter(y=>y.field_key!=="notification_email"),s=_student&&typeof _student.email=="string"&&_student.email.trim()||e.student&&typeof e.student.email=="string"&&e.student.email.trim()||(n?String(e.answers?.[n.id]||"").trim():""),o=calculateSubmissionStreak(t,window._cachedVocabSessions||[]),a=getTargetSettings(),l=getSubmittedAssignments(t),d=calculateOverallAverage(t),c=d!==null?d.toFixed(2):"\u2014",p=SKILL_ORDER.map(y=>{const x=getSkillGradedAssignments(t,y).map(C=>Number(C.overall_score)).filter(Number.isFinite);return{sk:y,best:x.length?Math.max(...x):null}}),r=new Set(l.map(y=>toDateKey(y.submitted_at||y.created_at)).filter(Boolean)),m=new Set(o.days),u=[];for(let y=6;y>=0;y--){const x=new Date;x.setDate(x.getDate()-y);const C=toDateKey(x),L=x.toLocaleDateString("vi-VN",{weekday:"short"});u.push(`<div class="home-streak-day ${m.has(C)?"on":""}" title="${C}">
      <div class="streak-dot">${m.has(C)?"\u{1F525}":"\xB7"}</div>
      <div class="streak-day-label">${L}</div>
    </div>`)}const g=(_myVocabCache||[]).length,h=(_student.full_name||"?").split(" ").map(y=>y[0]).join("").slice(0,2).toUpperCase(),v=o.current>=30?"#dc2626":o.current>=7?"#f59e0b":"#6b7280",f={reading:"#0f766e",listening:"#7c3aed",writing:"#d97706",speaking:"#dc2626"},_=[];p.forEach(({sk:y,best:x})=>{x!==null&&_.push(`<div class="ms-card"><div class="ms-icon">${SKILL_ICONS[y]}</div><div class="ms-val">${x}</div><div class="ms-label">Best ${SKILL_LABELS[y]}</div></div>`)}),l.length>0&&_.push(`<div class="ms-card"><div class="ms-icon">\u{1F4DD}</div><div class="ms-val">${l.length}</div><div class="ms-label">B\xE0i \u0111\xE3 n\u1ED9p</div></div>`),o.best>1&&_.push(`<div class="ms-card"><div class="ms-icon">\u{1F525}</div><div class="ms-val">${o.best}</div><div class="ms-label">Streak k\u1EF7 l\u1EE5c</div></div>`),g>0&&_.push(`<div class="ms-card"><div class="ms-icon">\u{1F4D6}</div><div class="ms-val">${g}</div><div class="ms-label">T\u1EEB \u0111\xE3 l\u01B0u</div></div>`);const S=[["profile-info","\u{1F4CB} Th\xF4ng tin"],["profile-streak","\u{1F525} Streak"],["profile-targets","\u{1F3AF} Target"],["profile-progress","\u{1F4C8} Ti\u1EBFn \u0111\u1ED9"],..._.length>0?[["profile-achievements","\u{1F3C6} Th\xE0nh t\xEDch"]]:[],["profile-next-steps","\u{1F680} Ti\u1EBFp t\u1EE5c h\u1ECDc"]];$("#app").innerHTML=`
    <div class="container profile-page">
      <div class="profile-hero">
        <div class="profile-avatar" style="background:${f.reading}">${h}</div>
        <div class="profile-hero-info">
          ...
          <div class="profile-meta">L\u1EDBp ${escapeHtml(_selectedClass.class_name)}</div>
          <div class="profile-meta-row">
            <span class="profile-streak" style="color:${v}">\u{1F525} ${o.current} ng\xE0y</span>
            <span class="profile-dot">\xB7</span>
    ...
    </div>`}function renderWritingFeedback(t,e=null){const n=t.teacher_feedback||{},i=(n.annotations||[]).sort((f,_)=>f.start-_.start),s=n.overall||"",o=t.overall_score??n.score,a=countWords(t.writing_content||""),l=e?[...e].sort((f,_)=>(_.attempt_number||1)-(f.attempt_number||1)):null,c=(l?l[0]:t).rewrite_status==="requested",p=e&&e.length>1,r=s?`
    ...
    </div>`}function renderSpeakingFeedback(t,e=null){const n=t.teacher_feedback||{},i=(n.annotations||[]).sort((v,f)=>v.start-f.start),s=n.overall||"",o=t.overall_score??n.score,a=e?[...e].sort((v,f)=>(f.attempt_number||1)-(v.attempt_number||1)):null,d=(a?a[0]:t).rewrite_status==="requested",c=e&&e.length>1,p=s?`
    <div class="section-label">Nh\u1EADn x\xE9t t\u1ED5ng th\u1EC3</div>
    ...
    <div class="assignment-page">
    ...
    </div>`;const o=3;let a="";for(const l of i){const d=s[l];if(!d||d.length===0)continue;const c=!!_vocabExpanded[l],p=c?d:d.slice(0,o),r=d.length-o,m=p.map(g=>`
      ...
      </a>`).join(""),u=!c&&r>0?`<button class="vocab-show-more" onclick="vocabToggleSkill('${l}')">+ Xem th\xEAm ${r} b\xE0i</button>`:c&&d.length>o?`<button class="vocab-show-more" onclick="vocabToggleSkill('${l}')">\u2212 Thu g\u1ECDn</button>`:"";a+=`
    ...
    <div class="assignment-page">
      ...
      </tr>${r}`}).join(""),a=t.correct_count,l=t.total_count||e.length;$("#app").innerHTML=`
    <div class="assignment-page">
      <div class="assignment-toolbar">
  ...
  `).join(""),o=i.length===0?`<div class="empty-hint">Kh\xF4ng c\xF3 \u0111\u1EC1 n\xE0o${_sharedSkillFilter!=="all"?" cho k\u1EF9 n\u0103ng n\xE0y":""}.</div>`:i.map(a=>{const l=(a.tags||[]).map(p=>`<span class="tag-chip">${escapeHtml(p)}</span>`).join(""),d=a.real_test_count>0&&a.best_score!=null,c=a.real_test_count>0?`<div class="shared-card-stats">
    ...
    </div>`}function setSharedSkillFilter(t,e){_sharedSkillFilter=t;const n=$("#shared-pool-search");_sharedSearchQuery=n?n.value.toLowerCase().trim():"",_renderSharedPoolList(e)}function filterSharedPool(t){const e=$("#shared-pool-search");_sharedSearchQuery=e?e.value.toLowerCase().trim():"";const n=["all","reading","listening","writing","speaking"],i={all:"T\u1EA5t c\u1EA3",reading:"Reading",listening:"Listening",writing:"Writing",speaking:"Speaking"},s=t.filter(a=>{const l=_sharedSkillFilter==="all"||a.skill===_sharedSkillFilter,d=!_sharedSearchQuery||a.title.toLowerCase().includes(_sharedSearchQuery)||(a.tags||[]).some(c=>c.toLowerCase().includes(_sharedSearchQuery));return l&&d}),o=$("#shared-pool-grid");if(o){if(s.length===0){o.innerHTML='<div class="empty-hint">Kh\xF4ng t\xECm th\u1EA5y \u0111\u1EC1 n\xE0o.</div>';return}o.innerHTML=s.map(a=>{const l=(a.tags||[]).map(p=>`<span class="tag-chip">${escapeHtml(p)}</span>`).join(""),d=a.real_test_count>0&&a.best_score!=null,c=a.real_test_count>0?`<div class="shared-card-stats"><span>\u{1F3AF} ${a.real_test_count} l\u1EA7n thi</span>${d?`<span>\u{1F3C6} Best: ${a.best_score}</span>`:""}</div>`:'<div class="shared-card-stats" style="color:var(--gray-400)">Ch\u01B0a thi l\u1EA7n n\xE0o</div>';return`
    <div class="shared-card" onclick="navigate('/shared-pool/${a.id}')">
    ...
    <div class="assignment-page">
      ...
      </div>`,bindReadingTextInteractions("practice-reading-text")}catch(a){if(routeChanged(o))return;toast("L\u1ED7i t\u1EA3i b\xE0i: "+(a.error||a.message),"error"),navigate("/shared-pool")}}async function submitSharedPractice(t,e,n){const i=_sharedCtx?.poolQ,s=i?i.questions_data.filter(c=>t.includes(c.q_no)):t.map(c=>({q_no:c,answers:[]})),o=t.map(c=>({q_no:c,answer:($(`#sprac-${c}`)?.value||"").trim()}));btnLoading(n);let a=0;const l=t.map(c=>{const p=s.find(u=>u.q_no===c)||{q_no:c,answers:[]},r=(o.find(u=>u.q_no===c)?.answer||"").trim(),m=(p.answers||[]).some(u=>u.toLowerCase().trim()===r.toLowerCase());return m&&a++,`
      <tr>
  ...
  `;const i=document.getElementById("profile-name-input");i?.focus(),i?.select(),i?.addEventListener("keydown",s=>{s.key==="Enter"&&saveProfileName(),s.key==="Escape"&&renderProfile(window._cachedAssignments||[],window._cachedProfileData)})}async function saveProfileName(){const t=document.getElementById("profile-name-input");if(!t)return;const e=t.value.trim();if(!e){t.focus();return}t.disabled=!0;let n=!1;try{await api.patch("/student/me",{full_name:e}),n=!0}catch(i){t.disabled=!1,t.focus(),toast(i?.error||"Kh\xF4ng th\u1EC3 c\u1EADp nh\u1EADt t\xEAn","error")}if(n){updateStudentState({full_name:e});const i=document.getElementById("header-student-name");i&&(i.textContent=e),renderProfile(window._cachedAssignments||[],window._cachedProfileData)}}window.startEditProfileName=startEditProfileName,window.saveProfileName=saveProfileName;let _compositeExam=null,_activeSectionId=null;function stopCompositeSectionTimer(){stopAssignmentCountdown()}async function showCompositeExam({id:t}){setLoading("\u0110ang t\u1EA3i \u0111\u1EC1 t\u1ED5ng h\u1EE3p...");const e=routeToken();try{const n=await api.get(`/student/assignments/${t}`);if(routeChanged(e))return;n.sections&&(n.sections=n.sections.map(i=>({...i,question_count:Array.isArray(i.questions_data)?i.questions_data.length:0}))),_compositeExam=n,_activeSectionId=null,stopCompositeSectionTimer(),renderCompositeExam(n)}catch(n){if(routeChanged(e))return;toast("L\u1ED7i t\u1EA3i \u0111\u1EC1: "+(n.error||n.message),"error"),navigate("/assignments")}}window.showCompositeExam=showCompositeExam;function renderCompositeExam(t){stopAssignmentCountdown();const e=t.sections||[],n=e.length>0&&e.every(a=>a.submission_id),i=!t.is_active,s=e.map(a=>{const l=!!a.submission_id,d=SKILL_ICONS[a.skill]||"\u{1F4DD}",c=a.question_count>0?`${a.question_count} c\xE2u`:"",p=a.time_limit_minutes?`\u23F1 ${a.time_limit_minutes} ph\xFAt`:"",r=[c,p].filter(Boolean).join(" \xB7 "),m=l?`<span class="badge badge-done" style="font-size:11px">\u2713 \u0110\xE3 n\u1ED9p${n&&a.score!=null?` \xB7 Band ${a.score}`:""}</span>`:i?'<span class="badge badge-closed" style="font-size:11px">\u{1F512} \u0110\xE3 \u0111\xF3ng</span>':'<span class="badge badge-pending" style="font-size:11px">Ch\u01B0a l\xE0m</span>',u=l?n:!i,g=l?n?`#/composite-result/${t.id}/section/${a.submission_id}`:"":i?"":`#/composite/${t.id}/section/${a.id}`,h=l&&!n?'<div style="font-size:12px;color:var(--gray-400);margin-top:6px">\u{1F512} Ho\xE0n th\xE0nh c\xE1c ph\u1EA7n c\xF2n l\u1EA1i \u0111\u1EC3 xem k\u1EBFt qu\u1EA3</div>':"",v=l&&!n?"\u{1F512}":"\u203A";return`
      <${u&&g?`a href="${g}"`:"div"} class="assignment-card${l?" done":""}${i&&!l?" assignment-card-closed":""}" style="margin-bottom:10px">
        ...
        <div class="assignment-card-body">
          ...
          <div class="assignment-card-meta">${skillBadge(a.skill)} ${m} ${r?`<span style="font-size:12px;color:var(--gray-400)">${r}</span>`:""}</div>
          ${h}
        </div>
        <div class="assignment-card-right"><span class="card-chevron">${v}</span></div>
      </${u&&g?"a":"div"}>`}).join(""),o=n?`<div style="margin-top:24px;text-align:center">
    ...
    <div class="assignment-page" style="max-width:700px;margin:0 auto">
      ...
      <div style="padding:16px 0 32px">
        ...
        <button class="q-flag-btn${m}" data-flag-q="${r}" onclick="toggleFlag(${r})" title="\u0110\xE1nh d\u1EA5u xem l\u1EA1i" aria-label="\u0110\xE1nh d\u1EA5u xem l\u1EA1i">\u{1F6A9}</button>
      </div>`}d=`
      <div class="assignment-content">
        <div class="content-pane" id="reading-content-pane">
          <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;margin-bottom:16px">
      ...
      </div>`,c=()=>{restoreAnswerDraft(s,a),_compositeExam.mode!=="practice"&&setupLockedListeningAudio(),bindReadingTextInteractions(),updateNavigatorState(),startAutoSave(()=>persistAnswerDraft(s,a))}}else e.skill==="writing"?(d=`
      <div class="assignment-content">
        <div class="content-pane">
          <div class="section-title">\u0110\u1EC1 b\xE0i</div>
