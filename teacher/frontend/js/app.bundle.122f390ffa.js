...
`),n=[];let i=null;const o=()=>{i&&(n.push(`</${i}>`),i=null)};for(const s of e){const a=s.trim();if(!a){o();continue}const r=a.match(/^[-*]\s+(.+)$/),l=a.match(/^\d+\.\s+(.+)$/);if(r||l){const d=r?"ul":"ol";i!==d&&(o(),n.push(`<${d}>`),i=d),n.push(`<li>${renderMarkdownInline((r||l)[1])}</li>`);continue}o();const c=a.match(/^(#{2,4})\s+(.+)$/);c?n.push(`<h5>${renderMarkdownInline(c[2])}</h5>`):n.push(`<p>${renderMarkdownInline(a)}</p>`)}return o(),n.join("")}function btnReset(t){t&&(t.disabled=!1,t.innerHTML=t._origHTML||t.innerHTML)}function toast(t,e="success"){const n=e==="error"?6e3:3500,i=document.createElement("div");i.className=`toast toast-${e}`,i.setAttribute("role","alert");const o=document.createElement("span");o.textContent=t;const s=document.createElement("button");s.className="toast-close",s.setAttribute("aria-label","\u0110\xF3ng th\xF4ng b\xE1o"),s.textContent="\xD7",s.onclick=()=>i.remove(),i.appendChild(o),i.appendChild(s),i.addEventListener("mouseenter",()=>i.classList.add("toast-paused")),i.addEventListener("mouseleave",()=>i.classList.remove("toast-paused")),$("#toast-container").appendChild(i);const a=setTimeout(()=>i.remove(),n);i.addEventListener("mouseenter",()=>clearTimeout(a)),i.addEventListener("mouseleave",()=>setTimeout(()=>i.remove(),1e3))}function setLoading(t="\u0110ang t\u1EA3i..."){$("#app").innerHTML=`
    ...
    `);const l=$("#modal-overlay"),c=l?.querySelector("#prompt-action-input"),d=l?.querySelector("#prompt-action-error"),u=l?.querySelector('[data-prompt-action="cancel"]'),g=l?.querySelector('[data-prompt-action="confirm"]');let h=!1;const m=w=>{h||(h=!0,window._modalCloseCallback=null,closeModal(),r(w))};window._modalCloseCallback=()=>m(null);const f=()=>{const w=c?.value??"",b=w.trim(),C=typeof a=="function"?a(b,w):"";if(C){d&&(d.textContent=C),c?.focus(),c?.select?.();return}m(b)};u.onclick=()=>m(null),g.onclick=f,c?.addEventListener("keydown",w=>{w.key==="Enter"&&(w.preventDefault(),f())}),l.onclick=w=>{w.target===l&&m(null)},requestAnimationFrame(()=>{c?.focus(),c?.select?.()})})}let _oneTimeStudentCredentials=null;function closeModal(t){const e=$("#modal-overlay");t&&t.target!==e||(_oneTimeStudentCredentials=null,e&&(e.onclick=n=>closeModal(n)),window._modalCloseCallback&&(window._modalCloseCallback(),window._modalCloseCallback=null),e.classList.add("hidden"),$("#modal-body").innerHTML="",_modalPreviousFocus&&(_modalPreviousFocus.focus(),_modalPreviousFocus=null))}document.addEventListener("keydown",t=>{const e=$("#modal-overlay");if(!e||e.classList.contains("hidden"))return;const n=e.querySelector(".modal")||e;if(t.key==="Escape"){closeModal();return}if(t.key==="Tab"){const i=[...n.querySelectorAll(FOCUSABLE)];if(!i.length)return;const o=i[0],s=i[i.length-1];(t.shiftKey?document.activeElement===o:document.activeElement===s)&&(t.preventDefault(),(t.shiftKey?s:o).focus())}});function splitDelimitedList(t,e=/\n/){return String(t||"").split(e).map(n=>n.trim()).filter(Boolean)}function csvEscape(t){return`"${String(t??"").replace(/"/g,'""')}"`}function downloadCsvFile(t,e,n){const i=[e,...n].map(r=>r.map(csvEscape).join(",")).join(`
`),o=new Blob(["\uFEFF"+i],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(o),a=document.createElement("a");a.href=s,a.download=t,a.click(),URL.revokeObjectURL(s)}async function downloadAudioFile(t,e,n){if(!t)return;const i=n?n.innerHTML:"";try{n&&(n.disabled=!0,n.innerHTML="\u23F3");const o=await fetch(t,{cache:"no-store"});if(!o.ok)throw new Error("fetch failed");const s=await o.blob(),a=(t.split("?")[0].match(/\.([a-zA-Z0-9]+)$/)||[])[1],r=(s.type.split("/")[1]||"").split(";")[0],l=a||r||"webm",c=(e||"audio").replace(/\.[a-zA-Z0-9]{2,5}$/,""),d=URL.createObjectURL(s),u=document.createElement("a");u.href=d,u.download=`${c}.${l}`,document.body.appendChild(u),u.click(),u.remove(),URL.revokeObjectURL(d)}catch(o){toast("T\u1EA3i file th\u1EA5t b\u1EA1i: "+(o.message||"l\u1ED7i kh\xF4ng x\xE1c \u0111\u1ECBnh"),"error")}finally{n&&(n.disabled=!1,n.innerHTML=i)}}window.downloadAudioFile=downloadAudioFile;const AUDIO_SKIP_SECONDS=10,AUDIO_SPEEDS=[1,1.25,1.5,2,2.5,3];function _audioBlockTrack(t){return t?.closest?.(".audio-block")?.querySelector("audio")||null}function nudgeAudio(t,e){const n=_audioBlockTrack(t);if(!n)return;const i=Number.isFinite(n.duration)?n.duration:1/0;n.currentTime=Math.min(i,Math.max(0,n.currentTime+e))}window.nudgeAudio=nudgeAudio;function setAudioRate(t){const e=_audioBlockTrack(t);e&&(e.playbackRate=Number(t.value)||1)}window.setAudioRate=setAudioRate;function audioPlayerBlock(t){return`<div class="audio-block">
      ${t}
      <div class="audio-tools">
        <button type="button" class="audio-tool-btn" title="L\xF9i ${AUDIO_SKIP_SECONDS} gi\xE2y"
                onclick="nudgeAudio(this,-${AUDIO_SKIP_SECONDS})">\xAB ${AUDIO_SKIP_SECONDS}s</button>
        <button type="button" class="audio-tool-btn" title="Ti\u1EBFn ${AUDIO_SKIP_SECONDS} gi\xE2y"
                onclick="nudgeAudio(this,${AUDIO_SKIP_SECONDS})">${AUDIO_SKIP_SECONDS}s \xBB</button>
        <label class="audio-speed">
          <span>T\u1ED1c \u0111\u1ED9</span>
          <select class="audio-speed-select" onchange="setAudioRate(this)" aria-label="T\u1ED1c \u0111\u1ED9 ph\xE1t">
            ${AUDIO_SPEEDS.map(e=>`<option value="${e}">x${e}</option>`).join("")}
          </select>
        </label>
      </div>
    </div>`}function buildStudentCredentialsFilename(t="student_accounts"){const e=new Date().toISOString().replace(/[-:]/g,"").replace(/\.\d{3}Z$/,"Z");return`${t}_${e}.csv`}function openStudentCredentialsModal(t,e,n="student_accounts"){const i=(Array.isArray(e)?e:[]).map(o=>({full_name:String(o?.full_name||"").trim(),username:String(o?.username||"").trim(),password:String(o?.password||"")})).filter(o=>o.full_name&&o.username&&o.password);_oneTimeStudentCredentials=i.length>0?{rows:i,fileName:buildStudentCredentialsFilename(n)}:null,openModal(t,`
    ...
    </div>`}window.showHistogramStudents=showHistogramStudents;function renderStatsTab(t,e){destroyStatsCharts();const{timeline:n,per_student:i,per_assignment:o}=e,s=_statsSkillFilter,a=_statsStatusFilter,r=_statsModeFilter,l=_statsScaleFilter,c=o.filter(p=>!(s&&p.skill!==s||a==="active"&&!p.is_active||a==="closed"&&p.is_active||r&&p.mode!==r||l&&(p.scoring_scale||"10")!==l)),d=new Set(c.map(p=>p.id)),u=p=>p.length?p.reduce((v,y)=>v+y,0)/p.length:null,g=i.length,h=c.length,m=c.filter(p=>p.is_active).length,f=h-m,w=new Map;i.forEach(p=>{p.submissions.forEach(v=>{if(!d.has(v.assignment_id))return;const y=`${p.id||p.student_id}:${v.assignment_id}`,k=w.get(y);(!k||(v.attempt_number||1)>(k.attempt_number||1))&&w.set(y,{...v,student_name:p.name})})});const b=Array.from(w.values()),C=b.filter(p=>p.overall_score!==null);_statsAllScoredSubs=C;const L=u(C.map(p=>Number(p.overall_score))),I=h*g,q=I>0?Math.round(b.length/I*100):0,H=[0,0,0,0,0];for(const p of C){const v=Number(p.overall_score),y=v>=9?4:Math.min(4,Math.floor(v/2));H[y]++}const P=["reading","listening","writing","speaking"],V={},Q={};for(const p of P){const v=C.filter(_=>_.skill===p);V[p]=u(v.map(_=>Number(_.overall_score)));const y=c.filter(_=>_.skill===p),k=b.filter(_=>_.skill===p),B=y.length*g;Q[p]={count:y.length,submitted:k.length,pct:B>0?Math.round(k.length/B*100):0}}let F=i.map(p=>{const v=p.submissions.filter(T=>d.has(T.assignment_id)),y=new Map;v.forEach(T=>{const x=y.get(T.assignment_id);(!x||(T.attempt_number||1)>(x.attempt_number||1))&&y.set(T.assignment_id,T)});const k=Array.from(y.values()),B=k.filter(T=>T.overall_score!==null),_=T=>u(B.filter(x=>x.skill===T).map(x=>Number(x.overall_score))),S=k.filter(T=>!T.is_active&&T.deadline),E=S.filter(T=>T.on_time).length;return{...p,submitted:k.length,total:h,avg_score:s?_(s):u(B.map(T=>Number(T.overall_score))),avg_reading:_("reading"),avg_listening:_("listening"),avg_writing:_("writing"),avg_speaking:_("speaking"),on_time:E,closed_total:S.length,on_time_rate:S.length>0?E/S.length:null}});_statsSortCol&&(F=[...F].sort((p,v)=>{let y=p[_statsSortCol],k=v[_statsSortCol];return y==null?1:k==null?-1:typeof y=="string"?_statsSortDir==="asc"?y.localeCompare(k):k.localeCompare(y):_statsSortDir==="asc"?y-k:k-y}));const R=p=>p!=null?Number(p).toFixed(1):"\u2014",U=(p,v)=>v>0?Math.round(p/v*100):0,M=p=>_statsSortCol!==p?'<span class="sort-icon">\u2195</span>':`<span class="sort-icon active">${_statsSortDir==="asc"?"\u2191":"\u2193"}</span>`,O={reading:"#3b82f6",listening:"#f59e0b",writing:"#8b5cf6",speaking:"#22c55e"},z=["#3b82f6","#ef4444","#22c55e","#f59e0b","#8b5cf6","#06b6d4","#ec4899","#14b8a6","#f97316","#a3e635"],G={reading:"Reading",listening:"Listening",writing:"Writing",speaking:"Speaking",composite:"T\u1ED5ng h\u1EE3p"},Y=`
    <div class="stats-cards-grid">
      <div class="stats-card">
        <div class="stats-card-icon" style="background:#e0f2fe;color:#0284c7">\u{1F465}</div>
        <div class="stats-card-body">
          <div class="stats-card-value">${g}</div>
      ...
      <div class="stats-card">
        ...
        <div class="stats-card-body">
          ...
          <div class="stats-card-label">${m} \u0111ang m\u1EDF \xB7 ${f} \u0111\xE3 \u0111\xF3ng</div>
        </div>
      </div>
      <div class="stats-card">
        ...
        <div class="stats-card-body">
          ...
          <div class="stats-card-label">${b.length} / ${I} l\u01B0\u1EE3t n\u1ED9p</div>
        </div>
      </div>
      <div class="stats-card">
        <div class="stats-card-icon" style="background:var(--primary-lt);color:var(--primary)">\u{1F3AF}</div>
        <div class="stats-card-body">
          <div class="stats-card-value">${L!==null?Number(L).toFixed(2):"\u2014"}</div>
      ...
      <div class="stats-skill-chart">
        ${["reading","listening","writing","speaking"].map(p=>{const v=Q[p];return!v||v.count===0?"":`<div class="stats-skill-row">
            ...
            <div class="stats-bar-wrap">
              <div class="stats-bar-fill" style="width:${v.pct}%;background:${O[p]}"></div>
            </div>
            <div class="stats-pct">${v.pct}% &nbsp;<span style="color:var(--gray-400)">(${v.submitted}/${v.count*g} n\u1ED9p)</span></div>
          </div>`}).join("")}
      </div>
    </div>`,tt=`
    ...
    </div>`,j=c.filter(p=>!p.is_active&&p.deadline),D=_closedAssignsSearch?j.filter(p=>p.title.toLowerCase().includes(_closedAssignsSearch)):j,W=3,N=_closedAssignsExpanded?D:D.slice(0,W),it=D.length-N.length,ot=j.length===0?"":`
    <div class="stats-section-card">
      ...
      ${D.length===0?'<p style="color:var(--gray-400);font-size:13px;padding:8px 0 4px">Kh\xF4ng t\xECm th\u1EA5y b\xE0i t\u1EADp ph\xF9 h\u1EE3p</p>':`<canvas id="chart-ontime" height="${Math.max(80,N.length*38)}"></canvas>`}
      ${D.length>W?`
    ...
    <div class="stats-section-card">
      ...
      ${F.length===0?'<div class="empty-state" style="padding:20px">Kh\xF4ng c\xF3 d\u1EEF li\u1EC7u</div>':`<div class="table-wrap">
          <table class="stats-table">
            ...
            <tbody>
              ${F.map(p=>{const v=U(p.submitted,p.total),y=p.on_time_rate!==null?Math.round(p.on_time_rate*100):null;return`<tr>
                  ...
                  <td><span class="stats-score-badge">${R(p.avg_score)}</span></td>
                  ${s?"":`
                    <td style="color:#3b82f6">${R(p.avg_reading)}</td>
                    <td style="color:#f59e0b">${R(p.avg_listening)}</td>
                    <td style="color:#8b5cf6">${R(p.avg_writing)}</td>
                    <td style="color:#22c55e">${R(p.avg_speaking)}</td>`}
                  <td>${y!==null?`<span class="stats-ontime-pill ${y>=80?"good":y>=50?"mid":"bad"}">${y}%</span>`:'<span style="color:var(--gray-400)">\u2014</span>'}</td>
                  <td>
    ...
    </div>`,A=p=>makeSortIcon(p,_assignTableSortCol,_assignTableSortDir),X=[...c];_assignTableSortCol&&X.sort((p,v)=>{let y,k;switch(_assignTableSortCol){case"title":y=p.title.toLowerCase(),k=v.title.toLowerCase();break;case"skill":y=p.skill||"",k=v.skill||"";break;case"mode":y=p.mode||"",k=v.mode||"";break;case"submitted_rate":y=p.total?p.submitted/p.total:0,k=v.total?v.submitted/v.total:0;break;case"avg_score":y=p.avg_score??-1,k=v.avg_score??-1;break;case"on_time":y=p.on_time??-1,k=v.on_time??-1;break;case"late":y=p.late??-1,k=v.late??-1;break;case"missing":y=p.missing??-1,k=v.missing??-1;break;case"is_active":y=p.is_active?1:0,k=v.is_active?1:0;break;default:return 0}return y<k?_assignTableSortDir==="asc"?-1:1:y>k?_assignTableSortDir==="asc"?1:-1:0});const ct=`
    <div class="stats-section-card">
      ...
      ${c.length===0?'<div class="empty-state" style="padding:20px">Kh\xF4ng c\xF3 b\xE0i t\u1EADp ph\xF9 h\u1EE3p</div>':`<div class="table-wrap">
          <table class="stats-table">
            ...
            <tbody>
              ${X.map(p=>{const v=U(p.submitted,p.total);return`<tr>
    ...
    ${Z}
    ${lt}
    ${ct}`,ensureChartJsLoaded().then(()=>requestAnimationFrame(()=>{const p=document.getElementById("chart-skill-score");if(p){const _=["reading","listening","writing","speaking"].filter(S=>V[S]!==null);if(_.length>0){const S=new Chart(p.getContext("2d"),{type:"bar",data:{labels:_.map(E=>G[E]),datasets:[{data:_.map(E=>Number(V[E]).toFixed(2)),backgroundColor:_.map(E=>O[E]+"cc"),borderColor:_.map(E=>O[E]),borderWidth:1,borderRadius:6}]},options:{indexAxis:"y",responsive:!0,plugins:{legend:{display:!1}},scales:{x:{min:0,max:9,grid:{color:"#f3f4f6"},ticks:{font:{size:11}}},y:{ticks:{font:{size:12}}}}}});_statsCharts.push(S)}else p.insertAdjacentHTML("afterend",'<p style="color:var(--gray-400);font-size:13px;padding:20px 0">Ch\u01B0a c\xF3 d\u1EEF li\u1EC7u \u0111i\u1EC3m</p>'),p.remove()}const v=document.getElementById("chart-score-dist");if(v)if(H.reduce((S,E)=>S+E,0)>0){const S=new Chart(v.getContext("2d"),{type:"bar",data:{labels:["0 \u2013 2","2 \u2013 4","4 \u2013 6","6 \u2013 8","8 \u2013 10"],datasets:[{label:"S\u1ED1 b\xE0i",data:H,backgroundColor:["#fca5a5","#fcd34d","#86efac","#67e8f9","#6ee7b7"],hoverBackgroundColor:["#f87171","#fbbf24","#4ade80","#22d3ee","#34d399"],borderRadius:6}]},options:{responsive:!0,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,ticks:{stepSize:1,font:{size:11}},grid:{color:"#f3f4f6"}},x:{ticks:{font:{size:11}}}},onClick:(E,T)=>{T.length&&showHistogramStudents(T[0].index)},onHover:(E,T)=>{E.native.target.style.cursor=T.length?"pointer":"default"}}});_statsCharts.push(S)}else v.insertAdjacentHTML("afterend",'<p style="color:var(--gray-400);font-size:13px;padding:20px 0">Ch\u01B0a c\xF3 b\xE0i n\xE0o \u0111\u01B0\u1EE3c ch\u1EA5m \u0111i\u1EC3m</p>'),v.remove();const y=document.getElementById("chart-trend");if(y){const _=[...o].reverse().filter(x=>!(_statsTrendSkill&&x.skill!==_statsTrendSkill||_statsModeFilter&&x.mode!==_statsModeFilter||_statsScaleFilter&&(x.scoring_scale||"10")!==_statsScaleFilter)),S=_.map(x=>x.title.length>18?x.title.slice(0,16)+"\u2026":x.title),E=i.map((x,dt)=>{const J=z[dt%z.length];return{label:x.name,_studentId:x.id,data:_.map(ut=>{const K=x.submissions.find(pt=>pt.assignment_id===ut.id);return K&&K.overall_score!==null?Number(K.overall_score):null}),borderColor:J,backgroundColor:J+"22",borderWidth:2,pointRadius:5,pointHoverRadius:7,fill:!1,tension:.3,spanGaps:!0}});if(_.length<1){y.style.display="none";const x=document.getElementById("trend-empty-msg");x&&(x.style.display="")}const T=new Chart(y.getContext("2d"),{type:"line",data:{labels:S,datasets:E},options:{responsive:!0,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{filter:x=>x.raw!==null,callbacks:{title:x=>x[0]?.label||"",label:x=>` ${x.dataset.label}: ${x.raw!==null?Number(x.raw).toFixed(1):"\u2014"}`}}},scales:{y:{min:0,max:9,ticks:{font:{size:11}},grid:{color:"#f3f4f6"}},x:{ticks:{font:{size:10},maxRotation:30}}}}});_statsCharts.push(T)}const k=document.getElementById("chart-timeline");if(k&&n.length>=2){const _=new Chart(k.getContext("2d"),{type:"line",data:{labels:n.map(S=>{const E=new Date(S.week);return`${E.getDate()}/${E.getMonth()+1}`}),datasets:[{label:"L\u01B0\u1EE3t n\u1ED9p",data:n.map(S=>S.count),borderColor:"#0f766e",backgroundColor:"#0f766e22",borderWidth:2,pointRadius:4,fill:!0,tension:.3}]},options:{responsive:!0,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,ticks:{stepSize:1,font:{size:11}},grid:{color:"#f3f4f6"}},x:{ticks:{font:{size:11}}}}}});_statsCharts.push(_)}const B=document.getElementById("chart-ontime");if(B&&N.length>0){const _=new Chart(B.getContext("2d"),{type:"bar",data:{labels:N.map(S=>S.title.length>22?S.title.slice(0,20)+"\u2026":S.title),datasets:[{label:"\u0110\xFAng h\u1EA1n",data:N.map(S=>S.on_time),backgroundColor:"#86efac",borderRadius:4},{label:"N\u1ED9p mu\u1ED9n",data:N.map(S=>S.late),backgroundColor:"#fcd34d",borderRadius:4},{label:"Ch\u01B0a n\u1ED9p",data:N.map(S=>S.missing||0),backgroundColor:"#fca5a5",borderRadius:4}]},options:{indexAxis:"y",responsive:!0,plugins:{legend:{position:"bottom",labels:{font:{size:11}}}},scales:{x:{stacked:!0,ticks:{stepSize:1,font:{size:11}},grid:{color:"#f3f4f6"}},y:{stacked:!0,ticks:{font:{size:11}}}}}});_statsCharts.push(_)}})).catch(()=>{const p=t.querySelector(".stats-charts-row");p&&p.insertAdjacentHTML("beforebegin",'<div class="empty-state" style="margin-bottom:16px"><p>Kh\xF4ng th\u1EC3 t\u1EA3i bi\u1EC3u \u0111\u1ED3 l\xFAc n\xE0y. B\u1EA1n v\u1EABn c\xF3 th\u1EC3 xem d\u1EEF li\u1EC7u d\u1EA1ng b\u1EA3ng b\xEAn d\u01B0\u1EDBi.</p></div>')})}function toggleStudentStatsRow(t){const e=document.getElementById(`stats-row-${t}`);e&&(e.style.display=e.style.display==="none"?"":"none")}window.toggleStudentStatsRow=toggleStudentStatsRow;function buildStatsSubRows(t){return t.length===0?'<tr><td colspan="5" style="color:var(--gray-400);padding:12px">Ch\u01B0a n\u1ED9p b\xE0i n\xE0o</td></tr>':(_statsSubSortCol?[...t].sort((n,i)=>{let o,s;if(_statsSubSortCol==="title")o=(n.assignment_title||"").toLowerCase(),s=(i.assignment_title||"").toLowerCase();else if(_statsSubSortCol==="skill")o=n.skill||"",s=i.skill||"";else if(_statsSubSortCol==="score")o=n.overall_score??-1,s=i.overall_score??-1;else if(_statsSubSortCol==="submitted_at")o=n.submitted_at||"",s=i.submitted_at||"";else if(_statsSubSortCol==="on_time")o=n.on_time===null?-1:n.on_time?1:0,s=i.on_time===null?-1:i.on_time?1:0;else return 0;return o<s?_statsSubSortDir==="asc"?-1:1:o>s?_statsSubSortDir==="asc"?1:-1:0}):t).map(n=>`<tr>
    ...
    <td>${n.is_overtime?'<span class="stats-overtime-pill">\u23F0 Overtime</span>':"\u2014"}</td>
       ...
       </td></tr>`:t.assignments.map(a=>{const r=isOverdue(a.deadline)&&a.is_active,l=t.student_count>0?Math.round(a.submission_count/t.student_count*100):0,c=a.skill==="composite",d=c&&Array.isArray(a.composite_sections)?a.composite_sections.map(g=>`<span class="badge" style="background:var(--surface);border:1px solid var(--border);font-size:10px;padding:1px 5px">${{reading:"\u{1F4D6}",listening:"\u{1F3A7}",writing:"\u270D\uFE0F",speaking:"\u{1F3A4}"}[g.skill]||""} ${escapeHtml(g.label)}</span>`).join(" "):"",u=c?`/composite/${a.id}`:`/assignment/${a.id}`;return`
        <tr>
    ...
    </div>`,s=escapeJsAttr(t.class_name);$("#app").innerHTML=`
    ...
    <div id="tab-students" class="tab-content" style="display:none">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px">
        <div id="bulk-action-bar" class="bulk-action-bar hidden">
          ...
          <button class="btn btn-sm btn-outline" onclick="bulkRemoveStudents('${t.id}', this)">\u{1F5D1} Xo\xE1 kh\u1ECFi l\u1EDBp</button>
...
`),o=new Blob([i],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(o),a=document.createElement("a");a.href=s,a.download=`students_${t}.csv`,a.click(),URL.revokeObjectURL(s),toast(`\u0110\xE3 xu\u1EA5t ${n.length} h\u1ECDc sinh ra CSV`)}window.bulkExportCSV=bulkExportCSV;function buildStudentRows(t,e){return t.map(n=>`
    ...
    <div class="modal-footer">
      ...
      <button class="btn btn-primary" onclick="saveDeadline('${escapeJsAttr(t)}', this)">L\u01B0u</button>
    </div>
...
`),s=new Blob(["\uFEFF"+o],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(s),r=document.createElement("a");r.href=a,r.download=`${t.title.replace(/[^a-zA-Z0-9_\-]/g,"_")}_diem.csv`,r.click(),URL.revokeObjectURL(a)}window.exportSubmissionsCSV=exportSubmissionsCSV;function buildSubmissionRows(t,e){return t.length===0?`<tr><td colspan="5">
     ...
     </td></tr>`:t.map(n=>{const i=!!n.submission_id,o=n.overall_score!=null?`<span style="font-weight:700;color:var(--primary)">${n.overall_score}${e.scoring_scale==="10"?"/10":"/9"}</span>`:i?'<span style="color:var(--gray-400)">Ch\u1EDD ch\u1EA5m</span>':"\u2014",s=n.attempt_number||1,a=s>1?`<span class="badge" style="background:#e0e7ff;color:#3730a3;margin-left:4px"
           title="${n.attempt_kind==="retake"?"H\u1ECDc sinh t\u1EF1 l\xE0m l\u1EA1i c\xF3 t\xEDnh \u0111i\u1EC3m":"L\xE0m l\u1EA1i theo y\xEAu c\u1EA7u gi\xE1o vi\xEAn"}">
           ${n.attempt_kind==="retake"?"\u{1F3AF}":"\u270F\uFE0F"} L\u1EA7n ${s}
         </span>`:"",r=(i?'<span class="badge" style="background:#d1fae5;color:#065f46">\u2713 \u0110\xE3 n\u1ED9p</span>':'<span class="badge" style="background:#fee2e2;color:#991b1b">\u2717 Ch\u01B0a n\u1ED9p</span>')+a,l=i?`<button class="btn btn-sm btn-outline"
    ...
    </div>`}async function openSubmissionModal(t,e){if(e==="writing"||e==="speaking"){navigate(`/grading/${t}`);return}openModal("\u0110ang t\u1EA3i b\xE0i l\xE0m...",'<div class="loading-screen"><div class="spinner"></div></div>');try{const n=await api.get(`/submissions/${t}`);let i=null;try{i=await api.get(`/submissions/${t}/attempts`)}catch{}renderSubmissionModal(n,e,i,t)}catch(n){$("#modal-title").textContent="L\u1ED7i";const i=document.createElement("p");i.style.color="var(--danger)",i.textContent=n.error||n.message||"\u0110\xE3 x\u1EA3y ra l\u1ED7i",$("#modal-body").replaceChildren(i)}}function renderAttemptSwitcher(t,e,n){if(!Array.isArray(t)||t.length<2)return"";const i=[...t].sort((o,s)=>(s.attempt_number||1)-(o.attempt_number||1)).map((o,s)=>{const a=o.attempt_kind==="retake"?"\u{1F3AF} HS t\u1EF1 l\xE0m l\u1EA1i":o.attempt_kind==="rewrite"?"\u270F\uFE0F Theo y\xEAu c\u1EA7u GV":"L\u1EA7n n\u1ED9p \u0111\u1EA7u",r=o.overall_score!=null?` \xB7 ${o.overall_score}`:"",l=s===0?" \u2014 \u0111ang t\xEDnh \u0111i\u1EC3m":"";return`<option value="${o.id}" ${o.id===e?"selected":""}>L\u1EA7n ${o.attempt_number} \xB7 ${a}${r}${l}</option>`}).join("");return`
    <div style="margin-bottom:12px;display:flex;align-items:center;gap:10px;flex-wrap:wrap">
      <span style="font-size:13px;color:var(--gray-600)">L\u1EA7n l\xE0m:</span>
      <select onchange="openSubmissionModal(this.value, '${n}')"
              style="padding:6px 10px;border:1px solid var(--gray-300);border-radius:6px;font-size:13px;max-width:100%">
        ${i}
      </select>
    </div>`}function renderSubmissionModal(t,e,n=null,i=null){const o=renderAttemptSwitcher(n,i,e),s="";if(e==="reading"||e==="listening"){const a={};(t.questions_data||[]).forEach(d=>{a[d.q_no]=d.answers||[]});const r=(t.student_answers||[]).map(d=>{const u=a[d.q_no]||[],g=u.some(h=>h.toLowerCase().trim()===(d.answer||"").toLowerCase().trim());return`
        <tr>
          <td style="font-weight:600;text-align:center">Q${d.q_no}</td>
          <td>${escapeHtml(d.answer||"\u2014")}</td>
          <td style="color:var(--gray-400);font-size:12px">${u.join(" / ")}</td>
          <td style="text-align:center;font-size:16px">${g?"\u2705":"\u274C"}</td>
        </tr>`}).join(""),l=(t.student_answers||[]).filter(d=>(a[d.q_no]||[]).some(g=>g.toLowerCase().trim()===(d.answer||"").toLowerCase().trim())).length,c=(t.questions_data||[]).length;$("#modal-title").textContent=`B\xE0i l\xE0m \u2014 ${skillBadge(e).replace(/<[^>]+>/g,"")}`,$("#modal-body").innerHTML=`
      ${o}
      <div style="margin-bottom:12px;padding:12px 16px;background:var(--primary-lt);border-radius:8px;display:flex;gap:24px;align-items:center">
        <span style="font-size:20px;font-weight:700;color:var(--primary)">${t.overall_score??"\u2014"}${t.scoring_scale==="10"?"/10":"/9"}</span>
        <span style="color:var(--gray-600);font-size:13px">\u0110\xFAng ${l}/${c} c\xE2u</span>
      ...
      <div class="table-wrap" style="max-height:400px;overflow-y:auto">
        <table>
          ...
          <tbody>${r||'<tr><td colspan="4" style="text-align:center;color:var(--gray-400)">Kh\xF4ng c\xF3 \u0111\xE1p \xE1n</td></tr>'}</tbody>
        </table>
      ...
      </div>`;else if(e==="speaking"){$("#modal-title").textContent="B\xE0i Speaking";const a=Array.isArray(t.speaking_audio_urls)&&t.speaking_audio_urls.length>0?t.speaking_audio_urls:t.speaking_audio_url?[{url:t.speaking_audio_url,name:""}]:[],r=a.length>1,l=a.length>0?a.map((d,u)=>`
          <div style="${r?"margin-bottom:10px":""}">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:8px">
              ${r?`<div style="font-size:12px;font-weight:600;color:var(--gray-500)">${escapeHtml(d.name||"Ph\u1EA7n "+(u+1))}</div>`:"<div></div>"}
              <button type="button" class="btn-icon" title="T\u1EA3i xu\u1ED1ng" aria-label="T\u1EA3i xu\u1ED1ng" onclick="downloadAudioFile('${escapeJsAttr(d.url||"")}', '${escapeJsAttr((t.student_name||"speaking")+"_"+(d.name||"phan"+(u+1)))}', this)">\u{1F4E5}</button>
            </div>
            ${audioPlayerBlock(`<audio controls src="${escapeHtml(d.url||"")}" style="width:100%;border-radius:8px"></audio>`)}
          </div>`).join(""):'<div style="color:var(--gray-400);padding:16px;text-align:center">Kh\xF4ng c\xF3 file audio</div>',c=t.speaking_script?`<div style="margin-top:12px">
      ...
      </div>`}}async function initWaveform(t,e){const i=document.createElement("canvas");i.className="waveform-canvas",i.height=56,t.innerHTML="",t.appendChild(i);const o=i.getContext("2d");function s(){i.width=t.clientWidth||600}s(),window.addEventListener("resize",s);let a=null;function r(l){const c=i.width,d=i.height;if(o.clearRect(0,0,c,d),!a){o.fillStyle="var(--gray-200)";for(let g=0;g<200;g++){const h=g/200*c,m=d*.15+Math.random()*d*.1;o.fillRect(h+1,(d-m)/2,c/200-2,m)}return}const u=c/200;for(let g=0;g<200;g++){const h=Math.max(3,a[g]*d*.9),m=g*u,f=g/200<(l||0);o.fillStyle=f?"#0f766e":"#d1d5db",o.fillRect(m+1,(d-h)/2,Math.max(1,u-2),h)}if(l>0){const g=l*c;o.strokeStyle="var(--primary-dk)",o.lineWidth=2,o.beginPath(),o.moveTo(g,4),o.lineTo(g,d-4),o.stroke()}}r(0),i.addEventListener("click",l=>{if(!e.duration)return;const c=i.getBoundingClientRect();e.currentTime=(l.clientX-c.left)/c.width*e.duration}),e.addEventListener("timeupdate",()=>{e.duration&&r(e.currentTime/e.duration)}),e.addEventListener("seeked",()=>{e.duration&&r(e.currentTime/e.duration)});try{const c=await(await fetch(e.src)).arrayBuffer(),d=new(window.AudioContext||window.webkitAudioContext),u=await d.decodeAudioData(c);d.close();const g=u.getChannelData(0),h=Math.floor(g.length/200),m=[];for(let b=0;b<200;b++){let C=0;for(let L=0;L<h;L++)C+=Math.abs(g[b*h+L]||0);m.push(C/h)}const f=Math.max(...m,.001);a=m.map(b=>b/f),a=a.map((b,C)=>{const L=a[C-1]??b,I=a[C+1]??b;return L*.25+b*.5+I*.25}),r(e.duration?e.currentTime/e.duration:0);const w=u.duration;if(w>0){const b=document.getElementById("audio-dur-0");if(b&&(b.textContent=`\xB7 ${formatAudioDur(w)}`),!isFinite(e.duration)||e.duration<1)try{e.currentTime=w,e.currentTime=0}catch{}}}catch{a=Array.from({length:200},()=>.2+Math.random()*.3),r(0)}}function formatAudioDur(t){const e=Math.round(t);return`${Math.floor(e/60)}:${String(e%60).padStart(2,"0")}`}async function fixTrackAudioDuration(t){const e=document.getElementById(`track-audio-${t}`),n=document.getElementById(`audio-dur-${t}`);if(!e||!e.src)return;const i=()=>isFinite(e.duration)&&e.duration>0?(n&&(n.textContent=`\xB7 ${formatAudioDur(e.duration)}`),!0):!1;if(i())return;e.addEventListener("loadedmetadata",()=>{i()||o()},{once:!0});async function o(){try{const a=await(await fetch(e.src)).arrayBuffer(),r=new(window.AudioContext||window.webkitAudioContext),l=await r.decodeAudioData(a);r.close(),l.duration>0&&n&&(n.textContent=`\xB7 ${formatAudioDur(l.duration)}`)}catch{}}setTimeout(()=>{n&&!n.textContent&&o()},1500)}let _gradingAnnotations=[],_gradingSubmissionId=null,_gradingText="",_gradingSkill="",_gradingAiFeedback=null,_gradingVoiceNotes=[],_voiceNoteMediaRecorder=null,_voiceNoteChunks=[],_voiceNoteRecordIdx=-1,_voiceNoteRecordSeconds=0,_voiceNoteRecordTimer=null,_gradingInitialSignature=null;function _gradingSignature(){return _gradingSubmissionId==null?null:JSON.stringify({id:_gradingSubmissionId,overall:document.getElementById("overall-feedback")?.value||"",score:document.getElementById("grading-score")?.value||"",annotations:_gradingAnnotations,voiceNotes:_gradingVoiceNotes.map(t=>({url:t.url,name:t.displayName||t.name,status:t.status}))})}function isGradingDirty(){return _gradingInitialSignature==null?!1:_gradingSignature()!==_gradingInitialSignature}window.addEventListener("beforeunload",t=>{window.location.hash.includes("/grading/")&&isGradingDirty()&&(t.preventDefault(),t.returnValue="")});function gradingDraftKey(t){return`grading-draft:${t}`}function saveGradingDraftNow(){if(!(_gradingSubmissionId==null||!isGradingDirty()))try{localStorage.setItem(gradingDraftKey(_gradingSubmissionId),JSON.stringify({signature:_gradingSignature(),savedAt:Date.now()}))}catch{}}function loadGradingDraft(t){try{const e=localStorage.getItem(gradingDraftKey(t));return e?JSON.parse(e):null}catch{return null}}function clearGradingDraft(t){try{localStorage.removeItem(gradingDraftKey(t))}catch{}}let _gradingDraftInterval=null;function startGradingDraftAutosave(){stopGradingDraftAutosave(),_gradingDraftInterval=setInterval(saveGradingDraftNow,4e3)}function stopGradingDraftAutosave(){_gradingDraftInterval&&(clearInterval(_gradingDraftInterval),_gradingDraftInterval=null)}function maybeOfferGradingDraftRestore(){const t=_gradingSubmissionId,e=loadGradingDraft(t);if(!e?.signature)return;if(e.signature===_gradingInitialSignature){clearGradingDraft(t);return}let n;try{n=JSON.parse(e.signature)}catch{clearGradingDraft(t);return}if(n.id!==t){clearGradingDraft(t);return}const i=e.savedAt?formatDateTime(new Date(e.savedAt).toISOString()):"";if(!confirm(`Ph\xE1t hi\u1EC7n b\u1EA3n nh\xE1p ch\u01B0a l\u01B0u cho b\xE0i ch\u1EA5m n\xE0y${i?" (l\xFAc "+i+")":""} \u2014 c\xF3 th\u1EC3 do phi\xEAn tr\u01B0\u1EDBc b\u1ECB gi\xE1n \u0111o\u1EA1n (m\u1EA5t m\u1EA1ng, h\u1EBFt phi\xEAn \u0111\u0103ng nh\u1EADp, \u0111\xF3ng tab...). Kh\xF4i ph\u1EE5c b\u1EA3n nh\xE1p n\xE0y?`)){clearGradingDraft(t);return}const s=document.getElementById("grading-score"),a=document.getElementById("overall-feedback");s&&(s.value=n.score??s.value),a&&(a.value=n.overall??a.value),Array.isArray(n.annotations)&&(_gradingAnnotations=n.annotations,refreshWritingDisplay(),refreshAnnotationsList()),toast("\u0110\xE3 kh\xF4i ph\u1EE5c b\u1EA3n nh\xE1p ch\u01B0a l\u01B0u","warning")}let _gradingKeyHandler=null;function bindGradingShortcuts(){_gradingKeyHandler&&document.removeEventListener("keydown",_gradingKeyHandler),_gradingKeyHandler=t=>{const e=(t.target?.tagName||"").toUpperCase();if(e==="INPUT"||e==="TEXTAREA"){if((t.metaKey||t.ctrlKey)&&t.key.toLowerCase()==="s"){t.preventDefault();const n=document.querySelector('#save-btn, [onclick*="saveGrading"]');n&&saveGrading(n,"complete")}return}if((t.metaKey||t.ctrlKey)&&t.key.toLowerCase()==="s"){t.preventDefault();const n=document.querySelector('#save-btn, [onclick*="saveGrading"]');n&&saveGrading(n)}if((t.key==="ArrowDown"||t.key==="ArrowUp")&&_gradingAnnotations.length>0){t.preventDefault();const n=_gradingAnnotations.map(o=>o.id);let i=n.indexOf(window._gradingFocusAnnId);i<0&&(i=t.key==="ArrowDown"?-1:0),i=t.key==="ArrowDown"?(i+1)%n.length:(i-1+n.length)%n.length,window._gradingFocusAnnId=n[i],scrollToAnnotation(window._gradingFocusAnnId)}},document.addEventListener("keydown",_gradingKeyHandler)}function unbindGradingShortcuts(){_gradingKeyHandler&&document.removeEventListener("keydown",_gradingKeyHandler),_gradingKeyHandler=null,_gradingInitialSignature=null,stopGradingDraftAutosave()}async function showGradingPage({id:t}){setLoading("\u0110ang t\u1EA3i b\xE0i l\xE0m...");const e=routeToken();try{const n=await api.get(`/submissions/${t}`);if(routeChanged(e))return;renderGradingPage(n),bindGradingShortcuts(),startGradingDraftAutosave()}catch(n){if(routeChanged(e))return;toast("L\u1ED7i: "+(n.error||n.message),"error"),renderRouteError("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c b\xE0i l\xE0m",n,`/grading/${t}`)}}window.addEventListener("hashchange",()=>{window.location.hash.includes("/grading/")||unbindGradingShortcuts()});function prevAttemptsDropdownHtml(t,e){return!Array.isArray(t)||t.length===0?"":t.map(n=>{let i="";if(e==="speaking"){const a=Array.isArray(n.speaking_audio_urls)&&n.speaking_audio_urls.length?n.speaking_audio_urls:n.speaking_audio_url?[{url:n.speaking_audio_url,name:""}]:[];i=`${a.map((l,c)=>`
        <div style="margin-bottom:8px">
          ${a.length>1?`<div style="font-size:12px;color:var(--gray-500);margin-bottom:4px">${escapeHtml(l.name||"Ph\u1EA7n "+(c+1))}</div>`:""}
          ${audioPlayerBlock(`<audio controls src="${escapeHtml(l.url||"")}" style="width:100%;height:34px"></audio>`)}
        </div>`).join("")}
      ...
      <details class="grading-question-details">
      ...
      </details>`}).join("")}function renderGradingPage(t){_gradingSubmissionId=t.id,_gradingSkill=t.skill,_gradingText=t.skill==="speaking"?t.speaking_script||"":t.writing_content||"";const e=t.teacher_feedback||{};_gradingAnnotations=e.annotations||[],_gradingAiFeedback=t.ai_feedback||null,_gradingVoiceNotes=(e.voice_notes||[]).map(u=>({displayName:u.name||"",file:null,name:u.name||"",size:0,status:"done",url:u.url||null,key:u.key||null,pct:100,eta:null,localUrl:null}));const n=t.submission_kind==="composite_section"?`/composite/${t.assignment_id}`:`/assignment/${t.assignment_id}`,i=t.supports_ai_feedback!==!1,o=t.skill==="speaking"?"\u{1F3A4} Ch\u1EA5m b\xE0i Speaking":"\u270F\uFE0F Ch\u1EA5m b\xE0i Writing",s=(t.attempt_number||1)>1,a=t.previous_attempts||[];let r="";if(t.skill==="speaking"){const u=Array.isArray(t.speaking_audio_urls)&&t.speaking_audio_urls.length>0?t.speaking_audio_urls:t.speaking_audio_url?[{url:t.speaking_audio_url,name:""}]:[],g=u.length>1;u.length>0&&(r=`
        <div style="margin-bottom:16px;padding:12px;background:var(--gray-50);border-radius:12px;border:1px solid var(--gray-200)">
          ...
          ${u.map((h,m)=>`
            <div style="${g?"margin-bottom:10px":""}">
              <div style="display:flex;align-items:center;justify-content:space-between;gap:8px">
                ${g?`<div style="font-size:12px;color:var(--gray-500)">${escapeHtml(h.name||"Ph\u1EA7n "+(m+1))} <span id="audio-dur-${m}" style="color:var(--gray-400)"></span></div>`:"<div></div>"}
                <button type="button" class="btn-icon" title="T\u1EA3i xu\u1ED1ng" aria-label="T\u1EA3i xu\u1ED1ng" onclick="downloadAudioFile('${escapeJsAttr(h.url||"")}', '${escapeJsAttr((t.student_name||"speaking")+"_"+(h.name||"phan"+(m+1)))}', this)">\u{1F4E5}</button>
              </div>
              ${m===0?'<div id="waveform-container" class="waveform-container"><div class="waveform-loading">\u0110ang t\u1EA3i waveform...</div></div>':""}
              ${audioPlayerBlock(`<audio ${m===0?'id="waveform-audio"':`id="track-audio-${m}"`} controls src="${escapeHtml(h.url||"")}" preload="metadata" style="width:100%;height:36px;outline:none;${m===0?"margin-top:6px":""}"></audio>`)}
            </div>`).join("")}
        </div>`)}$("#app").innerHTML=`
    <nav class="breadcrumb">
      <a class="breadcrumb-item" onclick="navigate('/classes')">L\u1EDBp h\u1ECDc</a>
  ...
  `)}window.showMicErrorModal=showMicErrorModal;async function confirmReloadForMicPermission(){closeModal(),await confirmAction({title:"T\u1EA3i l\u1EA1i trang?",message:"Nh\u1EADn x\xE9t/\u0111i\u1EC3m ch\u01B0a l\u01B0u tr\xEAn trang ch\u1EA5m b\xE0i s\u1EBD b\u1ECB m\u1EA5t. C\xE1c b\u1EA3n ghi \xE2m \u0111\xE3 upload xong (tr\u1EA1ng th\xE1i \u2713) th\xEC v\u1EABn an to\xE0n.",confirmText:"T\u1EA3i l\u1EA1i trang",danger:!0})&&location.reload()}window.confirmReloadForMicPermission=confirmReloadForMicPermission;function stopVoiceNoteRecording(){clearInterval(_voiceNoteRecordTimer),_voiceNoteMediaRecorder?.stop()}window.stopVoiceNoteRecording=stopVoiceNoteRecording;function _onVoiceNoteRecordingDone(t,e,n){const i=_gradingVoiceNotes[t];if(_voiceNoteRecordIdx=-1,!i)return;if(!e||e.size===0){i.status="idle",renderVoiceNotesList(),toast("B\u1EA3n ghi r\u1ED7ng \u2014 vui l\xF2ng th\u1EED ghi \xE2m l\u1EA1i","error");return}const o=String(n||"audio/webm").split(";")[0].trim(),s=extFromAudioMime(o),a=new File([e],`voice-note-${t+1}.${s}`,{type:o});i.file=a,i.name=a.name,i.size=e.size,i.localUrl=URL.createObjectURL(e),i.status="uploading",i.pct=0,renderVoiceNotesList(),_uploadVoiceNoteSlot(t)}function pickAudioRecorderMime(){const t=["audio/webm;codecs=opus","audio/webm","audio/mp4","audio/ogg"];for(const e of t)try{if(window.MediaRecorder&&MediaRecorder.isTypeSupported(e))return e}catch{}return""}function extFromAudioMime(t){const e=String(t||"").split(";")[0].trim().toLowerCase();return e.includes("webm")?"webm":e.includes("ogg")?"ogg":e.includes("mp4")||e.includes("m4a")||e.includes("aac")?"m4a":e.includes("mpeg")||e.includes("mp3")?"mp3":e.includes("wav")?"wav":e.includes("flac")?"flac":"webm"}const BROWSER_PLAYABLE_AUDIO_EXTS=new Set(["mp3","mpeg","mpga","mp4","m4a","aac","wav","wave","ogg","oga","webm","flac"]);function probeAudioPlayable(t){return new Promise(e=>{const n=URL.createObjectURL(t),i=new Audio;let o=!1;const s=r=>{o||(o=!0,clearTimeout(a),i.removeAttribute("src"),URL.revokeObjectURL(n),e(r))},a=setTimeout(()=>s(!1),8e3);i.preload="metadata",i.onloadedmetadata=()=>s(isFinite(i.duration)&&i.duration>0),i.onerror=()=>s(!1),i.src=n})}async function onVoiceNoteFileSelected(t,e){const n=t.files?.[0];if(!n||!_gradingVoiceNotes[e])return;t.value="";const i=(n.name.split(".").pop()||"").toLowerCase();if(!BROWSER_PLAYABLE_AUDIO_EXTS.has(i)){showFeedbackAudioUnsupported(n.name,i);return}_gradingVoiceNotes[e].status="checking",renderVoiceNotesList();const o=await probeAudioPlayable(n);if(_gradingVoiceNotes[e]){if(!o){_gradingVoiceNotes[e].status="idle",renderVoiceNotesList(),showFeedbackAudioUnsupported(n.name,i,!0);return}_gradingVoiceNotes[e].file=n,_gradingVoiceNotes[e].name=n.name,_gradingVoiceNotes[e].size=n.size,_gradingVoiceNotes[e].localUrl=URL.createObjectURL(n),_gradingVoiceNotes[e].status="uploading",_gradingVoiceNotes[e].pct=0,renderVoiceNotesList(),_uploadVoiceNoteSlot(e)}}window.onVoiceNoteFileSelected=onVoiceNoteFileSelected;function showFeedbackAudioUnsupported(t,e,n=!1){openModal("\u26A0\uFE0F File audio kh\xF4ng ph\xE1t \u0111\u01B0\u1EE3c",`
    ...
    <div class="form-group">
      ...
      <div class="skill-tabs" id="assign-skill-tabs">
        ${["",...FILTERABLE_ASSIGNMENT_SKILLS].map((s,a)=>`
          <button class="skill-tab ${a===0?"active":""}"
            onclick="filterAssignQuestions('${s}', this)">
            ${a===0?"T\u1EA5t c\u1EA3":SKILL_LABELS[s].icon+" "+SKILL_LABELS[s].label}
          </button>`).join("")}
      </div>
    ...
    ${i.map(o=>`
      <button type="button"
        ...
        onclick="setAssignTagFilter('${escapeJsAttr(o)}')">${escapeHtml(o)}</button>
    `).join("")}
  `}function setAssignTagFilter(t){_assignTagFilter=t||"",renderAssignPicker(_assignSkillFilter)}function selectQuestion(t,e){_selectedQuestionId=t,document.querySelectorAll(".question-picker-item").forEach(s=>s.classList.remove("selected")),e.classList.add("selected"),e.querySelector("input[type=radio]").checked=!0;const n=e.dataset.skill||"",i=$("#assign-scale-group");i&&(i.style.display=n==="reading"||n==="listening"||n==="composite"?"":"none");const o=$("#assign-word-count-group");o&&(o.style.display=n==="writing"?"":"none")}function _syncAssignTimeLimitVisibility(){const t=document.querySelector('input[name="assign-mode"]:checked'),e=!t||t.value!=="practice",n=$("#assign-time-limit-group");n&&(n.style.display=e?"":"none")}async function submitAssign(t,e=!1){const n=$("#assign-title")?.value.trim(),i=$("#assign-deadline")?.value,o=i?new Date(i).toISOString():null,a=document.querySelector('input[name="assign-mode"]:checked')?.value==="practice"?"practice":"exam",r=$("#assign-time-limit")?.value.trim(),l=a==="exam"&&r?Number(r):null,d=document.querySelector('input[name="assign-scale"]:checked')?.value||null,u=$("#assign-min-word-count")?.value.trim(),g=u?Number(u):null;if(!n){toast("Vui l\xF2ng nh\u1EADp t\xEAn b\xE0i t\u1EADp","error");return}if(!_selectedQuestionId){toast("Vui l\xF2ng ch\u1ECDn m\u1ED9t \u0111\u1EC1 t\u1EEB kho","error");return}if(u&&(!Number.isFinite(g)||g<=0)){toast("S\u1ED1 t\u1EEB t\u1ED1i thi\u1EC3u ph\u1EA3i l\xE0 s\u1ED1 nguy\xEAn d\u01B0\u01A1ng","error");return}if(!e&&d==="ielts"){const h=_questions.find(b=>b.id===_selectedQuestionId),m=h?.question_count??0,f=h?.skill??"";if((f==="reading"||f==="listening")&&m!==40){let b=document.getElementById("assign-scale-warn");b||(b=document.createElement("div"),b.id="assign-scale-warn",document.getElementById("modal-body")?.appendChild(b)),b.innerHTML=`
  ...
  `}function _buildFolderTreeItems(t,e){return _allFolders.filter(n=>n.parent_id===t).sort((n,i)=>n.display_order-i.display_order||n.name.localeCompare(i.name)).map(n=>{const i=_getFolderSubtreeIds(n.id),o=_allQuestions.filter(l=>i.has(l.folder_id)).length,s=_currentFolderFilter===n.id,a=_allFolders.some(l=>l.parent_id===n.id),r=escapeJsAttr(n.name);return`
        <div class="folder-item ${s?"active":""}" style="padding-left:${12+e*14}px"
          ...
          <span class="folder-item-actions" onclick="event.stopPropagation()">
            ...
            <button class="folder-action-btn danger" title="Xo\xE1" aria-label="Xo\xE1 th\u01B0 m\u1EE5c" onclick="deleteFolderConfirm('${n.id}','${r}',this)">&#x1f5d1;</button>
          </span>
        </div>
        ${_buildFolderTreeItems(n.id,e+1)}`}).join("")}function setFolderFilter(t){_currentFolderFilter=t,renderQuestions()}window.setFolderFilter=setFolderFilter;async function createFolderPrompt(t){const e=await promptAction({title:t?"T\u1EA1o th\u01B0 m\u1EE5c con":"T\u1EA1o th\u01B0 m\u1EE5c m\u1EDBi",message:t?"Nh\u1EADp t\xEAn cho th\u01B0 m\u1EE5c con m\u1EDBi.":"Nh\u1EADp t\xEAn cho th\u01B0 m\u1EE5c m\u1EDBi trong kho \u0111\u1EC1.",placeholder:t?"V\xED d\u1EE5: Reading Mock 01":"V\xED d\u1EE5: B\u1ED9 \u0111\u1EC1 th\xE1ng 6",confirmText:"T\u1EA1o th\u01B0 m\u1EE5c",validate:n=>n?"":"Vui l\xF2ng nh\u1EADp t\xEAn th\u01B0 m\u1EE5c."});if(e)try{const n=await api.post("/question-folders",{name:e,parent_id:t});_allFolders.push(n),renderQuestions(),toast('\u0110\xE3 t\u1EA1o th\u01B0 m\u1EE5c "'+n.name+'"')}catch(n){toast("L\u1ED7i: "+(n.error||n.message),"error")}}window.createFolderPrompt=createFolderPrompt;async function renameFolderPrompt(t,e){const n=await promptAction({title:"\u0110\u1ED5i t\xEAn th\u01B0 m\u1EE5c",message:`C\u1EADp nh\u1EADt t\xEAn m\u1EDBi cho th\u01B0 m\u1EE5c <strong>${escapeHtml(e)}</strong>.`,initialValue:e,confirmText:"L\u01B0u t\xEAn m\u1EDBi",validate:i=>i?i===e?"T\xEAn m\u1EDBi \u0111ang tr\xF9ng t\xEAn hi\u1EC7n t\u1EA1i.":"":"Vui l\xF2ng nh\u1EADp t\xEAn th\u01B0 m\u1EE5c."});if(n)try{const i=await api.patch(`/question-folders/${t}`,{name:n}),o=_allFolders.findIndex(s=>s.id===t);o>=0&&(_allFolders[o]=i),renderQuestions()}catch(i){toast("L\u1ED7i: "+(i.error||i.message),"error")}}window.renameFolderPrompt=renameFolderPrompt;async function deleteFolderConfirm(t,e,n){const i=_allFolders.filter(r=>r.parent_id===t).length,o=_allQuestions.filter(r=>r.folder_id===t).length;let s=`<p style="margin:0">Th\u01B0 m\u1EE5c <strong>${escapeHtml(e)}</strong> s\u1EBD b\u1ECB xo\xE1.</p>`;if((i>0||o>0)&&(s+='<ul style="margin:12px 0 0 18px;line-height:1.7">',i>0&&(s+=`<li>${i} th\u01B0 m\u1EE5c con c\u0169ng s\u1EBD b\u1ECB xo\xE1.</li>`),o>0&&(s+=`<li>${o} \u0111\u1EC1 s\u1EBD \u0111\u01B0\u1EE3c chuy\u1EC3n v\u1EC1 Ch\u01B0a ph\xE2n lo\u1EA1i.</li>`),s+="</ul>"),!!await confirmAction({title:"Xo\xE1 th\u01B0 m\u1EE5c",message:s,confirmText:"Xo\xE1 th\u01B0 m\u1EE5c",danger:!0})){btnLoading(n);try{await api.delete(`/question-folders/${t}`);const r=_getFolderSubtreeIds(t);_allFolders=_allFolders.filter(l=>!r.has(l.id)),_allQuestions.forEach(l=>{r.has(l.folder_id)&&(l.folder_id=null)}),r.has(_currentFolderFilter)&&(_currentFolderFilter=null),renderQuestions(),toast("\u0110\xE3 xo\xE1 th\u01B0 m\u1EE5c")}catch(r){btnReset(n),toast("L\u1ED7i: "+(r.error||r.message),"error")}}}window.deleteFolderConfirm=deleteFolderConfirm;function openMoveQuestionModal(t){const e=_allQuestions.find(i=>i.id===t);if(!e)return;const n=(i,o)=>_allFolders.filter(s=>s.parent_id===i).sort((s,a)=>s.display_order-a.display_order||s.name.localeCompare(a.name)).map(s=>`
  ...
  `)}window.openMoveQuestionModal=openMoveQuestionModal;async function confirmMoveQuestion(t){const e=document.getElementById("move-folder-select")?.value||null;try{await api.patch(`/questions/${t}`,{folder_id:e||null});const n=_allQuestions.find(i=>i.id===t);n&&(n.folder_id=e||null),closeModal(),renderQuestions(),toast("\u0110\xE3 di chuy\u1EC3n \u0111\u1EC1")}catch(n){toast("L\u1ED7i: "+(n.error||n.message),"error")}}window.confirmMoveQuestion=confirmMoveQuestion;function _buildQuestionTableRows(t){return t.length===0?`<tr><td colspan="6">
      ...
      <tr draggable="true"
        ...
        <td style="font-size:12px;color:var(--gray-400)">
          ${Array.isArray(e.tags)&&e.tags.length>0?e.tags.map(n=>`<span class="tag-chip tag-chip-sm" onclick="setQuestionTagFilter('${escapeJsAttr(n)}')" title="L\u1ECDc theo tag n\xE0y">${escapeHtml(n)}</span>`).join(""):"\u2014"}
        </td>
        <td style="font-size:12px;color:var(--gray-400)">
      ...
      <div class="drag-assign-classes">
        ${t.map(n=>`
          <div class="drag-class-target"
            ...
            ondrop="onDropToClass('${n.id}', '${escapeJsAttr(n.class_name)}', event)">
    ...
    <div class="modal-footer">
      ...
      <div class="preview-q-row">
        ...
        <div class="preview-q-main">
          ...
          <div class="preview-q-ans">${Array.isArray(u.answers)&&u.answers.length?u.answers.map(g=>`<span class="preview-answer-chip">${escapeHtml(g)}</span>`).join(""):Array.isArray(u.correct_answers)&&u.correct_answers.length?u.correct_answers.map(g=>`<span class="preview-answer-chip">${escapeHtml(g)}</span>`).join(""):'<span class="preview-answer-empty">Ch\u01B0a c\xF3 \u0111\xE1p \xE1n</span>'}</div>
        </div>
          ...
          <div style="position:relative">
            ...
            <div id="fmt-color-palette" class="fmt-color-palette" style="display:none" onmousedown="event.preventDefault()">
              <div class="fmt-palette-swatches">
                ${["#000000","#434343","#666666","#999999","#ffffff","#ff0000","#e91e63","#9c27b0","#3f51b5","#2196f3","#03a9f4","#009688","#4caf50","#8bc34a","#ffeb3b","#ff9800","#ff5722","#795548","#607d8b","#1a237e"].map(n=>`<button type="button" class="fmt-swatch" style="background:${n}" title="${n}" aria-label="M\xE0u ch\u1EEF ${n}" onmousedown="event.preventDefault()" onclick="applyFormatColor('${n}');closeColorPalette()"></button>`).join("")}
              </div>
...
`).map(u=>escapeHtml(u)).join("<br>");const r=document.createElement("div");r.style.fontWeight="normal",r.style.fontStyle="normal",r.style.textDecoration="none",r.style.fontSize="13px",r.style.fontFamily='-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',r.innerHTML=a,a=r.outerHTML,document.execCommand("insertHTML",!1,a);const l=document.getElementById("content-composer-host");l&&(normalizeIndentTokensInElement(l),bindTableEditorEvents(l)),syncContentBlocksFromEditor(),saveComposerRange()}async function showQuestionDetail({id:t}){setLoading("\u0110ang t\u1EA3i \u0111\u1EC1...");const e=routeToken();try{const n=await api.get(`/questions/${t}`);if(routeChanged(e))return;renderQuestionDetail(n)}catch(n){if(routeChanged(e))return;toast("L\u1ED7i t\u1EA3i \u0111\u1EC1: "+(n.error||n.message),"error"),renderRouteError("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c \u0111\u1EC1",n,`/questions/${t}`)}}function skillEditorHtml(t,e={}){const{composerHints:n={},writingHintBox:i="",speakingHintBox:o="",audioExtraHint:s="",scriptValue:a="",scriptPlaceholder:r="",scriptRows:l=8,scriptLabelExtra:c="",scriptTrailingHint:d="",includeSttSelector:u=!0,includeScriptLoading:g=!0,includeSpeakerRename:h=!0,includeLocationHint:m=!0,includeVocab:f=!0}=e;return t==="reading"?`
      ...
      <div class="form-group" id="script-section">
        ...
        ${u?sttSelectorHtml():""}
        ${g?'<div id="script-loading" class="script-loading hidden"><span class="btn-spinner btn-spinner--dark"></span> <span id="script-loading-msg">\u0110ang tr\xEDch xu\u1EA5t script...</span></div>':""}
    ...
    </div>`}const ANSWER_IMPORT_AI_PROMPT=`T\u1EA1o gi\xFAp t\xF4i 1 file CSV (m\xE3 ho\xE1 UTF-8) \u0111\u1EC3 t\xF4i DOWNLOAD v\u1EC1 v\xE0 import \u0111\xE1p \xE1n IELTS Reading/Listening v\xE0o h\u1EC7 th\u1ED1ng. File c\xF3 \u0111\xFAng 4 c\u1ED9t theo th\u1EE9 t\u1EF1: STT, \u0110\xE1p \xE1n, Gi\u1EA3i th\xEDch, Location

NGU\u1ED2N \u0110\xC1P \xC1N:
- N\u1EBFu b\xEAn d\u01B0\u1EDBi t\xF4i C\xD3 cung c\u1EA5p \u0111\xE1p \xE1n (answer key): PH\u1EA2I d\xF9ng \u0111\xFAng \u0111\xE1p \xE1n \u0111\xF3, kh\xF4ng \u0111\u01B0\u1EE3c s\u1EEDa hay "ch\u1EEFa" l\u1EA1i. Vi\u1EC7c c\u1EE7a b\u1EA1n l\xE0 gi\u1EA3i th\xEDch v\xEC sao n\xF3 \u0111\xFAng, t\xECm Location v\xE0 b\u1ED5 sung c\xE1c c\xE1ch vi\u1EBFt kh\xE1c \u0111\u01B0\u1EE3c ch\u1EA5p nh\u1EADn (theo quy t\u1EAFc b\xEAn d\u01B0\u1EDBi).
- N\u1EBFu KH\xD4NG c\xF3 \u0111\xE1p \xE1n: t\u1EF1 suy lu\u1EADn \u0111\xE1p \xE1n \u0111\xFAng t\u1EEB b\xE0i \u0111\u1ECDc/audio script v\xE0 \u0111\u1EC1 c\xE2u h\u1ECFi, c\u1EA9n th\u1EADn nh\u01B0 m\u1ED9t gi\xE1m kh\u1EA3o IELTS. \u0110\u1ECDc k\u1EF9 t\u1EEBng c\xE2u, \u0111\u1EB7c bi\u1EC7t c\xE1c c\xE2u TRUE/FALSE/NOT GIVEN v\xE0 YES/NO/NOT GIVEN.

QUY T\u1EAEC T\u1EEANG C\u1ED8T:
- STT: s\u1ED1 th\u1EE9 t\u1EF1 c\xE2u h\u1ECFi, gi\u1EEF \u0111\xFAng nh\u01B0 trong \u0111\u1EC1 t\xF4i d\xE1n b\xEAn d\u01B0\u1EDBi (\u0111\u1EC1 \u0111\xE3 \u0111\u01B0\u1EE3c \u0111\xE1nh s\u1ED1 li\u1EC1n m\u1EA1ch t\u1EEB 1). N\u1EBFu \u0111\xE1p \xE1n g\u1ED1c d\xF9ng s\u1ED1 c\u0169 (vd m\u1ED7i b\xE0i l\u1EA1i b\u1EAFt \u0111\u1EA7u t\u1EEB 1, ho\u1EB7c b\u1EAFt \u0111\u1EA7u t\u1EEB 14), ph\u1EA3i quy \u0111\u1ED5i sang s\u1ED1 m\u1EDBi t\u01B0\u01A1ng \u1EE9ng trong \u0111\u1EC1.

- \u0110\xE1p \xE1n: kh\xF4ng \u0111\u01B0\u1EE3c \u0111\u1EC3 tr\u1ED1ng. H\u1EC7 th\u1ED1ng ch\u1EA5m b\u1EB1ng c\xE1ch so kh\u1EDBp CH\xCDNH X\xC1C t\u1EEBng ch\u1EEF (ch\u1EC9 b\u1ECF qua hoa/th\u01B0\u1EDDng v\xE0 kho\u1EA3ng tr\u1EAFng hai \u0111\u1EA7u), n\xEAn:
  + N\u1EBFu c\xF3 nhi\u1EC1u c\xE1ch vi\u1EBFt c\xF9ng \u0111\u01B0\u1EE3c ch\u1EA5p nh\u1EADn, li\u1EC7t k\xEA h\u1EBFt, c\xE1ch nhau b\u1EDFi d\u1EA5u "|". V\xED d\u1EE5: "the museum|museum", "19|nineteen", "colour|color", "3,000|3000".
  + M\u1ECDi c\xE1ch vi\u1EBFt li\u1EC7t k\xEA ra \u0111\u1EC1u PH\u1EA2I tu\xE2n th\u1EE7 gi\u1EDBi h\u1EA1n t\u1EEB c\u1EE7a \u0111\u1EC1 (xem m\u1EE5c GI\u1EDAI H\u1EA0N T\u1EEA). C\xE1ch vi\u1EBFt n\xE0o v\u01B0\u1EE3t gi\u1EDBi h\u1EA1n th\xEC kh\xF4ng \u0111\u01B0\u1EE3c \u0111\u01B0a v\xE0o.
  + TRUE/FALSE/NOT GIVEN, YES/NO/NOT GIVEN: ghi d\u1EA1ng \u0111\u1EA7y \u0111\u1EE7 (TRUE, FALSE, NOT GIVEN, YES, NO).
  + C\xE2u ch\u1ECDn ch\u1EEF c\xE1i (multiple choice, matching headings, matching information...): ch\u1EC9 ghi ch\u1EEF c\xE1i ho\u1EB7c s\u1ED1 La M\xE3 (A, B, iv...), kh\xF4ng ghi k\xE8m n\u1ED9i dung.
  + C\xE2u "Choose TWO/THREE letters" tr\u1EA3i tr\xEAn nhi\u1EC1u STT (vd c\xE2u 14-15, \u0111\xE1p \xE1n A v\xE0 D): v\xEC th\u1EE9 t\u1EF1 kh\xF4ng quan tr\u1ECDng, M\u1ED6I c\xE2u trong nh\xF3m \u0111\u1EC1u ghi to\xE0n b\u1ED9 c\xE1c \u0111\xE1p \xE1n c\u1EE7a nh\xF3m. V\xED d\u1EE5 c\xE2u 14: "A|D", c\xE2u 15: "A|D".
  + Kh\xF4ng d\xF9ng d\u1EA5u ";" b\xEAn trong \u0111\xE1p \xE1n (h\u1EC7 th\u1ED1ng coi ";" l\xE0 d\u1EA5u ng\u0103n c\xE1ch nh\u01B0 "|").

- GI\u1EDAI H\u1EA0N T\u1EEA (\xE1p d\u1EE5ng cho c\xE2u \u0111i\u1EC1n t\u1EEB: completion, short answer, label...): \u0111\u1ECDc k\u1EF9 ch\u1EC9 d\u1EABn c\u1EE7a t\u1EEBng nh\xF3m c\xE2u v\xE0 \u0111\xE1p \xE1n PH\u1EA2I tu\xE2n th\u1EE7 theo \u0111\xFAng quy t\u1EAFc ch\u1EA5m IELTS:
  + "ONE WORD ONLY": \u0111\xFAng 1 t\u1EEB, kh\xF4ng k\xE8m s\u1ED1.
  + "ONE WORD AND/OR A NUMBER": t\u1ED1i \u0111a 1 t\u1EEB v\xE0/ho\u1EB7c 1 s\u1ED1.
  + "NO MORE THAN TWO WORDS": t\u1ED1i \u0111a 2 t\u1EEB; "NO MORE THAN TWO WORDS AND/OR A NUMBER": t\u1ED1i \u0111a 2 t\u1EEB v\xE0/ho\u1EB7c 1 s\u1ED1; t\u01B0\u01A1ng t\u1EF1 v\u1EDBi THREE WORDS.
  + "A NUMBER": ch\u1EC9 ghi s\u1ED1.
  + C\xE1ch \u0111\u1EBFm: m\u1EA1o t\u1EEB (a/an/the) v\xE0 gi\u1EDBi t\u1EEB t\xEDnh l\xE0 1 t\u1EEB; t\u1EEB c\xF3 g\u1EA1ch n\u1ED1i (well-known, part-time) t\xEDnh l\xE0 1 t\u1EEB; s\u1ED1 vi\u1EBFt b\u1EB1ng ch\u1EEF s\u1ED1 (15, 3,000, 1990) t\xEDnh l\xE0 1 s\u1ED1, kh\xF4ng t\xEDnh l\xE0 t\u1EEB; ng\xE0y th\xE1ng nh\u01B0 "15 March" = 1 s\u1ED1 + 1 t\u1EEB.
  + Reading: t\u1EEB trong \u0111\xE1p \xE1n ph\u1EA3i l\u1EA5y NGUY\xCAN V\u0102N t\u1EEB b\xE0i \u0111\u1ECDc, kh\xF4ng \u0111\u1ED5i d\u1EA1ng t\u1EEB (kh\xF4ng \u0111\u1ED5i s\u1ED1 \xEDt/s\u1ED1 nhi\u1EC1u, th\xEC c\u1EE7a \u0111\u1ED9ng t\u1EEB, t\u1EEB lo\u1EA1i), tr\u1EEB khi c\xE2u h\u1ECFi b\u1EAFt bu\u1ED9c.
  + \u0110\xE1p \xE1n ph\u1EA3i v\u1EEBa kh\xEDt ng\u1EEF ph\xE1p v\u1EDBi ch\u1ED7 tr\u1ED1ng (kh\xF4ng l\u1EB7p l\u1EA1i t\u1EEB \u0111\xE3 c\xF3 s\u1EB5n trong c\xE2u h\u1ECFi quanh ch\u1ED7 tr\u1ED1ng) v\xE0 \u0111\xFAng ch\xEDnh t\u1EA3; s\u1ED1 \xEDt/s\u1ED1 nhi\u1EC1u sai l\xE0 sai.
  + N\u1EBFu \u0111\xE1p \xE1n c\xF3 ph\u1EA7n tu\u1EF3 ch\u1ECDn (vd "(the) museum", "shoe(s)"), li\u1EC7t k\xEA c\u1EA3 b\u1EA3n c\xF3 v\xE0 kh\xF4ng c\xF3 ph\u1EA7n \u0111\xF3, mi\u1EC5n kh\xF4ng v\u01B0\u1EE3t gi\u1EDBi h\u1EA1n t\u1EEB.

- CH\xCDNH T\u1EA2 V\xC0 S\u1ED0 \xCDT/S\u1ED0 NHI\u1EC0U (C\u1EF0C K\u1EF2 QUAN TR\u1ECCNG, \u0111\u1EB7c bi\u1EC7t v\u1EDBi Listening):
  + Ch\xEDnh t\u1EA3 ph\u1EA3i \u0111\xFAng tuy\u1EC7t \u0111\u1ED1i t\u1EEBng ch\u1EEF c\xE1i. Sai 1 ch\u1EEF c\xE1i l\xE0 sai. TUY\u1EC6T \u0110\u1ED0I kh\xF4ng \u0111\u01B0a c\xE1c c\xE1ch vi\u1EBFt sai ch\xEDnh t\u1EA3 ph\u1ED5 bi\u1EBFn v\xE0o l\xE0m bi\u1EBFn th\u1EC3 ch\u1EA5p nh\u1EADn.
  + Ch\xEDnh t\u1EA3 Anh v\xE0 M\u1EF9 \u0111\u1EC1u \u0111\u01B0\u1EE3c ch\u1EA5p nh\u1EADn (colour|color, centre|center, organise|organize, programme|program, travelling|traveling): li\u1EC7t k\xEA c\u1EA3 hai n\u1EBFu t\u1EEB \u0111\xF3 c\xF3 2 c\xE1ch vi\u1EBFt.
  + S\u1ED1 \xEDt/s\u1ED1 nhi\u1EC1u ph\u1EA3i \u0111\xFAng nh\u01B0 trong b\xE0i: Listening l\xE0 \u0111\xFAng d\u1EA1ng ng\u01B0\u1EDDi n\xF3i ph\xE1t \xE2m (nghe c\xF3 \xE2m /s/, /z/, /\u026Az/ \u1EDF cu\u1ED1i th\xEC l\xE0 s\u1ED1 nhi\u1EC1u); Reading l\xE0 \u0111\xFAng d\u1EA1ng xu\u1EA5t hi\u1EC7n trong b\xE0i. Ch\u1EC9 ch\u1EA5p nh\u1EADn c\u1EA3 hai d\u1EA1ng khi \u0111\xE1p \xE1n g\u1ED1c cho ph\xE9p (vd "shoe(s)") ho\u1EB7c c\u1EA3 hai \u0111\u1EC1u ho\xE0n to\xE0n \u0111\xFAng ng\u1EEF ph\xE1p l\u1EABn n\u1ED9i dung.
  + Ki\u1EC3m tra ng\u1EEF ph\xE1p quanh ch\u1ED7 tr\u1ED1ng \u0111\u1EC3 x\xE1c \u0111\u1ECBnh s\u1ED1 \xEDt/s\u1ED1 nhi\u1EC1u: sau "a/an/one/each/every" l\xE0 s\u1ED1 \xEDt; sau "several/many/a few/both/two..." ho\u1EB7c \u0111\u1ED9ng t\u1EEB chia s\u1ED1 nhi\u1EC1u (are/were/have) l\xE0 s\u1ED1 nhi\u1EC1u; danh t\u1EEB kh\xF4ng \u0111\u1EBFm \u0111\u01B0\u1EE3c (information, equipment, furniture, advice, luggage, accommodation) kh\xF4ng bao gi\u1EDD th\xEAm "s".
  + Listening, t\xEAn ri\xEAng/\u0111\u1ECBa ch\u1EC9/m\xE3 s\u1ED1 \u0111\u01B0\u1EE3c ng\u01B0\u1EDDi n\xF3i \u0110\xC1NH V\u1EA6N t\u1EEBng ch\u1EEF c\xE1i: \u0111\xE1p \xE1n ph\u1EA3i kh\u1EDBp ch\xEDnh x\xE1c t\u1EEBng ch\u1EEF c\xE1i theo ph\u1EA7n \u0111\xE1nh v\u1EA7n trong script.
  + Listening, n\u1EBFu ng\u01B0\u1EDDi n\xF3i t\u1EF1 s\u1EEDa l\u1EA1i ho\u1EB7c \u0111\u1ED5i \xFD (vd "on Tuesday... no, sorry, Wednesday"), \u0111\xE1p \xE1n l\xE0 th\xF4ng tin CU\u1ED0I C\xD9NG \u0111\u01B0\u1EE3c x\xE1c nh\u1EADn; th\xF4ng tin b\u1ECB s\u1EEDa l\xE0 b\u1EABy.
  + Listening, \u0111\xE1p \xE1n ph\u1EA3i l\xE0 \u0111\xFAng t\u1EEB \u0111\u01B0\u1EE3c n\xF3i trong script, kh\xF4ng d\xF9ng t\u1EEB \u0111\u1ED3ng ngh\u0129a hay di\u1EC5n \u0111\u1EA1t kh\xE1c.
  + S\u1ED1, ng\xE0y, gi\u1EDD, ti\u1EC1n (trong gi\u1EDBi h\u1EA1n t\u1EEB): li\u1EC7t k\xEA c\xE1c c\xE1ch vi\u1EBFt t\u01B0\u01A1ng \u0111\u01B0\u01A1ng \u0111\u01B0\u1EE3c ch\u1EA5p nh\u1EADn, vd "15 March|March 15|15th March|March 15th", "7.30|7:30", "\xA3250|250 pounds" (ch\u1EC9 khi kh\xF4ng v\u01B0\u1EE3t gi\u1EDBi h\u1EA1n t\u1EEB), s\u1ED1 \u0111i\u1EC7n tho\u1EA1i c\xF3/kh\xF4ng c\xF3 kho\u1EA3ng tr\u1EAFng "0412 876 543|0412876543".
  + T\u1EEB gh\xE9p: ch\u1EC9 li\u1EC7t k\xEA d\u1EA1ng vi\u1EBFt li\u1EC1n/g\u1EA1ch n\u1ED1i/t\xE1ch r\u1EDDi khi d\u1EA1ng \u0111\xF3 th\u1EF1c s\u1EF1 \u0111\xFAng ch\xEDnh t\u1EA3 trong t\u1EEB \u0111i\u1EC3n v\xE0 kh\xF4ng v\u01B0\u1EE3t gi\u1EDBi h\u1EA1n t\u1EEB (d\u1EA1ng t\xE1ch r\u1EDDi t\xEDnh l\xE0 2 t\u1EEB).

- T\u1EF0 KI\u1EC2M TRA TR\u01AF\u1EDAC KHI XU\u1EA4T FILE: v\u1EDBi T\u1EEANG c\xE2u, \u0111\u1ED1i chi\u1EBFu l\u1EA1i \u0111\xE1p \xE1n v\u1EDBi b\xE0i \u0111\u1ECDc/script: (a) \u0111\xFAng t\u1EEBng ch\u1EEF c\xE1i, (b) \u0111\xFAng s\u1ED1 \xEDt/s\u1ED1 nhi\u1EC1u, (c) \u0111\xFAng gi\u1EDBi h\u1EA1n t\u1EEB, (d) v\u1EEBa ng\u1EEF ph\xE1p ch\u1ED7 tr\u1ED1ng, (e) m\u1ECDi bi\u1EBFn th\u1EC3 trong "|" \u0111\u1EC1u \u0111\xFAng ch\xEDnh t\u1EA3 v\xE0 \u0111\xFAng gi\u1EDBi h\u1EA1n t\u1EEB. N\u1EBFu t\xF4i c\xF3 cung c\u1EA5p \u0111\xE1p \xE1n g\u1ED1c, kh\xF4ng \u0111\u01B0\u1EE3c s\u1EEDa \u0111\xE1p \xE1n g\u1ED1c, ch\u1EC9 \u0111\u01B0\u1EE3c b\u1ED5 sung bi\u1EBFn th\u1EC3 h\u1EE3p l\u1EC7.

- Gi\u1EA3i th\xEDch: b\u1EB1ng ti\u1EBFng Vi\u1EC7t, C\u1EF0C K\u1EF2 CHI TI\u1EBET v\xEC sao \u0111\xE1p \xE1n \u0111\xF3 \u0111\xFAng, gi\xFAp ng\u01B0\u1EDDi h\u1ECDc hi\u1EC3u s\xE2u, kh\xF4ng b\u1ECB l\u1EEBa l\u1EA7n sau. Ph\u1EA3i c\xF3 \u0111\u1EE7:
  (1) T\u1EEB kho\xE1/c\u1EE5m t\u1EEB trong c\xE2u h\u1ECFi \u0111\u01B0\u1EE3c paraphrase t\u1EEB c\u1EE5m n\xE0o trong b\xE0i; \xE1nh x\u1EA1 r\xF5 gi\u1EEFa ng\xF4n ng\u1EEF c\xE2u h\u1ECFi v\xE0 ng\xF4n ng\u1EEF trong b\xE0i.
  (2) Logic suy lu\u1EADn t\u1EEBng b\u01B0\u1EDBc d\u1EABn t\u1EDBi \u0111\xE1p \xE1n, kh\xF4ng kh\u1EB3ng \u0111\u1ECBnh su\xF4ng.
  (3) N\u1EBFu c\xF3 th\xF4ng tin g\xE2y nhi\u1EC5u ho\u1EB7c ph\u01B0\u01A1ng \xE1n sai tr\xF4ng h\u1EE3p l\xFD, PH\u1EA2I ch\u1EC9 r\xF5 \u0111\xF3 l\xE0 b\u1EABy g\xEC v\xE0 v\xEC sao sai.
  (4) V\u1EDBi c\xE2u \u0111i\u1EC1n t\u1EEB: n\xF3i r\xF5 v\xEC sao \u0111\xE1p \xE1n \u0111\xFAng gi\u1EDBi h\u1EA1n t\u1EEB, v\u1EEBa ng\u1EEF ph\xE1p ch\u1ED7 tr\u1ED1ng, v\xE0 v\xEC sao l\xE0 s\u1ED1 \xEDt hay s\u1ED1 nhi\u1EC1u; l\u01B0u \xFD ch\xEDnh t\u1EA3 n\u1EBFu t\u1EEB d\u1EC5 vi\u1EBFt sai.
  (5) V\u0103n phong r\xF5 r\xE0ng, d\u1EC5 hi\u1EC3u v\u1EDBi ng\u01B0\u1EDDi \u0111ang luy\u1EC7n band 6.5-8.0.
  Lu\xF4n b\xE1m s\xE1t n\u1ED9i dung th\u1EADt trong b\xE0i, kh\xF4ng th\xEAm th\xF4ng tin ngo\xE0i b\xE0i. C\xF3 th\u1EC3 xu\u1ED1ng d\xF2ng \u0111\u1EC3 t\xE1ch \xFD, nh\u01B0ng KH\xD4NG d\xF9ng markdown (kh\xF4ng **, kh\xF4ng #, kh\xF4ng b\u1EA3ng).

- Location: \u0111o\u1EA1n tr\xEDch NGUY\xCAN V\u0102N t\u1EEB b\xE0i \u0111\u1ECDc/audio script (copy ch\xEDnh x\xE1c, kh\xF4ng di\u1EC5n gi\u1EA3i, kh\xF4ng d\u1ECBch) ch\u1EE9a b\u1EB1ng ch\u1EE9ng cho \u0111\xE1p \xE1n. H\u1EC7 th\u1ED1ng t\xECm v\u1ECB tr\xED b\u1EB1ng c\xE1ch so kh\u1EDBp \u0111o\u1EA1n n\xE0y v\u1EDBi b\xE0i, n\xEAn:
  + Gi\u1EEF nguy\xEAn d\u1EA5u c\xE2u y nh\u01B0 trong b\xE0i (kh\xF4ng \u0111\u1ED5i \u2019 th\xE0nh ', \u2014 th\xE0nh -, \u201C \u201D th\xE0nh ").
  + Ch\u1EC9 tr\xEDch trong PH\u1EA0M VI 1 \u0110O\u1EA0N V\u0102N, kh\xF4ng tr\xEDch v\u1EAFt qua 2 \u0111o\u1EA1n.
  + Tr\xEDch \u0111\u1EE7 d\xE0i (kho\u1EA3ng 5-15 t\u1EEB li\xEAn t\u1EE5c) \u0111\u1EC3 kh\xF4ng tr\xF9ng v\u1EDBi ch\u1ED7 kh\xE1c trong b\xE0i.
  + N\u1EBFu b\u1EB1ng ch\u1EE9ng kh\xF4ng n\u1EB1m trong ph\u1EA7n ch\u1EEF (vd n\u1EB1m trong b\u1EA3ng/h\xECnh) ho\u1EB7c kh\xF4ng c\xF3 \u0111o\u1EA1n n\xE0o ph\xF9 h\u1EE3p: \u0111\u1EC3 tr\u1ED1ng, tuy\u1EC7t \u0111\u1ED1i kh\xF4ng b\u1ECBa.

\u0110\u1ECANH D\u1EA0NG FILE:
- D\xF2ng \u0111\u1EA7u l\xE0 header: STT,\u0110\xE1p \xE1n,Gi\u1EA3i th\xEDch,Location
- D\xF9ng d\u1EA5u ph\u1EA9y (,) ng\u0103n c\xE1ch c\u1ED9t; b\u1ECDc \xF4 trong d\u1EA5u ngo\u1EB7c k\xE9p "..." n\u1EBFu n\u1ED9i dung c\xF3 d\u1EA5u ph\u1EA9y, d\u1EA5u ngo\u1EB7c k\xE9p ho\u1EB7c xu\u1ED1ng d\xF2ng (d\u1EA5u " b\xEAn trong \xF4 vi\u1EBFt th\xE0nh "").
- T\u1EA1o file .csv th\u1EADt \u0111\u1EC3 t\xF4i t\u1EA3i v\u1EC1 (vd dap_an.csv), kh\xF4ng ch\u1EC9 in n\u1ED9i dung ra m\xE0n h\xECnh.

--- D\xE1n b\xEAn d\u01B0\u1EDBi: (1) b\xE0i \u0111\u1ECDc ho\u1EB7c audio script, (2) \u0111\u1EC1 c\xE2u h\u1ECFi (k\xE8m ch\u1EC9 d\u1EABn nh\u01B0 "NO MORE THAN TWO WORDS"), (3) \u0111\xE1p \xE1n n\u1EBFu c\xF3 ---
...
`,EXAM_CONTENT_AI_PROMPT=`T\u1EEB \u1EA3nh/PDF \u0111\u1EC1 IELTS t\xF4i g\u1EEDi k\xE8m, h\xE3y tr\xECnh b\xE0y l\u1EA1i TO\xC0N B\u1ED8 \u0111\u1EC1 (b\xE0i \u0111\u1ECDc ho\u1EB7c ph\u1EA7n ch\u1EEF \u0111i k\xE8m n\u1EBFu c\xF3, ch\u1EC9 d\u1EABn v\xE0 c\xE2u h\u1ECFi) ngay trong c\xE2u tr\u1EA3 l\u1EDDi, \u0111\u1EC3 t\xF4i copy v\xE0 d\xE1n v\xE0o h\u1EC7 th\u1ED1ng.
Ch\u1EC9 xu\u1EA5t n\u1ED9i dung \u0111\u1EC1: kh\xF4ng gi\u1EA3i \u0111\u1EC1, kh\xF4ng \u0111\u01B0a \u0111\xE1p \xE1n, kh\xF4ng gi\u1EA3i th\xEDch, kh\xF4ng th\xEAm l\u1EDDi m\u1EDF \u0111\u1EA7u hay k\u1EBFt lu\u1EADn.

1. NGUY\xCAN V\u0102N
- Tr\xECnh b\xE0y nguy\xEAn v\u0103n 100% n\u1ED9i dung trong \u1EA3nh/PDF: kh\xF4ng s\u1EEDa ch\xEDnh t\u1EA3, kh\xF4ng di\u1EC5n \u0111\u1EA1t l\u1EA1i, kh\xF4ng t\xF3m t\u1EAFt, kh\xF4ng d\u1ECBch, kh\xF4ng th\xEAm b\u1EDBt.
- Gi\u1EEF \u0111\xFAng th\u1EE9 t\u1EF1 n\u1ED9i dung nh\u01B0 b\u1EA3n g\u1ED1c, g\u1ED3m c\u1EA3 ti\xEAu \u0111\u1EC1 b\xE0i, nh\xE3n \u0111o\u1EA1n v\u0103n (A, B, C...), ch\u1EC9 d\u1EABn (vd "Write NO MORE THAN TWO WORDS AND/OR A NUMBER"), v\xED d\u1EE5 m\u1EABu (Example), danh s\xE1ch heading/ph\u01B0\u01A1ng \xE1n \u0111\u1EC3 matching.

2. \u0110\u1ECANH D\u1EA0NG
- Gi\u1EEF in \u0111\u1EADm, in nghi\xEAng, g\u1EA1ch ngang nh\u01B0 b\u1EA3n g\u1ED1c.
- Ch\u1EEF g\u1EA1ch ch\xE2n trong b\u1EA3n g\u1ED1c: chuy\u1EC3n th\xE0nh in \u0111\u1EADm.
- Ch\u1ED7 th\u1EE5t d\xF2ng/ph\xE2n c\u1EA5p trong b\u1EA3n g\u1ED1c: d\xF9ng danh s\xE1ch g\u1EA1ch \u0111\u1EA7u d\xF2ng l\u1ED3ng nhau.
- T\u1EA4T C\u1EA2 ch\u1EEF ph\u1EA3i c\xF9ng m\u1ED9t c\u1EE1 ch\u1EEF v\xE0 m\u1ED9t font: KH\xD4NG d\xF9ng ti\xEAu \u0111\u1EC1 markdown (#, ##, ###), kh\xF4ng d\xF9ng code block, kh\xF4ng d\xF9ng tr\xEDch d\u1EABn (>). C\xE1c ti\xEAu \u0111\u1EC1 nh\u01B0 READING PASSAGE 1, SECTION 1, Questions 1-8 ch\u1EC9 in \u0111\u1EADm.
- B\u1EA3ng trong \u0111\u1EC1: tr\xECnh b\xE0y th\xE0nh b\u1EA3ng, gi\u1EEF \u0111\xFAng s\u1ED1 h\xE0ng, s\u1ED1 c\u1ED9t v\xE0 n\u1ED9i dung t\u1EEBng \xF4. \xD4 b\u1ECB g\u1ED9p (merged cell): \u0111\u1EC3 tr\u1ED1ng c\xE1c \xF4 th\u1EEBa, t\xF4i s\u1EBD t\u1EF1 g\u1ED9p l\u1EA1i.
- Ch\u1ED7 tr\u1ED1ng c\u1EA7n \u0111i\u1EC1n: vi\u1EBFt "(s\u1ED1 c\xE2u) \u2026\u2026\u2026\u2026" b\u1EB1ng d\u1EA5u ch\u1EA5m l\u1EEDng, vd "(5) \u2026\u2026\u2026\u2026". KH\xD4NG d\xF9ng d\u1EA5u g\u1EA1ch d\u01B0\u1EDBi (___).
- C\xE2u tr\u1EAFc nghi\u1EC7m tr\xECnh b\xE0y \u0111\xFAng m\u1EABu, m\u1ED7i ph\u01B0\u01A1ng \xE1n m\u1ED9t d\xF2ng ri\xEAng, gi\u1EEF \u0111\u1EE7 s\u1ED1 ph\u01B0\u01A1ng \xE1n nh\u01B0 b\u1EA3n g\u1ED1c:
Question 1: n\u1ED9i dung c\xE2u h\u1ECFi
A. ...
B. ...
C. ...
D. ...

3. \u0110\xC1NH S\u1ED0 C\xC2U LI\u1EC0N M\u1EA0CH
- To\xE0n b\u1ED9 c\xE2u h\u1ECFi ph\u1EA3i \u0111\xE1nh s\u1ED1 li\xEAn t\u1EE5c t\u1EEB Question 1 \u0111\u1EBFn c\xE2u cu\u1ED1i c\xF9ng, k\u1EC3 c\u1EA3 khi b\u1EA3n g\u1ED1c chia nhi\u1EC1u b\xE0i/section \u0111\xE1nh s\u1ED1 ri\xEAng. Vd b\xE0i 1 l\xE0 c\xE2u 1-8, b\xE0i 2 b\u1EA3n g\u1ED1c l\xE0 1-14 ho\u1EB7c 20-33, th\xEC b\xE0i 2 ph\u1EA3i \u0111\u1ED5i th\xE0nh 9-22.
- \u0110\u1ED5i s\u1ED1 \u0110\u1ED2NG B\u1ED8 \u1EDF m\u1ECDi ch\u1ED7: s\u1ED1 c\u1EE7a c\xE2u h\u1ECFi, s\u1ED1 trong ch\u1ED7 tr\u1ED1ng, d\xF2ng ch\u1EC9 d\u1EABn (vd "Questions 9-22"), nh\xF3m "Choose TWO letters" (vd "Questions 15-16"), s\u1ED1 c\xE2u n\u1EB1m trong b\u1EA3ng, v\xE0 b\u1EA5t k\u1EF3 ch\u1ED7 n\xE0o kh\xE1c nh\u1EAFc t\u1EDBi s\u1ED1 c\xE2u.

4. \u1EA2NH
- N\u1EBFu m\u1ED9t ph\u1EA7n \u0111\u1EC1 l\xE0 \u1EA3nh (b\u1EA3n \u0111\u1ED3, s\u01A1 \u0111\u1ED3, bi\u1EC3u \u0111\u1ED3, h\xECnh minh ho\u1EA1...) ho\u1EB7c c\xE1c ph\u01B0\u01A1ng \xE1n tr\u1EA3 l\u1EDDi l\xE0 \u1EA3nh: KH\xD4NG m\xF4 t\u1EA3, kh\xF4ng ch\xE9p ch\u1EEF trong \u1EA3nh, \u0111\u1EC3 tr\u1ED1ng \u0111\xFAng v\u1ECB tr\xED \u0111\xF3 \u0111\u1EC3 t\xF4i t\u1EF1 ch\xE8n \u1EA3nh.
- D\xF9 c\xF3 \u1EA3nh v\u1EABn ph\u1EA3i t\u1EA1o \u0111\u1EE7 c\xE1c c\xE2u h\u1ECFi li\xEAn quan v\u1EDBi s\u1ED1 th\u1EE9 t\u1EF1 li\u1EC1n m\u1EA1ch, kh\xF4ng \u0111\u01B0\u1EE3c b\u1ECF qua c\xE2u n\xE0o. Vd b\u1EA3n \u0111\u1ED3 c\xF3 5 c\xE2u th\xEC v\u1EABn vi\u1EBFt \u0111\u1EE7 5 c\xE2u v\u1EDBi s\u1ED1 m\u1EDBi; ph\u01B0\u01A1ng \xE1n l\xE0 \u1EA3nh th\xEC v\u1EABn ghi "A." "B." "C." tr\xEAn t\u1EEBng d\xF2ng r\u1ED3i \u0111\u1EC3 tr\u1ED1ng ph\xEDa sau.

--- G\u1EEDi k\xE8m \u1EA3nh/PDF \u0111\u1EC1 ---
`,AI_PROMPT_HELPERS={answer:{prompt:ANSWER_IMPORT_AI_PROMPT,title:"\u2728 Prompt t\u1EA1o CSV \u0111\xE1p \xE1n b\u1EB1ng AI",hint:"Sao ch\xE9p prompt n\xE0y, d\xE1n v\xE0o ChatGPT/Claude k\xE8m b\xE0i \u0111\u1ECDc/audio script, \u0111\u1EC1 c\xE2u h\u1ECFi v\xE0 \u0111\xE1p \xE1n (n\u1EBFu c\xF3), r\u1ED3i t\u1EA3i file CSV m\xE0 AI t\u1EA1o ra v\xE0 import v\xE0o \u0111\xE2y."},vocab:{prompt:VOCAB_IMPORT_AI_PROMPT,title:"\u2728 Prompt t\u1EA1o CSV t\u1EEB v\u1EF1ng b\u1EB1ng AI",hint:"Sao ch\xE9p prompt n\xE0y, d\xE1n v\xE0o ChatGPT/Claude k\xE8m theo b\xE0i \u0111\u1ECDc ho\u1EB7c audio script c\u1EE7a b\u1EA1n, r\u1ED3i t\u1EA3i file CSV m\xE0 AI tr\u1EA3 v\u1EC1 v\xE0 import v\xE0o \u0111\xE2y."},exam:{prompt:EXAM_CONTENT_AI_PROMPT,title:"\u2728 Prompt t\u1EA1o \u0111\u1EC1 b\u1EB1ng AI",hint:'Sao ch\xE9p prompt n\xE0y, d\xE1n v\xE0o ChatGPT/Claude k\xE8m \u1EA3nh/PDF \u0111\u1EC1. B\xF4i \u0111en to\xE0n b\u1ED9 c\xE2u tr\u1EA3 l\u1EDDi c\u1EE7a AI r\u1ED3i Ctrl+C, b\u1EA5m n\xFAt "d\xE1n gi\u1EEF \u0111\u1ECBnh d\u1EA1ng" (bi\u1EC3u t\u01B0\u1EE3ng b\u1EA3ng k\u1EB9p c\xF3 ch\u1EEF A) tr\xEAn thanh \u0111\u1ECBnh d\u1EA1ng r\u1ED3i Ctrl+V v\xE0o khung so\u1EA1n \u0111\u1EC1. Sau \u0111\xF3 ch\xE8n \u1EA3nh v\xE0o c\xE1c ch\u1ED7 \u0111\u1EC3 tr\u1ED1ng.'}};function showAiPromptHelper(t){const{prompt:e,title:n,hint:i}=AI_PROMPT_HELPERS[t]||AI_PROMPT_HELPERS.answer;openModal(n,`
    <div style="display:flex;flex-direction:column;gap:12px">
      <div style="font-size:13px;color:var(--text-muted)">${i}</div>
      <textarea id="ai-prompt-helper-text" class="form-textarea" rows="20" readonly style="font-family:ui-monospace,monospace;font-size:12px;white-space:pre-wrap">${escapeHtml(e)}</textarea>
      <div class="modal-footer" style="display:flex;justify-content:flex-end;gap:8px">
...
`?(n.push(i),i="",e.push(n),n=[]):i+=a)}return(i.length>0||n.length>0)&&(n.push(i),e.push(n)),e.filter(s=>s.some(a=>String(a).trim()!==""))}function vocabHeaderLevenshtein(t,e){const n=t.length,i=e.length;if(n===0)return i;if(i===0)return n;const o=Array.from({length:n+1},()=>new Array(i+1).fill(0));for(let s=0;s<=n;s++)o[s][0]=s;for(let s=0;s<=i;s++)o[0][s]=s;for(let s=1;s<=n;s++)for(let a=1;a<=i;a++)o[s][a]=t[s-1]===e[a-1]?o[s-1][a-1]:1+Math.min(o[s-1][a-1],o[s-1][a],o[s][a-1]);return o[n][i]}function mapHeadersByAliases(t,e,n){const i={};for(const s of Object.keys(e))i[s]=null;const o=new Set;return t.forEach((s,a)=>{const r=n(s);if(!r)return;let l=null,c=1/0;for(const[d,u]of Object.entries(e))if(!o.has(d))for(const g of u){const h=vocabHeaderLevenshtein(r,g);h<=1&&h<c&&(c=h,l=d)}l&&(i[l]=a,o.add(l))}),i}const VOCAB_FIELD_ALIASES={word:["word"],definition:["definition"],pronunciation:["pronunciation"],collocation:["collocation"],example:["example"]};function normalizeVocabHeader(t){return String(t??"").toLowerCase().trim().replace(/[^a-z]/g,"")}function mapVocabHeaders(t){return mapHeadersByAliases(t,VOCAB_FIELD_ALIASES,normalizeVocabHeader)}function setVocabImportStatus(t,e=""){const n=$("#vocab-import-status");n&&(n.className=`pdf-import-status${e?` is-${e}`:""}`,n.textContent=t)}async function handleVocabFileImport(t){const e=t?.files?.[0];if(t&&(t.value=""),!e)return;const n=(e.name.split(".").pop()||"").toLowerCase(),i=n==="csv"||e.type==="text/csv";if(!i&&!(n==="xlsx"||n==="xls")){setVocabImportStatus("Ch\u1EC9 h\u1ED7 tr\u1EE3 file .csv, .xlsx ho\u1EB7c .xls.","error"),toast("File kh\xF4ng h\u1EE3p l\u1EC7","error");return}setVocabImportStatus("\u0110ang \u0111\u1ECDc file...","loading");try{let s;if(i){const d=(await e.text()).replace(/^\uFEFF/,"");s=parseVocabCsvText(d)}else{const d=await ensureXlsxLoaded(),u=await e.arrayBuffer(),g=d.read(new Uint8Array(u),{type:"array"}),h=g.Sheets[g.SheetNames[0]];s=d.utils.sheet_to_json(h,{header:1,defval:"",raw:!1}).filter(m=>Array.isArray(m)&&m.some(f=>String(f).trim()!==""))}if(!s||s.length<2){setVocabImportStatus("File kh\xF4ng c\xF3 d\u1EEF li\u1EC7u (c\u1EA7n d\xF2ng ti\xEAu \u0111\u1EC1 + \xEDt nh\u1EA5t 1 d\xF2ng d\u1EEF li\u1EC7u).","error"),toast("File tr\u1ED1ng","error");return}const a=mapVocabHeaders(s[0]);if(a.word==null||a.definition==null){setVocabImportStatus('Kh\xF4ng t\xECm th\u1EA5y c\u1ED9t "word" v\xE0/ho\u1EB7c "definition" \u1EDF d\xF2ng ti\xEAu \u0111\u1EC1.',"error"),toast("Thi\u1EBFu c\u1ED9t b\u1EAFt bu\u1ED9c: word, definition","error");return}const r=[];let l=0;for(let d=1;d<s.length;d++){const u=s[d]||[],g=String(u[a.word]??"").trim(),h=String(u[a.definition]??"").trim();if(!g||!h){l++;continue}const m={word:g,definition:h};for(const f of["pronunciation","collocation","example"]){const w=a[f];if(w==null)continue;const b=String(u[w]??"").trim();b&&(m[f]=b)}r.push(m)}if(r.length===0){setVocabImportStatus("Kh\xF4ng c\xF3 d\xF2ng d\u1EEF li\u1EC7u h\u1EE3p l\u1EC7 (c\u1EA7n \u0111\u1EE7 word + definition).","error"),toast("Kh\xF4ng import \u0111\u01B0\u1EE3c d\xF2ng n\xE0o","error");return}_vocabItems.push(...r),renderVocabList(),scheduleQuestionDraftSave();const c=l>0?`, b\u1ECF qua ${l} d\xF2ng thi\u1EBFu d\u1EEF li\u1EC7u`:"";setVocabImportStatus(`\u0110\xE3 import ${r.length} t\u1EEB v\u1EF1ng t\u1EEB "${e.name}"${c}.`,"success"),toast(`\u0110\xE3 import ${r.length} t\u1EEB v\u1EF1ng`)}catch(s){console.error("Vocab import failed:",s);const a=s?.message||"Kh\xF4ng th\u1EC3 \u0111\u1ECDc file n\xE0y.";setVocabImportStatus(a,"error"),toast(a,"error")}}function showQuestionForm(){_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioFile=null,_audioUploadUrl=null,_audioUploadKey=null,_audioUploadName="",_audioUploadSize=0,_audioUploading=!1,_editingVocabIndex=-1,$("#app").innerHTML=`
    ...
    </div>`}function setAnswerImportStatus(t,e=""){const n=$("#answer-import-status");n&&(n.className=`pdf-import-status${e?` is-${e}`:""}`,n.textContent=t)}async function handleAnswerFileImport(t){const e=t?.files?.[0];if(t&&(t.value=""),!e)return;const n=(e.name.split(".").pop()||"").toLowerCase(),i=n==="csv"||e.type==="text/csv";if(!i&&!(n==="xlsx"||n==="xls")){setAnswerImportStatus("Ch\u1EC9 h\u1ED7 tr\u1EE3 file .csv, .xlsx ho\u1EB7c .xls.","error"),toast("File kh\xF4ng h\u1EE3p l\u1EC7","error");return}const s=document.querySelectorAll("#answer-grid .answer-row");if(!s.length){setAnswerImportStatus("Ch\u01B0a c\xF3 l\u01B0\u1EDBi \u0111\xE1p \xE1n \u2014 nh\u1EADp S\u1ED1 c\xE2u h\u1ECFi tr\u01B0\u1EDBc khi import.","error"),toast("Ch\u01B0a c\xF3 l\u01B0\u1EDBi \u0111\xE1p \xE1n","error");return}setAnswerImportStatus("\u0110ang \u0111\u1ECDc file...","loading");try{let a;if(i){const u=(await e.text()).replace(/^\uFEFF/,"");a=parseVocabCsvText(u)}else{const u=await ensureXlsxLoaded(),g=await e.arrayBuffer(),h=u.read(new Uint8Array(g),{type:"array"}),m=h.Sheets[h.SheetNames[0]];a=u.utils.sheet_to_json(m,{header:1,defval:"",raw:!1}).filter(f=>Array.isArray(f)&&f.some(w=>String(w).trim()!==""))}if(!a||a.length<2){setAnswerImportStatus("File kh\xF4ng c\xF3 d\u1EEF li\u1EC7u (c\u1EA7n d\xF2ng ti\xEAu \u0111\u1EC1 + \xEDt nh\u1EA5t 1 d\xF2ng d\u1EEF li\u1EC7u).","error"),toast("File tr\u1ED1ng","error");return}const r=mapAnswerHeaders(a[0]);if(r.q_no==null||r.answers==null){setAnswerImportStatus("Kh\xF4ng t\xECm th\u1EA5y c\u1ED9t STT v\xE0/ho\u1EB7c \u0110\xE1p \xE1n \u1EDF d\xF2ng ti\xEAu \u0111\u1EC1.","error"),toast("Thi\u1EBFu c\u1ED9t b\u1EAFt bu\u1ED9c: STT, \u0110\xE1p \xE1n","error");return}let l=0;const c=[];for(let u=1;u<a.length;u++){const g=a[u]||[],h=String(g[r.q_no]??"").trim(),m=parseInt(h,10);if(!m){c.push(`D\xF2ng ${u+1}: STT kh\xF4ng h\u1EE3p l\u1EC7 ("${h}")`);continue}const f=Array.from(s).find(C=>C.querySelector(".q-label")?.textContent===`Q${m}`);if(!f){c.push(`C\xE2u ${m}: kh\xF4ng t\u1ED3n t\u1EA1i trong l\u01B0\u1EDBi \u0111\xE1p \xE1n`);continue}const w=String(g[r.answers]??"").trim(),b=splitDelimitedList(w,/[|;]/);if(!b.length){c.push(`C\xE2u ${m}: thi\u1EBFu \u0111\xE1p \xE1n`);continue}if(setAnswerRowChips(f,b),r.explanation!=null){const C=String(g[r.explanation]??"").trim(),L=f.querySelector(".answer-explanation");L&&(L.value=C)}if(r.location!=null){const C=String(g[r.location]??"").trim();if(C){const L=findAnswerLocationMatch(C);L?applyAnswerLocationToRow(f,L.text,L.meta):c.push(`C\xE2u ${m}: kh\xF4ng t\xECm th\u1EA5y v\u1ECB tr\xED kh\u1EDBp v\u1EDBi "${C}"`)}}l++}attachChipListeners(),scheduleQuestionDraftSave();const d=c.length?` \u2014 ${c.length} l\u1ED7i: ${c.join("; ")}`:"";setAnswerImportStatus(`\u0110\xE3 import ${l} c\xE2u t\u1EEB "${e.name}"${d}`,c.length?"warning":"success"),toast(c.length?`Import xong, ${c.length} l\u1ED7i (xem chi ti\u1EBFt b\xEAn d\u01B0\u1EDBi)`:`\u0110\xE3 import ${l} c\xE2u`,c.length?"warning":"success")}catch(a){console.error("Answer import failed:",a);const r=a?.message||"Kh\xF4ng th\u1EC3 \u0111\u1ECDc file n\xE0y.";setAnswerImportStatus(r,"error"),toast(r,"error")}}let _pdfJsLoadingPromise=null;function pdfImportBoxHtml(){return`
...
`)){const o=i.match(/^([^:\n]+?):\s/);o&&!e.has(o[1])&&(e.add(o[1]),n.push(o[1]))}return n}function _nextSpeakerLabel(){const t=new Set(_speakerNames.map(e=>e.original));for(const e of"ABCDEFGHIJKLMNOPQRSTUVWXYZ")if(!t.has(e))return e;return"?"}function _hasSpeakerPattern(t){return/^[A-Za-z][^:\n]*:\s/m.test(t)}function _refreshSpeakerNames(){const t=$("#listening-script");if(!t||!_hasSpeakerPattern(t.value))return;const e=_parseSpeakersFromTranscript(t.value),n=new Map(_speakerNames.map(i=>[i.original,i]));_speakerNames=e.map(i=>n.get(i)||{original:i,replace:""}),_speakerNames.length===0&&(_speakerNames=[{original:"A",replace:""},{original:"B",replace:""}])}function _renderSpeakerRenameUI(){const t=$("#speaker-rename-section");if(!t)return;const e=$("#listening-script");if(!(e&&_hasSpeakerPattern(e.value))){t.style.display="none";return}t.style.display="";const i=$("#speaker-rename-list");if(!i)return;const o="padding:4px 8px;border:1px solid var(--border);border-radius:5px;font-size:13px;background:var(--surface,var(--bg-subtle));color:var(--text);outline:none;width:100%";i.innerHTML=_speakerNames.map((s,a)=>`
    ...
    `}`),setTimeout(()=>{($("#stu-names")||$("#stu-existing-username"))?.focus()},50)}function switchStudentTab(t){_addStudentTab=t,renderAddStudentModal()}async function submitCreateStudent(t){const e=parseStudentNameLines($("#stu-names")?.value);if(e.length===0){toast("Vui l\xF2ng nh\u1EADp \xEDt nh\u1EA5t 1 h\u1ECDc sinh","error");return}btnLoading(t);try{const n=await api.post("/students",{class_id:_addStudentClassId,students:e.map(s=>({full_name:s}))}),i=Array.isArray(n.created)?n.created:[],o=Array.isArray(n.failed)?n.failed:[];if(i.length===0)throw new Error(o[0]?.error||"Kh\xF4ng nh\u1EADn \u0111\u01B0\u1EE3c t\xE0i kho\u1EA3n \u0111\xE3 t\u1EA1o");closeModal(),openStudentCredentialsModal(i.length===1?"T\xE0i kho\u1EA3n h\u1ECDc sinh \u0111\xE3 \u0111\u01B0\u1EE3c t\u1EA1o":`\u0110\xE3 t\u1EA1o ${i.length} t\xE0i kho\u1EA3n h\u1ECDc sinh`,i,i.length===1?"student_account":"student_accounts"),o.length>0?toast(`\u0110\xE3 t\u1EA1o ${i.length} t\xE0i kho\u1EA3n, ${o.length} l\u1ED7i: `+o.map(s=>`${s.full_name} (${s.error})`).join("; "),"warning"):toast(`\u0110\xE3 t\u1EA1o ${i.length} t\xE0i kho\u1EA3n h\u1ECDc sinh!`),showClassDetail({id:_addStudentClassId})}catch(n){btnReset(t),toast("L\u1ED7i: "+(n.error||n.message||"Kh\xF4ng th\u1EC3 t\u1EA1o h\u1ECDc sinh"),"error")}}async function submitAddExistingStudent(t){const e=$("#stu-existing-username")?.value.trim();if(!e){toast("Vui l\xF2ng nh\u1EADp username","error");return}btnLoading(t);try{await api.post("/student-classes",{class_id:_addStudentClassId,username:e}),closeModal(),toast("\u0110\xE3 th\xEAm h\u1ECDc sinh v\xE0o l\u1EDBp!"),showClassDetail({id:_addStudentClassId})}catch(n){btnReset(t),toast("L\u1ED7i: "+(n.error||"Kh\xF4ng th\u1EC3 th\xEAm h\u1ECDc sinh"),"error")}}function openResetPasswordModal(t,e,n){confirmAction({title:"C\u1EA5p m\u1EADt kh\u1EA9u m\u1EDBi",message:`M\u1EADt kh\u1EA9u c\u0169 c\u1EE7a <strong>${escapeHtml(e)}</strong> s\u1EBD h\u1EBFt hi\u1EC7u l\u1EF1c ngay sau khi \u0111\u1ED5i.`,confirmText:"C\u1EA5p m\u1EADt kh\u1EA9u m\u1EDBi",danger:!0}).then(i=>{i&&submitResetPassword(t,n)})}async function submitResetPassword(t,e){btnLoading(e);try{const n=await api.post(`/students/${t}/reset-password`,{});if(!n?.credentials)throw new Error("Kh\xF4ng nh\u1EADn \u0111\u01B0\u1EE3c m\u1EADt kh\u1EA9u m\u1EDBi");openStudentCredentialsModal("M\u1EADt kh\u1EA9u m\u1EDBi c\u1EE7a h\u1ECDc sinh",[n.credentials],"student_password_reset"),toast("\u0110\xE3 c\u1EA5p m\u1EADt kh\u1EA9u m\u1EDBi!")}catch(n){btnReset(e),toast("L\u1ED7i: "+(n.error||n.message||"Kh\xF4ng th\u1EC3 \u0111\u1ED5i m\u1EADt kh\u1EA9u"),"error");return}btnReset(e)}async function removeStudentFromClass(t,e,n){if(await confirmAction({title:"Xo\xE1 h\u1ECDc sinh kh\u1ECFi l\u1EDBp",message:"T\xE0i kho\u1EA3n h\u1ECDc sinh v\u1EABn \u0111\u01B0\u1EE3c gi\u1EEF l\u1EA1i, ch\u1EC9 b\u1ECB g\u1EE1 kh\u1ECFi l\u1EDBp n\xE0y.",confirmText:"G\u1EE1 kh\u1ECFi l\u1EDBp",danger:!0})){btnLoading(n);try{await api.delete(`/student-classes?student_id=${t}&class_id=${e}`),toast("\u0110\xE3 xo\xE1 h\u1ECDc sinh kh\u1ECFi l\u1EDBp"),showClassDetail({id:e})}catch(o){btnReset(n),toast("L\u1ED7i: "+(o.error||o.message),"error");return}btnReset(n)}}async function showProfileFields(){setLoading("\u0110ang t\u1EA3i...");const t=routeToken();try{const e=await api.get("/profile-fields");if(routeChanged(t))return;renderProfileFieldsPage(e)}catch(e){if(routeChanged(t))return;toast("L\u1ED7i: "+(e.error||e.message),"error"),renderRouteError("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c h\u1ED3 s\u01A1 h\u1ECDc sinh",e,"/profile-fields")}}function renderProfileFieldsPage(t){const e={text:"V\u0103n b\u1EA3n ng\u1EAFn",textarea:"V\u0103n b\u1EA3n d\xE0i",select:"Ch\u1ECDn \u0111\xE1p \xE1n",date:"Ng\xE0y sinh"},n={notification_email:"Email th\xF4ng b\xE1o"},i=t.length===0?'<div class="pf-empty"><div class="pf-empty-icon">\u{1F4CB}</div><div>Ch\u01B0a c\xF3 c\xE2u h\u1ECFi n\xE0o. Th\xEAm c\xE2u h\u1ECFi \u0111\u1EA7u ti\xEAn b\xEAn tr\xEAn!</div></div>':`<div class="table-wrap"><table class="pf-table">
        ...
        <tbody>${t.map((o,s)=>{const a=Array.isArray(o.options)&&o.options.length?`<div class="pf-opts-preview">${o.options.slice(0,3).map(l=>`<span class="pf-opt-pill">${escapeHtml(String(l))}</span>`).join("")}${o.options.length>3?`<span class="pf-opt-more">+${o.options.length-3}</span>`:""}</div>`:"",r=o.field_key?`<span class="pf-type-badge">${n[o.field_key]||o.field_key}</span>`:'<span style="color:var(--gray-400)">\u2014</span>';return`<tr>
            ...
            <td>${r}</td>
            <td><button class="btn-icon danger" onclick="deleteProfileField('${o.id}', this)" aria-label="Xo\xE1 tr\u01B0\u1EDDng h\u1ED3 s\u01A1">\u{1F5D1}</button></td>
          </tr>`}).join("")}</tbody>
    ...
    </tr>`).join(""):'<tr><td colspan="7" style="text-align:center;color:var(--gray-400);padding:32px">Ch\u01B0a c\xF3 \u0111\u1EC1 n\xE0o.</td></tr>'}function setSharedSkillFilter(t){_sharedSkillFilter=t,renderSharedPool()}window.setSharedSkillFilter=setSharedSkillFilter;async function deleteSharedQuestion(t,e,n){if(await confirmAction({title:"Xo\xE1 \u0111\u1EC1 kh\u1ECFi kho luy\u1EC7n t\u1EADp",message:`\u0110\u1EC1 <strong>${escapeHtml(e)}</strong> s\u1EBD b\u1ECB xo\xE1 kh\u1ECFi Kho \u0111\u1EC1 luy\u1EC7n t\u1EADp.`,confirmText:"Xo\xE1 \u0111\u1EC1",danger:!0})){btnLoading(n);try{await api.delete(`/shared-pool/${t}`),_sharedQuestions=_sharedQuestions.filter(o=>o.id!==t),renderSharedPool(),toast("\u0110\xE3 xo\xE1 \u0111\u1EC1","success")}catch(o){btnReset(n),toast("L\u1ED7i xo\xE1 \u0111\u1EC1: "+(o.error||o.message),"error")}}}window.deleteSharedQuestion=deleteSharedQuestion;async function copySharedToQuestions(t,e,n){if(await confirmAction({title:"Copy sang Kho \u0111\u1EC1",message:`M\u1ED9t b\u1EA3n sao <strong>\u0111\u1ED9c l\u1EADp</strong> c\u1EE7a \u0111\u1EC1 <strong>${escapeHtml(e)}</strong> s\u1EBD \u0111\u01B0\u1EE3c t\u1EA1o trong Kho \u0111\u1EC1 (k\xE8m b\u1EA3n sao ri\xEAng c\u1EE7a audio/\u1EA3nh) \u0111\u1EC3 b\u1EA1n giao cho l\u1EDBp. S\u1EEDa ho\u1EB7c xo\xE1 b\u1EA3n sao s\u1EBD kh\xF4ng \u1EA3nh h\u01B0\u1EDFng \u0111\u1EC1 luy\u1EC7n t\u1EADp g\u1ED1c.`,confirmText:"T\u1EA1o b\u1EA3n sao"})){btnLoading(n);try{const o=await api.post(`/shared-pool/${t}/copy-to-questions`,{});btnReset(n),await confirmAction({title:"\u0110\xE3 t\u1EA1o b\u1EA3n sao trong Kho \u0111\u1EC1",message:`\u0110\xE3 t\u1EA1o <strong>${escapeHtml(o.title||e)}</strong> trong Kho \u0111\u1EC1. M\u1EDF kho \u0111\u1EC1 \u0111\u1EC3 giao cho l\u1EDBp?`,confirmText:"M\u1EDF Kho \u0111\u1EC1",cancelText:"\u1EDE l\u1EA1i"})&&navigate("/questions")}catch(o){btnReset(n),toast("L\u1ED7i t\u1EA1o b\u1EA3n sao: "+(o.error||o.message),"error")}}}window.copySharedToQuestions=copySharedToQuestions;let _sharedStatsModal=null,_sharedStatsChart=null,_sharedStatsRows=[],_sharedStatsMode="avg";async function showSharedPoolStats(t,e){if(_sharedStatsModal&&(_sharedStatsModal.remove(),_sharedStatsModal=null),_sharedStatsChart){try{_sharedStatsChart.destroy()}catch{}_sharedStatsChart=null}const n=document.createElement("div");n.className="modal-overlay",n.innerHTML=`
                  ...
                  <td colspan="6" style="padding:0 0 0 40px">
                    <div class="sp-stats-detail-inner">
                      <table class="sp-stats-detail-table">
                        <thead><tr><th>#</th><th>Ch\u1EBF \u0111\u1ED9</th><th>Ng\xE0y n\u1ED9p</th><th>\u0110i\u1EC3m</th><th></th></tr></thead>
                        <tbody>
                          ${[...r.attempts].sort((l,c)=>new Date(l.submitted_at)-new Date(c.submitted_at)).map((l,c)=>`
                            <tr>
                              ...
                              <td><button class="btn btn-sm btn-outline" onclick="showSharedAttemptSubmission('${l.id}')">Hi\u1EC3n th\u1ECB b\xE0i l\xE0m</button></td>
                            </tr>`).join("")}
                        </tbody>
                      </table>
                    </div>
  ...
  `,_buildSharedStatsChart(n)}function _buildSharedStatsChart(t){if(_sharedStatsChart){try{_sharedStatsChart.destroy()}catch{}_sharedStatsChart=null}const e=document.getElementById("sp-stats-chart");if(!e)return;const n=t.map(a=>_sharedStatsMode==="avg"?a.avg:a.max).filter(a=>a!=null).map(Number),i=[];for(let a=1;a<=9;a+=.5)i.push(a);const o=new Array(i.length).fill(0);for(const a of n){const r=Math.round(a*2)/2,l=i.indexOf(Math.min(9,Math.max(1,r)));l>=0&&o[l]++}const s=i.map(a=>a>=7?{bg:"#16a34a99",border:"#16a34a"}:a>=5?{bg:"#ca8a0499",border:"#ca8a04"}:{bg:"#dc262699",border:"#dc2626"});ensureChartJsLoaded().then(()=>{_sharedStatsChart=new Chart(e,{type:"bar",data:{labels:i.map(a=>a%1===0?String(a):a.toFixed(1)),datasets:[{label:_sharedStatsMode==="avg"?"\u0110i\u1EC3m TB / HS":"\u0110i\u1EC3m cao nh\u1EA5t / HS",data:o,backgroundColor:s.map(a=>a.bg),borderColor:s.map(a=>a.border),borderWidth:1,borderRadius:4}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{title:a=>`Band ${a[0].label}`,label:a=>`${a.raw} h\u1ECDc sinh`}}},scales:{x:{title:{display:!0,text:"Band IELTS"},grid:{display:!1}},y:{title:{display:!0,text:"S\u1ED1 h\u1ECDc sinh"},beginAtZero:!0,ticks:{stepSize:1}}}}})}).catch(()=>{const a=e.parentElement;a&&(a.innerHTML='<div class="empty-state" style="height:100%;display:flex;align-items:center;justify-content:center"><p>Kh\xF4ng th\u1EC3 t\u1EA3i bi\u1EC3u \u0111\u1ED3 l\xFAc n\xE0y.</p></div>')})}function setSharedStatsMode(t){_sharedStatsMode=t,document.querySelectorAll(".sp-stats-mode-btn").forEach(e=>{e.classList.toggle("active",e.textContent.includes(t==="avg"?"Trung b\xECnh":"Cao nh\u1EA5t"))}),_buildSharedStatsChart(_groupSharedStatsByStudent(_sharedStatsRows))}function toggleSharedStudentDetail(t){const e=document.getElementById(`sp-detail-${t}`),n=document.querySelector(`.sp-stats-student-row[data-sid="${t}"] .sp-expand-btn`);if(!e)return;const i=e.classList.toggle("hidden");n&&(n.textContent=i?"Chi ti\u1EBFt \u25BE":"Thu g\u1ECDn \u25B4")}let _sharedAttemptModal=null;async function showSharedAttemptSubmission(t){_sharedAttemptModal&&(_sharedAttemptModal.remove(),_sharedAttemptModal=null);const e=document.createElement("div");e.className="modal-overlay",e.innerHTML=`
    <div class="modal modal-wide" onclick="event.stopPropagation()">
      <div class="modal-header">
        <h3>\u{1F4C4} B\xE0i l\xE0m</h3>
        <button class="modal-close" onclick="closeSharedAttemptModal()" aria-label="\u0110\xF3ng">\xD7</button>
      </div>
      <div class="modal-body" id="shared-attempt-body">
        <div style="text-align:center;padding:40px 0"><div class="spinner"></div><p style="color:var(--gray-400);margin-top:12px">\u0110ang t\u1EA3i b\xE0i l\xE0m...</p></div>
      </div>
    </div>`,e.addEventListener("click",i=>{i.target===e&&closeSharedAttemptModal()}),document.body.appendChild(e),_sharedAttemptModal=e;let n;try{n=await api.get(`/shared-pool/attempts/${t}`)}catch(i){e.querySelector("#shared-attempt-body").innerHTML=`<p style="color:var(--red);text-align:center">L\u1ED7i t\u1EA3i b\xE0i l\xE0m: ${escapeHtml(i.error||i.message)}</p>`;return}renderSharedAttemptBody(e.querySelector("#shared-attempt-body"),n)}function closeSharedAttemptModal(){_sharedAttemptModal&&(_sharedAttemptModal.remove(),_sharedAttemptModal=null)}function renderSharedAttemptBody(t,e){const n=e.skill;if(n==="reading"||n==="listening"){const i={};(e.questions_data||[]).forEach(c=>{i[c.q_no]=c.answers||[]});const o=c=>(i[c.q_no]||[]).some(u=>u.toLowerCase().trim()===(c.answer||"").toLowerCase().trim()),s=(e.student_answers||[]).map(c=>`
      <tr>
        <td style="font-weight:600;text-align:center">Q${c.q_no}</td>
        <td>${escapeHtml(c.answer||"\u2014")}</td>
        <td style="color:var(--gray-400);font-size:12px">${(i[c.q_no]||[]).join(" / ")}</td>
        <td style="text-align:center;font-size:16px">${o(c)?"\u2705":"\u274C"}</td>
      </tr>`).join(""),a=(e.student_answers||[]).filter(o).length,r=(e.questions_data||[]).length,l=e.max_score===40?9:10;t.innerHTML=`
      <div style="margin-bottom:8px;font-size:13px;color:var(--gray-500)">${escapeHtml(e.student_name||e.username||"")}</div>
      <div style="margin-bottom:12px;padding:12px 16px;background:var(--primary-lt);border-radius:8px;display:flex;gap:24px;align-items:center;flex-wrap:wrap">
        <span style="font-size:20px;font-weight:700;color:var(--primary)">${e.overall_score??"\u2014"}/${l}</span>
        <span style="color:var(--gray-600);font-size:13px">\u0110\xFAng ${a}/${r} c\xE2u</span>
        <span style="color:var(--gray-400);font-size:12px">N\u1ED9p l\xFAc ${formatDateTime(e.submitted_at)}</span>
      </div>
      <div class="table-wrap" style="max-height:420px;overflow-y:auto">
        <table>
          <thead><tr><th>C\xE2u</th><th>H\u1ECDc sinh tr\u1EA3 l\u1EDDi</th><th>\u0110\xE1p \xE1n \u0111\xFAng</th><th>K\u1EBFt qu\u1EA3</th></tr></thead>
          <tbody>${s||'<tr><td colspan="4" style="text-align:center;color:var(--gray-400)">Kh\xF4ng c\xF3 \u0111\xE1p \xE1n</td></tr>'}</tbody>
        </table>
      </div>`}else{const i=e.ai_feedback_error?`<div style="margin-top:14px;padding:10px 14px;background:#fee2e2;border:1px solid #fca5a5;border-radius:8px;color:#991b1b;font-size:13px;text-align:left">\u26A0\uFE0F Ch\u1EA5m AI th\u1EA5t b\u1EA1i: ${escapeHtml(e.ai_feedback_error)}</div>`:"";t.innerHTML=`
      <div style="text-align:center;padding:40px 20px;color:var(--gray-500)">
        <div style="font-size:32px;margin-bottom:12px">\u{1F6A7}</div>
        <div style="font-size:15px;font-weight:600">T\xEDnh n\u0103ng \u0111ang ph\xE1t tri\u1EC3n</div>
        <div style="font-size:13px;margin-top:6px">Xem chi ti\u1EBFt b\xE0i l\xE0m ${n==="writing"?"Writing":"Speaking"} cho kho \u0111\u1EC1 luy\u1EC7n t\u1EADp s\u1EBD c\xF3 \u1EDF phi\xEAn b\u1EA3n ti\u1EBFp theo.</div>
        ${i}
      </div>`}}window.showSharedPoolStats=showSharedPoolStats,window.closeSharedStatsModal=closeSharedStatsModal,window.setSharedStatsMode=setSharedStatsMode,window.toggleSharedStudentDetail=toggleSharedStudentDetail,window.showSharedAttemptSubmission=showSharedAttemptSubmission,window.closeSharedAttemptModal=closeSharedAttemptModal;let _sharedEditingId=null;async function showSharedPoolForm(){_sharedEditingId=null,_vocabItems=[],_contentBlocks=[createTextBlock("")],_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioFile=null,_audioUploadUrl=null,_audioUploadKey=null,_audioUploadName="",_audioUploadSize=0,_audioUploading=!1,_editingVocabIndex=-1,renderSharedPoolFormPage("T\u1EA1o \u0111\u1EC1 luy\u1EC7n t\u1EADp m\u1EDBi",null);const t=restoreSpDraftIntoForm("new");startSpDraftAutosave("new"),t&&toast("\u0110\xE3 kh\xF4i ph\u1EE5c b\u1EA3n nh\xE1p ch\u01B0a l\u01B0u trong 15 ph\xFAt g\u1EA7n nh\u1EA5t.","info")}async function showSharedPoolDetail({id:t}){const e=routeToken();let n;try{n=await api.get(`/shared-pool/${t}`)}catch(o){if(routeChanged(e))return;renderRouteError("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c \u0111\u1EC1",o,"/shared-pool");return}if(routeChanged(e))return;_sharedEditingId=t,_vocabItems=Array.isArray(n.vocabulary)?[...n.vocabulary]:[],_contentBlocks=Array.isArray(n.content_blocks)&&n.content_blocks.length?n.content_blocks:[createTextBlock(n.content_text||"")],_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioFile=null,_audioUploadUrl=n.content_url||null,_audioUploadKey=null,_audioUploadName="",_audioUploadSize=0,_audioUploading=!1,_editingVocabIndex=-1,renderSharedPoolFormPage("S\u1EEDa \u0111\u1EC1 luy\u1EC7n t\u1EADp",n);const i=restoreSpDraftIntoForm("edit",t,n.skill,n);startSpDraftAutosave("edit",t,n.skill),i&&toast("\u0110\xE3 kh\xF4i ph\u1EE5c b\u1EA3n nh\xE1p ch\u01B0a l\u01B0u trong 15 ph\xFAt g\u1EA7n nh\u1EA5t.","info");try{const o=await api.get(`/shared-pool/${t}/stats`);if(routeChanged(e))return;renderSharedPoolStats(o,t,n.skill)}catch{}}function renderSharedPoolFormPage(t,e){const n=e?.skill||"";$("#app").innerHTML=`
    ...
    </div>`}).join("");let i="";if(e){const o=_cqSections[_cqEditingIdx];let s="";o.skill==="reading"?s=skillEditorHtml("reading",{includeVocab:!1}):o.skill==="listening"?s=skillEditorHtml("listening",{includeVocab:!1,scriptValue:o.script||"",scriptPlaceholder:"Script t\u1EF1 \u0111\u1ED9ng \u0111i\u1EC1n sau khi upload audio",scriptRows:6}):o.skill==="writing"?s=skillEditorHtml("writing",{writingHintBox:`
          <div class="form-group">
            <label class="form-label">S\u1ED1 t\u1EEB t\u1ED1i thi\u1EC3u g\u1EE3i \xFD</label>
            <div style="display:flex;align-items:center;gap:8px">
              <input id="cq-min-words" class="form-input" type="number" min="1"
                value="${o.min_word_count??""}" placeholder="VD: 150 ho\u1EB7c 250" style="width:140px" />
              <span style="color:var(--gray-400);font-size:13px">t\u1EEB \u2014 hi\u1EC7n cho h\u1ECDc sinh khi l\xE0m ph\u1EA7n n\xE0y</span>
            </div>
          </div>`}):o.skill==="speaking"&&(s=skillEditorHtml("speaking",{})),i=`
