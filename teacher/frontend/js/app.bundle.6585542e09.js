...
`),n=[];let i=null;const s=()=>{i&&(n.push(`</${i}>`),i=null)};for(const o of e){const a=o.trim();if(!a){s();continue}const r=a.match(/^[-*]\s+(.+)$/),l=a.match(/^\d+\.\s+(.+)$/);if(r||l){const d=r?"ul":"ol";i!==d&&(s(),n.push(`<${d}>`),i=d),n.push(`<li>${renderMarkdownInline((r||l)[1])}</li>`);continue}s();const c=a.match(/^(#{2,4})\s+(.+)$/);c?n.push(`<h5>${renderMarkdownInline(c[2])}</h5>`):n.push(`<p>${renderMarkdownInline(a)}</p>`)}return s(),n.join("")}function btnReset(t){t&&(t.disabled=!1,t.innerHTML=t._origHTML||t.innerHTML)}function toast(t,e="success"){const n=e==="error"?6e3:3500,i=document.createElement("div");i.className=`toast toast-${e}`,i.setAttribute("role","alert");const s=document.createElement("span");s.textContent=t;const o=document.createElement("button");o.className="toast-close",o.setAttribute("aria-label","\u0110\xF3ng th\xF4ng b\xE1o"),o.textContent="\xD7",o.onclick=()=>i.remove(),i.appendChild(s),i.appendChild(o),i.addEventListener("mouseenter",()=>i.classList.add("toast-paused")),i.addEventListener("mouseleave",()=>i.classList.remove("toast-paused")),$("#toast-container").appendChild(i);const a=setTimeout(()=>i.remove(),n);i.addEventListener("mouseenter",()=>clearTimeout(a)),i.addEventListener("mouseleave",()=>setTimeout(()=>i.remove(),1e3))}function setLoading(t="\u0110ang t\u1EA3i..."){$("#app").innerHTML=`
    ...
    `);const a=$("#modal-overlay"),r=a?.querySelector('[data-confirm-action="cancel"]'),l=a?.querySelector('[data-confirm-action="confirm"]');let c=!1;const d=u=>{c||(c=!0,window._modalCloseCallback=null,closeModal(),o(u))};window._modalCloseCallback=()=>d(!1),r.onclick=()=>d(!1),l.onclick=()=>d(!0),a.onclick=u=>{u.target===a&&d(!1)}})}function promptAction({title:t="Nh\u1EADp th\xF4ng tin",message:e="",initialValue:n="",placeholder:i="",confirmText:s="L\u01B0u",cancelText:o="Hu\u1EF7",validate:a}={}){return new Promise(r=>{openModal(t,`
      <div style="display:flex;flex-direction:column;gap:16px">
    ...
    `);const l=$("#modal-overlay"),c=l?.querySelector("#prompt-action-input"),d=l?.querySelector("#prompt-action-error"),u=l?.querySelector('[data-prompt-action="cancel"]'),m=l?.querySelector('[data-prompt-action="confirm"]');let h=!1;const g=w=>{h||(h=!0,window._modalCloseCallback=null,closeModal(),r(w))};window._modalCloseCallback=()=>g(null);const f=()=>{const w=c?.value??"",y=w.trim(),C=typeof a=="function"?a(y,w):"";if(C){d&&(d.textContent=C),c?.focus(),c?.select?.();return}g(y)};u.onclick=()=>g(null),m.onclick=f,c?.addEventListener("keydown",w=>{w.key==="Enter"&&(w.preventDefault(),f())}),l.onclick=w=>{w.target===l&&g(null)},requestAnimationFrame(()=>{c?.focus(),c?.select?.()})})}let _oneTimeStudentCredentials=null;function closeModal(t){const e=$("#modal-overlay");t&&t.target!==e||(_oneTimeStudentCredentials=null,e&&(e.onclick=n=>closeModal(n)),window._modalCloseCallback&&(window._modalCloseCallback(),window._modalCloseCallback=null),e.classList.add("hidden"),$("#modal-body").innerHTML="",_modalPreviousFocus&&(_modalPreviousFocus.focus(),_modalPreviousFocus=null))}document.addEventListener("keydown",t=>{const e=$("#modal-overlay");if(!e||e.classList.contains("hidden"))return;const n=e.querySelector(".modal")||e;if(t.key==="Escape"){closeModal();return}if(t.key==="Tab"){const i=[...n.querySelectorAll(FOCUSABLE)];if(!i.length)return;const s=i[0],o=i[i.length-1];(t.shiftKey?document.activeElement===s:document.activeElement===o)&&(t.preventDefault(),(t.shiftKey?o:s).focus())}});function splitDelimitedList(t,e=/\n/){return String(t||"").split(e).map(n=>n.trim()).filter(Boolean)}function csvEscape(t){return`"${String(t??"").replace(/"/g,'""')}"`}function downloadCsvFile(t,e,n){const i=[e,...n].map(r=>r.map(csvEscape).join(",")).join(`
`),s=new Blob(["\uFEFF"+i],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(s),a=document.createElement("a");a.href=o,a.download=t,a.click(),URL.revokeObjectURL(o)}async function downloadAudioFile(t,e,n){if(!t)return;const i=n?n.innerHTML:"";try{n&&(n.disabled=!0,n.innerHTML="\u23F3");const s=await fetch(t,{cache:"no-store"});if(!s.ok)throw new Error("fetch failed");const o=await s.blob(),a=(t.split("?")[0].match(/\.([a-zA-Z0-9]+)$/)||[])[1],r=(o.type.split("/")[1]||"").split(";")[0],l=a||r||"webm",c=(e||"audio").replace(/\.[a-zA-Z0-9]{2,5}$/,""),d=URL.createObjectURL(o),u=document.createElement("a");u.href=d,u.download=`${c}.${l}`,document.body.appendChild(u),u.click(),u.remove(),URL.revokeObjectURL(d)}catch(s){toast("T\u1EA3i file th\u1EA5t b\u1EA1i: "+(s.message||"l\u1ED7i kh\xF4ng x\xE1c \u0111\u1ECBnh"),"error")}finally{n&&(n.disabled=!1,n.innerHTML=i)}}window.downloadAudioFile=downloadAudioFile;function buildStudentCredentialsFilename(t="student_accounts"){const e=new Date().toISOString().replace(/[-:]/g,"").replace(/\.\d{3}Z$/,"Z");return`${t}_${e}.csv`}function openStudentCredentialsModal(t,e,n="student_accounts"){const i=(Array.isArray(e)?e:[]).map(s=>({full_name:String(s?.full_name||"").trim(),username:String(s?.username||"").trim(),password:String(s?.password||"")})).filter(s=>s.full_name&&s.username&&s.password);_oneTimeStudentCredentials=i.length>0?{rows:i,fileName:buildStudentCredentialsFilename(n)}:null,openModal(t,`
    ...
    </div>`,document.body.appendChild(i),i.querySelector("#confirm-cancel-save").onclick=()=>i.remove(),i.querySelector("#confirm-do-save").onclick=()=>{i.remove(),e()},i.addEventListener("click",s=>{s.target===i&&i.remove()})}function collectAnswerGrid(){const t=document.querySelectorAll("#answer-grid .answer-row");return Array.from(t).map((e,n)=>{const i=e.querySelector(".chip-container"),s=getChipValues(i),o=e.querySelector(".answer-location")?.value.trim()||"",a=e.querySelector(".answer-location-meta")?.value.trim()||"",r=e.querySelector(".answer-explanation")?.value.trim()||"",l={q_no:n+1,answers:s};if(o&&(l.location=o),a)try{l.location_meta=JSON.parse(a)}catch{}return r&&(l.explanation=r),l})}function _createAnswerRow(t,e=null){const n=document.createElement("div");n.className="answer-row";const i=document.createElement("div");i.className="answer-row-main";const s=document.createElement("span");s.className="q-label",s.textContent=`Q${t}`;const o=document.createElement("div");if(o.className="chip-container",e?.answers)for(const m of e.answers){const h=document.createElement("span");h.className="chip",h.dataset.value=m,h.innerHTML=`${escapeHtml(m)} <button class="chip-remove" title="Xo\xE1" aria-label="Xo\xE1">\xD7</button>`,h.querySelector(".chip-remove").onclick=()=>h.remove(),o.appendChild(h)}const a=document.createElement("input");a.className="chip-input",a.placeholder="\u0110\xE1p \xE1n + Enter",o.appendChild(a);const r=document.createElement("button");r.className="btn-delete-row",r.title="Xo\xE1 c\xE2u n\xE0y",r.setAttribute("aria-label","Xo\xE1 c\xE2u n\xE0y"),r.textContent="\xD7",r.onclick=function(){removeAnswerRow(this.closest(".answer-row"))},i.appendChild(s),i.appendChild(o),i.appendChild(r);const l=document.createElement("div");l.className="location-row",l.innerHTML=`
    ...
    </div>`}window.showHistogramStudents=showHistogramStudents;function renderStatsTab(t,e){destroyStatsCharts();const{timeline:n,per_student:i,per_assignment:s}=e,o=_statsSkillFilter,a=_statsStatusFilter,r=_statsModeFilter,l=_statsScaleFilter,c=s.filter(p=>!(o&&p.skill!==o||a==="active"&&!p.is_active||a==="closed"&&p.is_active||r&&p.mode!==r||l&&(p.scoring_scale||"10")!==l)),d=new Set(c.map(p=>p.id)),u=p=>p.length?p.reduce((v,b)=>v+b,0)/p.length:null,m=i.length,h=c.length,g=c.filter(p=>p.is_active).length,f=h-g,w=new Map;i.forEach(p=>{p.submissions.forEach(v=>{if(!d.has(v.assignment_id))return;const b=`${p.id||p.student_id}:${v.assignment_id}`,k=w.get(b);(!k||(v.attempt_number||1)>(k.attempt_number||1))&&w.set(b,{...v,student_name:p.name})})});const y=Array.from(w.values()),C=y.filter(p=>p.overall_score!==null);_statsAllScoredSubs=C;const E=u(C.map(p=>Number(p.overall_score))),I=h*m,N=I>0?Math.round(y.length/I*100):0,D=[0,0,0,0,0];for(const p of C){const v=Number(p.overall_score),b=v>=9?4:Math.min(4,Math.floor(v/2));D[b]++}const P=["reading","listening","writing","speaking"],j={},Q={};for(const p of P){const v=C.filter(_=>_.skill===p);j[p]=u(v.map(_=>Number(_.overall_score)));const b=c.filter(_=>_.skill===p),k=y.filter(_=>_.skill===p),B=b.length*m;Q[p]={count:b.length,submitted:k.length,pct:B>0?Math.round(k.length/B*100):0}}let F=i.map(p=>{const v=p.submissions.filter(T=>d.has(T.assignment_id)),b=new Map;v.forEach(T=>{const x=b.get(T.assignment_id);(!x||(T.attempt_number||1)>(x.attempt_number||1))&&b.set(T.assignment_id,T)});const k=Array.from(b.values()),B=k.filter(T=>T.overall_score!==null),_=T=>u(B.filter(x=>x.skill===T).map(x=>Number(x.overall_score))),S=k.filter(T=>!T.is_active&&T.deadline),L=S.filter(T=>T.on_time).length;return{...p,submitted:k.length,total:h,avg_score:o?_(o):u(B.map(T=>Number(T.overall_score))),avg_reading:_("reading"),avg_listening:_("listening"),avg_writing:_("writing"),avg_speaking:_("speaking"),on_time:L,closed_total:S.length,on_time_rate:S.length>0?L/S.length:null}});_statsSortCol&&(F=[...F].sort((p,v)=>{let b=p[_statsSortCol],k=v[_statsSortCol];return b==null?1:k==null?-1:typeof b=="string"?_statsSortDir==="asc"?b.localeCompare(k):k.localeCompare(b):_statsSortDir==="asc"?b-k:k-b}));const R=p=>p!=null?Number(p).toFixed(1):"\u2014",U=(p,v)=>v>0?Math.round(p/v*100):0,M=p=>_statsSortCol!==p?'<span class="sort-icon">\u2195</span>':`<span class="sort-icon active">${_statsSortDir==="asc"?"\u2191":"\u2193"}</span>`,V={reading:"#3b82f6",listening:"#f59e0b",writing:"#8b5cf6",speaking:"#22c55e"},z=["#3b82f6","#ef4444","#22c55e","#f59e0b","#8b5cf6","#06b6d4","#ec4899","#14b8a6","#f97316","#a3e635"],X={reading:"Reading",listening:"Listening",writing:"Writing",speaking:"Speaking",composite:"T\u1ED5ng h\u1EE3p"},Y=`
    ...
    </div>`,K=c.filter(p=>!p.is_active&&p.deadline),q=_closedAssignsSearch?K.filter(p=>p.title.toLowerCase().includes(_closedAssignsSearch)):K,W=3,H=_closedAssignsExpanded?q:q.slice(0,W),it=q.length-H.length,st=K.length===0?"":`
    <div class="stats-section-card">
      ...
      ${q.length===0?'<p style="color:var(--gray-400);font-size:13px;padding:8px 0 4px">Kh\xF4ng t\xECm th\u1EA5y b\xE0i t\u1EADp ph\xF9 h\u1EE3p</p>':`<canvas id="chart-ontime" height="${Math.max(80,H.length*38)}"></canvas>`}
      ${q.length>W?`
    ...
    <div class="stats-section-card">
      ...
      ${F.length===0?'<div class="empty-state" style="padding:20px">Kh\xF4ng c\xF3 d\u1EEF li\u1EC7u</div>':`<div class="table-wrap">
          <table class="stats-table">
            ...
            <tbody>
              ${F.map(p=>{const v=U(p.submitted,p.total),b=p.on_time_rate!==null?Math.round(p.on_time_rate*100):null;return`<tr>
    ...
    <div id="tab-stats" class="tab-content" style="display:none">
      ${s}
    </div>`}let _assignFilterSkill="",_assignFilterSearch="";function filterAssignments(t,e){t!==null&&(_assignFilterSearch=t.toLowerCase().trim()),e!==null&&(_assignFilterSkill=e,document.querySelectorAll(".assign-skill-pill").forEach(o=>{o.classList.toggle("active",o.dataset.skill===e)}));const n=_cachedCls;if(!n)return;const i=n.assignments.filter(o=>{const a=!_assignFilterSkill||o.skill===_assignFilterSkill,r=!_assignFilterSearch||o.title.toLowerCase().includes(_assignFilterSearch)||(o.question_title||"").toLowerCase().includes(_assignFilterSearch);return a&&r}),s=document.getElementById("assign-tbody");if(s){if(i.length===0){s.innerHTML=`<tr><td colspan="6">
      <div class="empty-state" style="padding:20px">
        <div class="empty-state-icon">\u{1F50D}</div>
        <h3 style="font-size:14px">Kh\xF4ng t\xECm th\u1EA5y b\xE0i n\xE0o</h3>
      </div></td></tr>`;return}_assignListSortCol&&i.sort((o,a)=>{let r,l;if(_assignListSortCol==="skill")r=o.skill||"",l=a.skill||"";else if(_assignListSortCol==="title")r=o.title.toLowerCase(),l=a.title.toLowerCase();else if(_assignListSortCol==="deadline")r=o.deadline||"",l=a.deadline||"";else return 0;return r<l?_assignListSortDir==="asc"?-1:1:r>l?_assignListSortDir==="asc"?1:-1:0}),updateAssignListSortIcons(),s.innerHTML=i.map(o=>{const a=isOverdue(o.deadline)&&o.is_active,r=n.student_count>0?Math.round(o.submission_count/n.student_count*100):0,c=o.skill==="composite"?`/composite/${o.id}`:`/assignment/${o.id}`;return`
      <tr>
...
`),o=new Blob(["\uFEFF"+s],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(o),r=document.createElement("a");r.href=a,r.download=`${t.title.replace(/[^a-zA-Z0-9_\-]/g,"_")}_diem.csv`,r.click(),URL.revokeObjectURL(a)}window.exportSubmissionsCSV=exportSubmissionsCSV;function buildSubmissionRows(t,e){return t.length===0?`<tr><td colspan="5">
    ...
    <div class="table-wrap">
      <table>
        ...
        </tr>`}).join(""),o=(t.student_answers||[]).filter(r=>(i[r.q_no]||[]).some(c=>c.toLowerCase().trim()===(r.answer||"").toLowerCase().trim())).length,a=(t.questions_data||[]).length;$("#modal-title").textContent=`B\xE0i l\xE0m \u2014 ${skillBadge(e).replace(/<[^>]+>/g,"")}`,$("#modal-body").innerHTML=`
      ...
      </div>`;else if(e==="speaking"){$("#modal-title").textContent="B\xE0i Speaking";const i=Array.isArray(t.speaking_audio_urls)&&t.speaking_audio_urls.length>0?t.speaking_audio_urls:t.speaking_audio_url?[{url:t.speaking_audio_url,name:""}]:[],s=i.length>1,o=i.length>0?i.map((r,l)=>`
          <div style="${s?"margin-bottom:10px":""}">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:8px">
              ${s?`<div style="font-size:12px;font-weight:600;color:var(--gray-500)">${escapeHtml(r.name||"Ph\u1EA7n "+(l+1))}</div>`:"<div></div>"}
    ...
    <div class="annotation-edit-actions">
      ...
      <button class="annotation-cancel-btn" onclick="refreshAnnotationsList()">Hu\u1EF7</button>
        ...
        <button type="button" class="btn btn-sm btn-danger" onclick="stopVoiceNoteRecording()">\u23F9 D\u1EEBng</button>`;else if(e.status==="checking")i='<span style="font-size:13px;color:var(--gray-500)">\u23F3 \u0110ang ki\u1EC3m tra file...</span>';else if(e.status==="uploading"){const s=e.pct<100&&e.eta!=null?` \xB7 ETA ${_fmtEta(e.eta)}`:"";i=`<div class="upload-progress-row" style="width:100%">
          <div class="upload-progress-bar-wrap"><div class="upload-progress-bar" style="width:${e.pct}%"></div></div>
          <span class="upload-progress-label">${e.pct}%${s}</span>
    ...
    </div>`}).join("")}}window.renderVoiceNotesList=renderVoiceNotesList;async function startVoiceNoteRecording(t){if(_voiceNoteRecordIdx>=0){toast("\u0110ang ghi \xE2m b\u1EA3n kh\xE1c, h\xE3y d\u1EEBng tr\u01B0\u1EDBc","warning");return}if(_gradingVoiceNotes[t]){_voiceNoteRecordIdx=t,_gradingVoiceNotes[t].status="recording",renderVoiceNotesList();try{const e=await navigator.mediaDevices.getUserMedia({audio:!0});_voiceNoteChunks=[];const n=pickAudioRecorderMime();_voiceNoteMediaRecorder=n?new MediaRecorder(e,{mimeType:n}):new MediaRecorder(e),_voiceNoteMediaRecorder.ondataavailable=i=>{i.data.size>0&&_voiceNoteChunks.push(i.data)},_voiceNoteMediaRecorder.onstop=()=>{e.getTracks().forEach(o=>o.stop());const i=(_voiceNoteMediaRecorder.mimeType||n||"audio/webm").split(";")[0],s=new Blob(_voiceNoteChunks,{type:i});_onVoiceNoteRecordingDone(_voiceNoteRecordIdx,s,i)},_voiceNoteMediaRecorder.start(),_voiceNoteRecordSeconds=0,clearInterval(_voiceNoteRecordTimer),_voiceNoteRecordTimer=setInterval(()=>{_voiceNoteRecordSeconds++;const i=Math.floor(_voiceNoteRecordSeconds/60),s=_voiceNoteRecordSeconds%60,o=document.getElementById("vn-record-timer");o&&(o.textContent=`${i}:${s.toString().padStart(2,"0")}`)},1e3)}catch(e){_gradingVoiceNotes[t].status="idle",_voiceNoteRecordIdx=-1,renderVoiceNotesList(),showMicErrorModal(t,e)}}}window.startVoiceNoteRecording=startVoiceNoteRecording;async function showMicErrorModal(t,e){const n=e?.name||"Error",i=e?.message||String(e||"");let s=-1;try{s=(await navigator.mediaDevices.enumerateDevices()).filter(r=>r.kind==="audioinput").length}catch{s=-1}let o="";n==="NotAllowedError"||n==="SecurityError"?o=`
      ...
      </ol>`:n==="NotFoundError"||n==="OverconstrainedError"||s===0?o=`
      <p><strong>Kh\xF4ng t\xECm th\u1EA5y thi\u1EBFt b\u1ECB microphone n\xE0o</strong> m\xE0 tr\xECnh duy\u1EC7t d\xF9ng \u0111\u01B0\u1EE3c${s===0?" (0 mic \u0111\u01B0\u1EE3c ph\xE1t hi\u1EC7n)":""}.</p>
      ...
      </ul>`:n==="NotReadableError"||n==="AbortError"?o=`
      ...
      </ul>`:o='<p>Kh\xF4ng truy c\u1EADp \u0111\u01B0\u1EE3c micro. H\xE3y th\u1EED t\u1EA3i l\u1EA1i trang ho\u1EB7c d\xF9ng n\xFAt "Ch\u1ECDn file" \u0111\u1EC3 upload audio c\xF3 s\u1EB5n thay v\xEC ghi \xE2m.</p>',openModal("\u{1F399}\uFE0F Kh\xF4ng th\u1EC3 truy c\u1EADp microphone",`
    <div style="display:flex;flex-direction:column;gap:12px;line-height:1.6;color:var(--text)">
      ...
      <div style="font-size:12px;color:var(--gray-500);background:var(--gray-50);border-radius:6px;padding:8px 10px;font-family:monospace">
        L\u1ED7i k\u1EF9 thu\u1EADt: ${escapeHtml(n)}${i?" \u2014 "+escapeHtml(i):""}${s>=0?` \xB7 mic ph\xE1t hi\u1EC7n: ${s}`:""}
      </div>
  ...
  `)}window.showMicErrorModal=showMicErrorModal;async function confirmReloadForMicPermission(){closeModal(),await confirmAction({title:"T\u1EA3i l\u1EA1i trang?",message:"Nh\u1EADn x\xE9t/\u0111i\u1EC3m ch\u01B0a l\u01B0u tr\xEAn trang ch\u1EA5m b\xE0i s\u1EBD b\u1ECB m\u1EA5t. C\xE1c b\u1EA3n ghi \xE2m \u0111\xE3 upload xong (tr\u1EA1ng th\xE1i \u2713) th\xEC v\u1EABn an to\xE0n.",confirmText:"T\u1EA3i l\u1EA1i trang",danger:!0})&&location.reload()}window.confirmReloadForMicPermission=confirmReloadForMicPermission;function stopVoiceNoteRecording(){clearInterval(_voiceNoteRecordTimer),_voiceNoteMediaRecorder?.stop()}window.stopVoiceNoteRecording=stopVoiceNoteRecording;function _onVoiceNoteRecordingDone(t,e,n){const i=_gradingVoiceNotes[t];if(_voiceNoteRecordIdx=-1,!i)return;if(!e||e.size===0){i.status="idle",renderVoiceNotesList(),toast("B\u1EA3n ghi r\u1ED7ng \u2014 vui l\xF2ng th\u1EED ghi \xE2m l\u1EA1i","error");return}const s=String(n||"audio/webm").split(";")[0].trim(),o=extFromAudioMime(s),a=new File([e],`voice-note-${t+1}.${o}`,{type:s});i.file=a,i.name=a.name,i.size=e.size,i.localUrl=URL.createObjectURL(e),i.status="uploading",i.pct=0,renderVoiceNotesList(),_uploadVoiceNoteSlot(t)}function pickAudioRecorderMime(){const t=["audio/webm;codecs=opus","audio/webm","audio/mp4","audio/ogg"];for(const e of t)try{if(window.MediaRecorder&&MediaRecorder.isTypeSupported(e))return e}catch{}return""}function extFromAudioMime(t){const e=String(t||"").split(";")[0].trim().toLowerCase();return e.includes("webm")?"webm":e.includes("ogg")?"ogg":e.includes("mp4")||e.includes("m4a")||e.includes("aac")?"m4a":e.includes("mpeg")||e.includes("mp3")?"mp3":e.includes("wav")?"wav":e.includes("flac")?"flac":"webm"}const BROWSER_PLAYABLE_AUDIO_EXTS=new Set(["mp3","mpeg","mpga","mp4","m4a","aac","wav","wave","ogg","oga","webm","flac"]);function probeAudioPlayable(t){return new Promise(e=>{const n=URL.createObjectURL(t),i=new Audio;let s=!1;const o=r=>{s||(s=!0,clearTimeout(a),i.removeAttribute("src"),URL.revokeObjectURL(n),e(r))},a=setTimeout(()=>o(!1),8e3);i.preload="metadata",i.onloadedmetadata=()=>o(isFinite(i.duration)&&i.duration>0),i.onerror=()=>o(!1),i.src=n})}async function onVoiceNoteFileSelected(t,e){const n=t.files?.[0];if(!n||!_gradingVoiceNotes[e])return;t.value="";const i=(n.name.split(".").pop()||"").toLowerCase();if(!BROWSER_PLAYABLE_AUDIO_EXTS.has(i)){showFeedbackAudioUnsupported(n.name,i);return}_gradingVoiceNotes[e].status="checking",renderVoiceNotesList();const s=await probeAudioPlayable(n);if(_gradingVoiceNotes[e]){if(!s){_gradingVoiceNotes[e].status="idle",renderVoiceNotesList(),showFeedbackAudioUnsupported(n.name,i,!0);return}_gradingVoiceNotes[e].file=n,_gradingVoiceNotes[e].name=n.name,_gradingVoiceNotes[e].size=n.size,_gradingVoiceNotes[e].localUrl=URL.createObjectURL(n),_gradingVoiceNotes[e].status="uploading",_gradingVoiceNotes[e].pct=0,renderVoiceNotesList(),_uploadVoiceNoteSlot(e)}}window.onVoiceNoteFileSelected=onVoiceNoteFileSelected;function showFeedbackAudioUnsupported(t,e,n=!1){openModal("\u26A0\uFE0F File audio kh\xF4ng ph\xE1t \u0111\u01B0\u1EE3c",`
  ...
  `)}window.openMoveQuestionModal=openMoveQuestionModal;async function confirmMoveQuestion(t){const e=document.getElementById("move-folder-select")?.value||null;try{await api.patch(`/questions/${t}`,{folder_id:e||null});const n=_allQuestions.find(i=>i.id===t);n&&(n.folder_id=e||null),closeModal(),renderQuestions(),toast("\u0110\xE3 di chuy\u1EC3n \u0111\u1EC1")}catch(n){toast("L\u1ED7i: "+(n.error||n.message),"error")}}window.confirmMoveQuestion=confirmMoveQuestion;function _buildQuestionTableRows(t){return t.length===0?`<tr><td colspan="6">
    ...
    <div class="question-bank-layout">
      ...
      </div>`},i=Array.isArray(e.questions_data)?e.questions_data:[],s=(l,c,d)=>`
    <div style="margin-bottom:12px">${skillBadge(l.skill)}</div>
    <div style="display:flex;gap:16px;margin-bottom:16px;flex-wrap:wrap">
    ...
    <div class="modal-footer">
      <button class="btn btn-outline" onclick="closeModal()">\u0110\xF3ng</button>
      <button class="btn btn-primary" onclick="closeModal();navigate('/questions/${t}')">Ch\u1EC9nh s\u1EEDa</button>
    </div>`,o=l=>{const c=Array.isArray(l.questions_data)?l.questions_data:[];return c.length===0?{qRows:"",hasMore:!1}:{qRows:c.slice(0,20).map(u=>`
      ...
      </div>`).join(""),hasMore:c.length>20}};if(e.skill==="composite"){openModal(escapeHtml(e.title),'<div style="color:var(--gray-400)">\u0110ang t\u1EA3i...</div>');try{const l=await api.get(`/questions/${t}`);Object.assign(e,l);const c=document.getElementById("modal-body");c&&(c.innerHTML=n(l))}catch{}return}const{qRows:a,hasMore:r}=o(e);if(openModal(escapeHtml(e.title),s(e,a,r)),!e.content_text&&(e.skill==="reading"||e.skill==="listening"||e.skill==="writing"||e.skill==="speaking"))try{const l=await api.get(`/questions/${t}`);Object.assign(e,l);const c=document.getElementById("modal-body");if(c){const{qRows:d,hasMore:u}=o(l);c.innerHTML=s(l,d,u)}}catch{}}window.previewQuestion=previewQuestion;function setSkillFilter(t){_currentSkillFilter=t,renderQuestions()}async function deleteQuestion(t,e){if(await confirmAction({title:"Xo\xE1 \u0111\u1EC1 kh\u1ECFi kho",message:"N\u1EBFu \u0111\u1EC1 \u0111ang \u0111\u01B0\u1EE3c d\xF9ng trong b\xE0i t\u1EADp, h\u1EC7 th\u1ED1ng s\u1EBD ch\u1EB7n thao t\xE1c n\xE0y.",confirmText:"Xo\xE1 \u0111\u1EC1",danger:!0})){btnLoading(e);try{await api.delete(`/questions/${t}`),toast("\u0110\xE3 xo\xE1 \u0111\u1EC1"),showQuestions()}catch(i){btnReset(e),toast("L\u1ED7i xo\xE1: "+(i.error||i.message),"error")}}}let _contentBlocks=[],_contentBlockSeq=1,_contentImageUploadCount=0,_composerSavedRange=null,_composerCollapsed=!1;function nextContentBlockId(){return`cb-${_contentBlockSeq++}`}function createTextBlock(t=""){return{id:nextContentBlockId(),type:"text",html:t}}function createImageBlock(t="",e="",n=100){return{id:nextContentBlockId(),type:"image",url:t,alt:e,width:n}}function repairImageTokensInBlocks(t){const e=[];for(const s of t){let r=function(){const c=a.innerHTML.replace(/^(<br\s*\/?>)+|(<br\s*\/?>)+$/gi,"").trim();c&&e.push({id:nextContentBlockId(),type:"text",html:c}),a=document.createElement("div")},l=function(c){c.nodeType===Node.ELEMENT_NODE&&c.classList?.contains("document-editor-image-token")?(r(),e.push({id:c.dataset.blockId||nextContentBlockId(),type:"image",url:c.dataset.url||"",alt:c.dataset.alt||"",width:Math.max(1,Number(c.dataset.width)||100)})):c.nodeType===Node.ELEMENT_NODE&&c.querySelector?.(".document-editor-image-token")?c.childNodes.forEach(d=>l(d)):a.appendChild(c.cloneNode(!0))};var n=r,i=l;if(s.type!=="text"||!s.html?.includes("document-editor-image-token")){e.push(s);continue}const o=document.createElement("div");o.innerHTML=s.html;let a=document.createElement("div");o.childNodes.forEach(c=>l(c)),r()}return e}function normalizeContentBlocksForEditor(t,e=""){const i=repairImageTokensInBlocks(Array.isArray(t)?t:[]).map(s=>{if(s?.type==="image"&&s?.url)return{id:s.id||nextContentBlockId(),type:"image",url:s.url,alt:s.alt||"",width:Number(s.width)||100};const o=normalizeIndentMarkupHtml(s?.html??(s?.text?textToEditorHtml(s.text):"")),a=(()=>{const r=document.createElement("div");return r.innerHTML=o,r.textContent||""})();return{id:s?.id||nextContentBlockId(),type:"text",html:o,text:a}}).filter(Boolean);return i.length>0?i:[createTextBlock(escapeHtml(e||""))]}function blocksToPlainText(t=_contentBlocks){return(t||[]).filter(e=>e.type==="text").map(e=>{if(e.html){const n=document.createElement("div");return n.innerHTML=e.html,(n.textContent||"").trim()}return String(e.text||"").trim()}).filter(Boolean).join(`
...
`;function showAiPromptHelper(t){openModal(t==="vocab"?"\u2728 Prompt t\u1EA1o CSV t\u1EEB v\u1EF1ng b\u1EB1ng AI":"\u2728 Prompt t\u1EA1o CSV \u0111\xE1p \xE1n b\u1EB1ng AI",`
  ...
  `)}window.showAiPromptHelper=showAiPromptHelper;async function copyAiPromptHelperText(){const t=document.getElementById("ai-prompt-helper-text");if(t)try{await navigator.clipboard.writeText(t.value),toast("\u0110\xE3 sao ch\xE9p prompt! D\xE1n v\xE0o ChatGPT/Claude \u0111\u1EC3 d\xF9ng.","success")}catch{t.removeAttribute("readonly"),t.focus(),t.select(),document.execCommand("copy"),t.setAttribute("readonly",""),toast("\u0110\xE3 sao ch\xE9p prompt!","success")}}window.copyAiPromptHelperText=copyAiPromptHelperText;function vocabImportBoxHtml(){return`
    ...
    </div>`).join("")}}let _xlsxLoadingPromise=null;function ensureXlsxLoaded(){return window.XLSX?Promise.resolve(window.XLSX):_xlsxLoadingPromise||(_xlsxLoadingPromise=new Promise((t,e)=>{const n=document.createElement("script");n.src="js/vendor/xlsx/xlsx.full.min.js",n.async=!0,n.onload=()=>t(window.XLSX),n.onerror=()=>{_xlsxLoadingPromise=null,e(new Error("Kh\xF4ng th\u1EC3 t\u1EA3i th\u01B0 vi\u1EC7n \u0111\u1ECDc Excel"))},document.head.appendChild(n)}),_xlsxLoadingPromise)}function parseVocabCsvText(t){const e=[];let n=[],i="",s=!1;for(let o=0;o<t.length;o++){const a=t[o];s?a==='"'?t[o+1]==='"'?(i+='"',o++):s=!1:i+=a:a==='"'?s=!0:a===","?(n.push(i),i=""):a==="\r"||(a===`
`?(n.push(i),i="",e.push(n),n=[]):i+=a)}return(i.length>0||n.length>0)&&(n.push(i),e.push(n)),e.filter(o=>o.some(a=>String(a).trim()!==""))}function vocabHeaderLevenshtein(t,e){const n=t.length,i=e.length;if(n===0)return i;if(i===0)return n;const s=Array.from({length:n+1},()=>new Array(i+1).fill(0));for(let o=0;o<=n;o++)s[o][0]=o;for(let o=0;o<=i;o++)s[0][o]=o;for(let o=1;o<=n;o++)for(let a=1;a<=i;a++)s[o][a]=t[o-1]===e[a-1]?s[o-1][a-1]:1+Math.min(s[o-1][a-1],s[o-1][a],s[o][a-1]);return s[n][i]}function mapHeadersByAliases(t,e,n){const i={};for(const o of Object.keys(e))i[o]=null;const s=new Set;return t.forEach((o,a)=>{const r=n(o);if(!r)return;let l=null,c=1/0;for(const[d,u]of Object.entries(e))if(!s.has(d))for(const m of u){const h=vocabHeaderLevenshtein(r,m);h<=1&&h<c&&(c=h,l=d)}l&&(i[l]=a,s.add(l))}),i}const VOCAB_FIELD_ALIASES={word:["word"],definition:["definition"],pronunciation:["pronunciation"],collocation:["collocation"],example:["example"]};function normalizeVocabHeader(t){return String(t??"").toLowerCase().trim().replace(/[^a-z]/g,"")}function mapVocabHeaders(t){return mapHeadersByAliases(t,VOCAB_FIELD_ALIASES,normalizeVocabHeader)}function setVocabImportStatus(t,e=""){const n=$("#vocab-import-status");n&&(n.className=`pdf-import-status${e?` is-${e}`:""}`,n.textContent=t)}async function handleVocabFileImport(t){const e=t?.files?.[0];if(t&&(t.value=""),!e)return;const n=(e.name.split(".").pop()||"").toLowerCase(),i=n==="csv"||e.type==="text/csv";if(!i&&!(n==="xlsx"||n==="xls")){setVocabImportStatus("Ch\u1EC9 h\u1ED7 tr\u1EE3 file .csv, .xlsx ho\u1EB7c .xls.","error"),toast("File kh\xF4ng h\u1EE3p l\u1EC7","error");return}setVocabImportStatus("\u0110ang \u0111\u1ECDc file...","loading");try{let o;if(i){const d=(await e.text()).replace(/^\uFEFF/,"");o=parseVocabCsvText(d)}else{const d=await ensureXlsxLoaded(),u=await e.arrayBuffer(),m=d.read(new Uint8Array(u),{type:"array"}),h=m.Sheets[m.SheetNames[0]];o=d.utils.sheet_to_json(h,{header:1,defval:"",raw:!1}).filter(g=>Array.isArray(g)&&g.some(f=>String(f).trim()!==""))}if(!o||o.length<2){setVocabImportStatus("File kh\xF4ng c\xF3 d\u1EEF li\u1EC7u (c\u1EA7n d\xF2ng ti\xEAu \u0111\u1EC1 + \xEDt nh\u1EA5t 1 d\xF2ng d\u1EEF li\u1EC7u).","error"),toast("File tr\u1ED1ng","error");return}const a=mapVocabHeaders(o[0]);if(a.word==null||a.definition==null){setVocabImportStatus('Kh\xF4ng t\xECm th\u1EA5y c\u1ED9t "word" v\xE0/ho\u1EB7c "definition" \u1EDF d\xF2ng ti\xEAu \u0111\u1EC1.',"error"),toast("Thi\u1EBFu c\u1ED9t b\u1EAFt bu\u1ED9c: word, definition","error");return}const r=[];let l=0;for(let d=1;d<o.length;d++){const u=o[d]||[],m=String(u[a.word]??"").trim(),h=String(u[a.definition]??"").trim();if(!m||!h){l++;continue}const g={word:m,definition:h};for(const f of["pronunciation","collocation","example"]){const w=a[f];if(w==null)continue;const y=String(u[w]??"").trim();y&&(g[f]=y)}r.push(g)}if(r.length===0){setVocabImportStatus("Kh\xF4ng c\xF3 d\xF2ng d\u1EEF li\u1EC7u h\u1EE3p l\u1EC7 (c\u1EA7n \u0111\u1EE7 word + definition).","error"),toast("Kh\xF4ng import \u0111\u01B0\u1EE3c d\xF2ng n\xE0o","error");return}_vocabItems.push(...r),renderVocabList(),scheduleQuestionDraftSave();const c=l>0?`, b\u1ECF qua ${l} d\xF2ng thi\u1EBFu d\u1EEF li\u1EC7u`:"";setVocabImportStatus(`\u0110\xE3 import ${r.length} t\u1EEB v\u1EF1ng t\u1EEB "${e.name}"${c}.`,"success"),toast(`\u0110\xE3 import ${r.length} t\u1EEB v\u1EF1ng`)}catch(o){console.error("Vocab import failed:",o);const a=o?.message||"Kh\xF4ng th\u1EC3 \u0111\u1ECDc file n\xE0y.";setVocabImportStatus(a,"error"),toast(a,"error")}}function showQuestionForm(){_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioFile=null,_audioUploadUrl=null,_audioUploadKey=null,_audioUploadName="",_audioUploadSize=0,_audioUploading=!1,_editingVocabIndex=-1,$("#app").innerHTML=`
    <a class="back-link" onclick="navigate('/questions')">\u2190 Kho \u0111\u1EC1</a>
    ...
    <div class="form-group">
      ...
      ${answerImportBoxHtml()}
    </div>`}const ANSWER_FIELD_ALIASES={q_no:["stt","sott","qno","causo","socau","so"],answers:["dapan","answer","answers","dapanmau","correctanswer"],explanation:["giaithich","explanation","explain"],location:["location","vitri","position"]};function normalizeAnswerHeader(t){return String(t??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/[^a-z0-9]/g,"")}function mapAnswerHeaders(t){return mapHeadersByAliases(t,ANSWER_FIELD_ALIASES,normalizeAnswerHeader)}function escapeRegExpChars(t){return String(t).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function buildFuzzyLocationRegex(t){const e=String(t).trim().split(/\s+/).filter(Boolean).map(escapeRegExpChars);if(!e.length)return null;try{return new RegExp(e.join("\\s+"),"i")}catch{return null}}function findReadingLocationMatch(t){const e=buildFuzzyLocationRegex(t);if(!e)return null;const n=document.querySelectorAll("#content-composer-preview-body .mixed-content-text[data-block-id]");for(const i of n){const s=e.exec(i.textContent||"");if(s){const o=s.index,a=o+s[0].length;return{text:s[0],meta:{type:"preview_text_range",start_block_id:i.dataset.blockId,end_block_id:i.dataset.blockId,start_offset:o,end_offset:a,text:s[0]}}}}return null}function findListeningLocationMatch(t){const e=document.getElementById("listening-script");if(!e)return null;const n=buildFuzzyLocationRegex(t);if(!n)return null;const i=n.exec(e.value||"");if(!i)return null;const s=i.index,o=s+i[0].length;return{text:i[0],meta:{type:"script_text_range",start:s,end:o,text:i[0]}}}function findAnswerLocationMatch(t){return document.getElementById("listening-script")?findListeningLocationMatch(t):findReadingLocationMatch(t)}function setAnswerRowChips(t,e){const n=t.querySelector(".chip-container");if(!n)return;n.querySelectorAll(".chip").forEach(s=>s.remove());const i=n.querySelector(".chip-input");for(const s of e){const o=String(s).trim();if(!o)continue;const a=document.createElement("span");a.className="chip",a.dataset.value=o,a.innerHTML=`${escapeHtml(o)} <button class="chip-remove" title="Xo\xE1" aria-label="Xo\xE1">\xD7</button>`,a.querySelector(".chip-remove").onclick=()=>a.remove(),n.insertBefore(a,i)}}function applyAnswerLocationToRow(t,e,n){const i=t.querySelector(".answer-location"),s=t.querySelector(".answer-location-meta"),o=t.querySelector(".location-text-display");i&&(i.value=e),s&&(s.value=JSON.stringify(n)),o&&(o.textContent=e),t.querySelector(".btn-clear-location")?.classList.remove("hidden")}function answerImportBoxHtml(){return`
    <div class="pdf-import-box" style="margin-top:10px">
      <div class="pdf-import-head">
        <div>
...
`)){const s=i.match(/^([^:\n]+?):\s/);s&&!e.has(s[1])&&(e.add(s[1]),n.push(s[1]))}return n}function _nextSpeakerLabel(){const t=new Set(_speakerNames.map(e=>e.original));for(const e of"ABCDEFGHIJKLMNOPQRSTUVWXYZ")if(!t.has(e))return e;return"?"}function _hasSpeakerPattern(t){return/^[A-Za-z][^:\n]*:\s/m.test(t)}function _refreshSpeakerNames(){const t=$("#listening-script");if(!t||!_hasSpeakerPattern(t.value))return;const e=_parseSpeakersFromTranscript(t.value),n=new Map(_speakerNames.map(i=>[i.original,i]));_speakerNames=e.map(i=>n.get(i)||{original:i,replace:""}),_speakerNames.length===0&&(_speakerNames=[{original:"A",replace:""},{original:"B",replace:""}])}function _renderSpeakerRenameUI(){const t=$("#speaker-rename-section");if(!t)return;const e=$("#listening-script");if(!(e&&_hasSpeakerPattern(e.value))){t.style.display="none";return}t.style.display="";const i=$("#speaker-rename-list");if(!i)return;const s="padding:4px 8px;border:1px solid var(--border);border-radius:5px;font-size:13px;background:var(--surface,var(--bg-subtle));color:var(--text);outline:none;width:100%";i.innerHTML=_speakerNames.map((o,a)=>`
    ...
    `}`),setTimeout(()=>{($("#stu-names")||$("#stu-existing-username"))?.focus()},50)}function switchStudentTab(t){_addStudentTab=t,renderAddStudentModal()}async function submitCreateStudent(t){const e=parseStudentNameLines($("#stu-names")?.value);if(e.length===0){toast("Vui l\xF2ng nh\u1EADp \xEDt nh\u1EA5t 1 h\u1ECDc sinh","error");return}btnLoading(t);try{const n=await api.post("/students",{class_id:_addStudentClassId,students:e.map(s=>({full_name:s}))}),i=Array.isArray(n.created)?n.created:[];if(i.length===0)throw new Error("Kh\xF4ng nh\u1EADn \u0111\u01B0\u1EE3c t\xE0i kho\u1EA3n \u0111\xE3 t\u1EA1o");closeModal(),openStudentCredentialsModal(i.length===1?"T\xE0i kho\u1EA3n h\u1ECDc sinh \u0111\xE3 \u0111\u01B0\u1EE3c t\u1EA1o":`\u0110\xE3 t\u1EA1o ${i.length} t\xE0i kho\u1EA3n h\u1ECDc sinh`,i,i.length===1?"student_account":"student_accounts"),toast(`\u0110\xE3 t\u1EA1o ${i.length} t\xE0i kho\u1EA3n h\u1ECDc sinh!`),showClassDetail({id:_addStudentClassId})}catch(n){btnReset(t),toast("L\u1ED7i: "+(n.error||n.message||"Kh\xF4ng th\u1EC3 t\u1EA1o h\u1ECDc sinh"),"error")}}async function submitAddExistingStudent(t){const e=$("#stu-existing-username")?.value.trim();if(!e){toast("Vui l\xF2ng nh\u1EADp username","error");return}btnLoading(t);try{await api.post("/student-classes",{class_id:_addStudentClassId,username:e}),closeModal(),toast("\u0110\xE3 th\xEAm h\u1ECDc sinh v\xE0o l\u1EDBp!"),showClassDetail({id:_addStudentClassId})}catch(n){btnReset(t),toast("L\u1ED7i: "+(n.error||"Kh\xF4ng th\u1EC3 th\xEAm h\u1ECDc sinh"),"error")}}function openResetPasswordModal(t,e,n){confirmAction({title:"C\u1EA5p m\u1EADt kh\u1EA9u m\u1EDBi",message:`M\u1EADt kh\u1EA9u c\u0169 c\u1EE7a <strong>${escapeHtml(e)}</strong> s\u1EBD h\u1EBFt hi\u1EC7u l\u1EF1c ngay sau khi \u0111\u1ED5i.`,confirmText:"C\u1EA5p m\u1EADt kh\u1EA9u m\u1EDBi",danger:!0}).then(i=>{i&&submitResetPassword(t,n)})}async function submitResetPassword(t,e){btnLoading(e);try{const n=await api.post(`/students/${t}/reset-password`,{});if(!n?.credentials)throw new Error("Kh\xF4ng nh\u1EADn \u0111\u01B0\u1EE3c m\u1EADt kh\u1EA9u m\u1EDBi");openStudentCredentialsModal("M\u1EADt kh\u1EA9u m\u1EDBi c\u1EE7a h\u1ECDc sinh",[n.credentials],"student_password_reset"),toast("\u0110\xE3 c\u1EA5p m\u1EADt kh\u1EA9u m\u1EDBi!")}catch(n){btnReset(e),toast("L\u1ED7i: "+(n.error||n.message||"Kh\xF4ng th\u1EC3 \u0111\u1ED5i m\u1EADt kh\u1EA9u"),"error");return}btnReset(e)}async function removeStudentFromClass(t,e,n){if(await confirmAction({title:"Xo\xE1 h\u1ECDc sinh kh\u1ECFi l\u1EDBp",message:"T\xE0i kho\u1EA3n h\u1ECDc sinh v\u1EABn \u0111\u01B0\u1EE3c gi\u1EEF l\u1EA1i, ch\u1EC9 b\u1ECB g\u1EE1 kh\u1ECFi l\u1EDBp n\xE0y.",confirmText:"G\u1EE1 kh\u1ECFi l\u1EDBp",danger:!0})){btnLoading(n);try{await api.delete(`/student-classes?student_id=${t}&class_id=${e}`),toast("\u0110\xE3 xo\xE1 h\u1ECDc sinh kh\u1ECFi l\u1EDBp"),showClassDetail({id:e})}catch(s){btnReset(n),toast("L\u1ED7i: "+(s.error||s.message),"error");return}btnReset(n)}}async function showProfileFields(){setLoading("\u0110ang t\u1EA3i...");const t=routeToken();try{const e=await api.get("/profile-fields");if(routeChanged(t))return;renderProfileFieldsPage(e)}catch(e){if(routeChanged(t))return;toast("L\u1ED7i: "+(e.error||e.message),"error"),renderRouteError("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c h\u1ED3 s\u01A1 h\u1ECDc sinh",e,"/profile-fields")}}function renderProfileFieldsPage(t){const e={text:"V\u0103n b\u1EA3n ng\u1EAFn",textarea:"V\u0103n b\u1EA3n d\xE0i",select:"Ch\u1ECDn \u0111\xE1p \xE1n",date:"Ng\xE0y sinh"},n={notification_email:"Email th\xF4ng b\xE1o"},i=t.length===0?'<div class="pf-empty"><div class="pf-empty-icon">\u{1F4CB}</div><div>Ch\u01B0a c\xF3 c\xE2u h\u1ECFi n\xE0o. Th\xEAm c\xE2u h\u1ECFi \u0111\u1EA7u ti\xEAn b\xEAn tr\xEAn!</div></div>':`<div class="table-wrap"><table class="pf-table">
        ...
        <tbody>${t.map((s,o)=>{const a=Array.isArray(s.options)&&s.options.length?`<div class="pf-opts-preview">${s.options.slice(0,3).map(l=>`<span class="pf-opt-pill">${escapeHtml(String(l))}</span>`).join("")}${s.options.length>3?`<span class="pf-opt-more">+${s.options.length-3}</span>`:""}</div>`:"",r=s.field_key?`<span class="pf-type-badge">${n[s.field_key]||s.field_key}</span>`:'<span style="color:var(--gray-400)">\u2014</span>';return`<tr>
  ...
  `,_buildSharedStatsChart(n)}function _buildSharedStatsChart(t){if(_sharedStatsChart){try{_sharedStatsChart.destroy()}catch{}_sharedStatsChart=null}const e=document.getElementById("sp-stats-chart");if(!e)return;const n=t.map(a=>_sharedStatsMode==="avg"?a.avg:a.max).filter(a=>a!=null).map(Number),i=[];for(let a=1;a<=9;a+=.5)i.push(a);const s=new Array(i.length).fill(0);for(const a of n){const r=Math.round(a*2)/2,l=i.indexOf(Math.min(9,Math.max(1,r)));l>=0&&s[l]++}const o=i.map(a=>a>=7?{bg:"#16a34a99",border:"#16a34a"}:a>=5?{bg:"#ca8a0499",border:"#ca8a04"}:{bg:"#dc262699",border:"#dc2626"});ensureChartJsLoaded().then(()=>{_sharedStatsChart=new Chart(e,{type:"bar",data:{labels:i.map(a=>a%1===0?String(a):a.toFixed(1)),datasets:[{label:_sharedStatsMode==="avg"?"\u0110i\u1EC3m TB / HS":"\u0110i\u1EC3m cao nh\u1EA5t / HS",data:s,backgroundColor:o.map(a=>a.bg),borderColor:o.map(a=>a.border),borderWidth:1,borderRadius:4}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{title:a=>`Band ${a[0].label}`,label:a=>`${a.raw} h\u1ECDc sinh`}}},scales:{x:{title:{display:!0,text:"Band IELTS"},grid:{display:!1}},y:{title:{display:!0,text:"S\u1ED1 h\u1ECDc sinh"},beginAtZero:!0,ticks:{stepSize:1}}}}})}).catch(()=>{const a=e.parentElement;a&&(a.innerHTML='<div class="empty-state" style="height:100%;display:flex;align-items:center;justify-content:center"><p>Kh\xF4ng th\u1EC3 t\u1EA3i bi\u1EC3u \u0111\u1ED3 l\xFAc n\xE0y.</p></div>')})}function setSharedStatsMode(t){_sharedStatsMode=t,document.querySelectorAll(".sp-stats-mode-btn").forEach(e=>{e.classList.toggle("active",e.textContent.includes(t==="avg"?"Trung b\xECnh":"Cao nh\u1EA5t"))}),_buildSharedStatsChart(_groupSharedStatsByStudent(_sharedStatsRows))}function toggleSharedStudentDetail(t){const e=document.getElementById(`sp-detail-${t}`),n=document.querySelector(`.sp-stats-student-row[data-sid="${t}"] .sp-expand-btn`);if(!e)return;const i=e.classList.toggle("hidden");n&&(n.textContent=i?"Chi ti\u1EBFt \u25BE":"Thu g\u1ECDn \u25B4")}window.showSharedPoolStats=showSharedPoolStats,window.closeSharedStatsModal=closeSharedStatsModal,window.setSharedStatsMode=setSharedStatsMode,window.toggleSharedStudentDetail=toggleSharedStudentDetail;let _sharedEditingId=null;async function showSharedPoolForm(){_sharedEditingId=null,_vocabItems=[],_contentBlocks=[createTextBlock("")],_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioFile=null,_audioUploadUrl=null,_audioUploadKey=null,_audioUploadName="",_audioUploadSize=0,_audioUploading=!1,_editingVocabIndex=-1,renderSharedPoolFormPage("T\u1EA1o \u0111\u1EC1 luy\u1EC7n t\u1EADp m\u1EDBi",null);const t=restoreSpDraftIntoForm("new");startSpDraftAutosave("new"),t&&toast("\u0110\xE3 kh\xF4i ph\u1EE5c b\u1EA3n nh\xE1p ch\u01B0a l\u01B0u trong 15 ph\xFAt g\u1EA7n nh\u1EA5t.","info")}async function showSharedPoolDetail({id:t}){const e=routeToken();let n;try{n=await api.get(`/shared-pool/${t}`)}catch(s){if(routeChanged(e))return;renderRouteError("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c \u0111\u1EC1",s,"/shared-pool");return}if(routeChanged(e))return;_sharedEditingId=t,_vocabItems=Array.isArray(n.vocabulary)?[...n.vocabulary]:[],_contentBlocks=Array.isArray(n.content_blocks)&&n.content_blocks.length?n.content_blocks:[createTextBlock(n.content_text||"")],_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioFile=null,_audioUploadUrl=n.content_url||null,_audioUploadKey=null,_audioUploadName="",_audioUploadSize=0,_audioUploading=!1,_editingVocabIndex=-1,renderSharedPoolFormPage("S\u1EEDa \u0111\u1EC1 luy\u1EC7n t\u1EADp",n);const i=restoreSpDraftIntoForm("edit",t,n.skill,n);startSpDraftAutosave("edit",t,n.skill),i&&toast("\u0110\xE3 kh\xF4i ph\u1EE5c b\u1EA3n nh\xE1p ch\u01B0a l\u01B0u trong 15 ph\xFAt g\u1EA7n nh\u1EA5t.","info");try{const s=await api.get(`/shared-pool/${t}/stats`);if(routeChanged(e))return;renderSharedPoolStats(s,t)}catch{}}function renderSharedPoolFormPage(t,e){const n=e?.skill||"";$("#app").innerHTML=`
    ...
    </div>`}).join("");let i="";if(e){const s=_cqSections[_cqEditingIdx];let o="";s.skill==="reading"?o=skillEditorHtml("reading",{includeVocab:!1}):s.skill==="listening"?o=skillEditorHtml("listening",{includeVocab:!1,scriptValue:s.script||"",scriptPlaceholder:"Script t\u1EF1 \u0111\u1ED9ng \u0111i\u1EC1n sau khi upload audio",scriptRows:6}):s.skill==="writing"?o=skillEditorHtml("writing",{}):s.skill==="speaking"&&(o=skillEditorHtml("speaking",{})),i=`
  ...
  `,e){const s=_cqSections[_cqEditingIdx];if(initContentComposer(s.content_blocks||[],""),s.skill==="listening"&&_renderAudioSlots(),s.skill==="reading"||s.skill==="listening"){s.questions_data?.length>0&&renderAnswerGridWithData(s.questions_data);const o=document.getElementById("answer-count");o&&o.addEventListener("input",()=>{const a=parseInt(o.value)||0;a>0&&a<=100&&renderAnswerGrid(a)})}renderVocabList&&renderVocabList(),syncVocabEditorState&&syncVocabEditorState()}}window.renderCQSectionsUI=renderCQSectionsUI;function addCQSection(){_saveCQCurrentEditorState(),_cqSections.push(_newCQSection()),_cqEditingIdx=_cqSections.length-1,_contentBlocks=[],_vocabItems=[],_editingVocabIndex=-1,_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioUploading=!1,renderCQSectionsUI()}window.addCQSection=addCQSection;function editCQSection(t){_saveCQCurrentEditorState(),_cqEditingIdx=t,_loadCQSectionIntoEditor(t),renderCQSectionsUI()}window.editCQSection=editCQSection;function saveCQSection(){const t=document.getElementById("cq-label");if(!t||!t.value.trim()){toast("Vui l\xF2ng \u0111\u1EB7t t\xEAn ph\u1EA7n thi","error");return}const e=document.getElementById("cq-skill");if(!e?.value){toast("Vui l\xF2ng ch\u1ECDn k\u1EF9 n\u0103ng","error");return}const n=e.value;if(n==="listening"){if(_audioSlots.filter(s=>s.status==="done").length===0){toast("Ph\u1EA7n Listening c\u1EA7n \xEDt nh\u1EA5t 1 file audio","error");return}if(_audioUploading){toast("Audio v\u1EABn \u0111ang upload, vui l\xF2ng \u0111\u1EE3i xong r\u1ED3i l\u01B0u","warning");return}}const i=()=>{_cqSections[_cqEditingIdx].skill=n,_saveCQCurrentEditorState(),_cqEditingIdx=-1,_contentBlocks=[],_vocabItems=[],_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,renderCQSectionsUI()};if(n==="reading"||n==="listening"){const s=checkEmptyAnswers();if(s.length>0){confirmSaveWithEmptyAnswers(s,i);return}}i()}window.saveCQSection=saveCQSection;function cancelCQEdit(){_cqSections[_cqEditingIdx]?.skill===""&&_cqSections.splice(_cqEditingIdx,1),_cqEditingIdx=-1,_contentBlocks=[],_vocabItems=[],_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,renderCQSectionsUI()}window.cancelCQEdit=cancelCQEdit;function removeCQSection(t){_cqEditingIdx===t?(_cqEditingIdx=-1,_contentBlocks=[],_vocabItems=[],_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots):_cqEditingIdx>t&&_cqEditingIdx--,_cqSections.splice(t,1),renderCQSectionsUI()}window.removeCQSection=removeCQSection;function onCQSkillChange(t){_cqEditingIdx<0||(_saveCQCurrentEditorState(),_cqSections[_cqEditingIdx].skill=t,_cqSections[_cqEditingIdx].questions_data=[],_cqSections[_cqEditingIdx].content_blocks=[],_cqSections[_cqEditingIdx].content_url=null,_cqSections[_cqEditingIdx].content_urls=[],_cqSections[_cqEditingIdx].script="",_contentBlocks=[],_vocabItems=[],_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioUploading=!1,renderCQSectionsUI())}window.onCQSkillChange=onCQSkillChange;async function showCompositeSubmissions({id:t}){setLoading("\u0110ang t\u1EA3i \u0111\u1EC1 t\u1ED5ng h\u1EE3p...");const e=routeToken();try{const n=await api.get(`/assignments/${t}/composite-submissions`);if(routeChanged(e))return;renderCompositeSubmissions(n)}catch(n){if(routeChanged(e))return;renderRouteError("Kh\xF4ng t\u1EA3i \u0111\u01B0\u1EE3c d\u1EEF li\u1EC7u",n,"/classes")}}window.showCompositeSubmissions=showCompositeSubmissions;function renderCompositeSubmissions({assignment:t,sections:e,perStudent:n}){const i=t,s=t?.id||"",o={reading:"\u{1F4D6}",listening:"\u{1F3A7}",writing:"\u270D\uFE0F",speaking:"\u{1F3A4}"},a=e.length,r=n.length===0?`<tr><td colspan="${a+2}" style="text-align:center;padding:24px;color:var(--gray-400)">L\u1EDBp ch\u01B0a c\xF3 h\u1ECDc sinh</td></tr>`:n.map(l=>{const c=e.map(d=>{const u=l.sections.find(f=>f.section_id===d.id)?.submission;if(!u)return'<td style="text-align:center;color:var(--gray-400)">\u2014</td>';const m=u.score!=null?`<span style="font-weight:700;color:var(--primary)">${u.score}/9</span>`:`<span style="color:var(--gray-400);font-size:12px">${d.skill==="reading"||d.skill==="listening"?"\u2014":"Ch\u1EDD ch\u1EA5m"}</span>`,h=u.is_overtime?'<span class="stats-overtime-pill" style="display:block;font-size:10px;margin-top:2px">OT</span>':"",g=d.skill==="writing"||d.skill==="speaking"?`<button class="btn btn-sm btn-outline" style="font-size:11px;padding:2px 6px;margin-top:2px"
    ...
    <div class="table-wrap" style="overflow-x:auto">
      <table>
        <thead><tr>
          <th>H\u1ECDc sinh</th>
          ${e.map(l=>`<th style="text-align:center;min-width:110px">${o[l.skill]||""} ${escapeHtml(l.label)}</th>`).join("")}
