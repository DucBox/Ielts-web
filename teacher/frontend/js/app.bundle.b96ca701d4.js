...
`),o=new Blob(["\uFEFF"+i],{type:"text/csv;charset=utf-8;"}),s=URL.createObjectURL(o),a=document.createElement("a");a.href=s,a.download=t,a.click(),URL.revokeObjectURL(s)}async function downloadAudioFile(t,e,n){if(!t)return;const i=n?n.innerHTML:"";try{n&&(n.disabled=!0,n.innerHTML="\u23F3");const o=await fetch(t,{cache:"no-store"});if(!o.ok)throw new Error("fetch failed");const s=await o.blob(),a=(t.split("?")[0].match(/\.([a-zA-Z0-9]+)$/)||[])[1],r=(s.type.split("/")[1]||"").split(";")[0],l=a||r||"webm",c=(e||"audio").replace(/\.[a-zA-Z0-9]{2,5}$/,""),d=URL.createObjectURL(s),u=document.createElement("a");u.href=d,u.download=`${c}.${l}`,document.body.appendChild(u),u.click(),u.remove(),URL.revokeObjectURL(d)}catch(o){toast("T\u1EA3i file th\u1EA5t b\u1EA1i: "+(o.message||"l\u1ED7i kh\xF4ng x\xE1c \u0111\u1ECBnh"),"error")}finally{n&&(n.disabled=!1,n.innerHTML=i)}}window.downloadAudioFile=downloadAudioFile;const AUDIO_SKIP_SECONDS=10,AUDIO_SPEEDS=[1,1.25,1.5,2,2.5,3];function _audioBlockTrack(t){return t?.closest?.(".audio-block")?.querySelector("audio")||null}function nudgeAudio(t,e){const n=_audioBlockTrack(t);if(!n)return;const i=Number.isFinite(n.duration)?n.duration:1/0;n.currentTime=Math.min(i,Math.max(0,n.currentTime+e))}window.nudgeAudio=nudgeAudio;function setAudioRate(t){const e=_audioBlockTrack(t);e&&(e.playbackRate=Number(t.value)||1)}window.setAudioRate=setAudioRate;function audioPlayerBlock(t){return`<div class="audio-block">
    ...
    </div>`,O=c.filter(p=>!p.is_active&&p.deadline),D=_closedAssignsSearch?O.filter(p=>p.title.toLowerCase().includes(_closedAssignsSearch)):O,G=3,R=_closedAssignsExpanded?D:D.slice(0,G),it=D.length-R.length,ot=O.length===0?"":`
    <div class="stats-section-card">
    ...
    <div class="stats-section-card">
      ...
      ${c.length===0?'<div class="empty-state" style="padding:20px">Kh\xF4ng c\xF3 b\xE0i t\u1EADp ph\xF9 h\u1EE3p</div>':`<div class="table-wrap">
          <table class="stats-table">
            ...
            <tbody>
              ${W.map(p=>{const v=U(p.submitted,p.total);return`<tr>
...
`),s=new Blob(["\uFEFF"+o],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(s),r=document.createElement("a");r.href=a,r.download=`${t.title.replace(/[^a-zA-Z0-9_\-]/g,"_")}_diem.csv`,r.click(),URL.revokeObjectURL(a)}window.exportSubmissionsCSV=exportSubmissionsCSV;function buildSubmissionRows(t,e){return t.length===0?`<tr><td colspan="5">
     ...
     </td></tr>`:t.map(n=>{const i=!!n.submission_id,o=n.overall_score!=null?`<span style="font-weight:700;color:var(--primary)">${n.overall_score}${e.scoring_scale==="10"?"/10":"/9"}</span>`:i?'<span style="color:var(--gray-400)">Ch\u1EDD ch\u1EA5m</span>':"\u2014",s=i?'<span class="badge" style="background:#d1fae5;color:#065f46">\u2713 \u0110\xE3 n\u1ED9p</span>':'<span class="badge" style="background:#fee2e2;color:#991b1b">\u2717 Ch\u01B0a n\u1ED9p</span>',a=i?`<button class="btn btn-sm btn-outline"
        ...
        \u270F\uFE0F Giao di\u1EC7n ch\u1EA5m v\xE0 nh\u1EADn x\xE9t writing s\u1EBD c\xF3 \u1EDF phi\xEAn b\u1EA3n ti\u1EBFp theo.
          ...
          <div style="${o?"margin-bottom:10px":""}">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:8px">
              ...
              <button type="button" class="btn-icon" title="T\u1EA3i xu\u1ED1ng" aria-label="T\u1EA3i xu\u1ED1ng" onclick="downloadAudioFile('${escapeJsAttr(r.url||"")}', '${escapeJsAttr((t.student_name||"speaking")+"_"+(r.name||"phan"+(l+1)))}', this)">\u{1F4E5}</button>
            </div>
            ${audioPlayerBlock(`<audio controls src="${escapeHtml(r.url||"")}" style="width:100%;border-radius:8px"></audio>`)}
...
- Gi\u1EA3i th\xEDch: gi\u1EA3i th\xEDch C\u1EF0C K\u1EF2 CHI TI\u1EBET v\xEC sao \u0111\xE1p \xE1n \u0111\xF3 \u0111\xFAng, kh\xF4ng ch\u1EC9 n\xEAu k\u1EBFt qu\u1EA3 m\xE0 ph\u1EA3i gi\xFAp ng\u01B0\u1EDDi l\xE0m b\xE0i hi\u1EC3u s\xE2u, hi\u1EC3u k\u1EF9, kh\xF4ng b\u1ECB l\u1EEBa l\u1EA7n sau. C\u1EE5 th\u1EC3 ph\u1EA3i c\xF3 \u0111\u1EE7:
  (1) Ch\u1EC9 r\xF5 t\u1EEB kho\xE1/c\u1EE5m t\u1EEB trong c\xE2u h\u1ECFi \u0111\u01B0\u1EE3c paraphrase (di\u1EC5n \u0111\u1EA1t l\u1EA1i) t\u1EEB c\u1EE5m n\xE0o trong Location, \xE1nh x\u1EA1 r\xF5 r\xE0ng gi\u1EEFa ng\xF4n ng\u1EEF c\xE2u h\u1ECFi v\xE0 ng\xF4n ng\u1EEF trong b\xE0i.
  (2) Tr\xECnh b\xE0y logic suy lu\u1EADn t\u1EEBng b\u01B0\u1EDBc d\u1EABn t\u1EDBi \u0111\xE1p \xE1n \u2014 v\xEC sao c\xE1c d\u1EEF ki\u1EC7n trong Location d\u1EABn \u0111\u1EBFn k\u1EBFt lu\u1EADn \u0111\xF3, kh\xF4ng ch\u1EC9 kh\u1EB3ng \u0111\u1ECBnh su\xF4ng.
  (3) N\u1EBFu trong \u0111o\u1EA1n v\u0103n c\xF3 th\xF4ng tin g\xE2y nhi\u1EC5u, d\u1EC5 nh\u1EA7m l\u1EABn, ho\u1EB7c ph\u01B0\u01A1ng \xE1n sai tr\xF4ng h\u1EE3p l\xFD, PH\u1EA2I ch\u1EC9 r\xF5 \u0111\xF3 l\xE0 b\u1EABy g\xEC v\xE0 v\xEC sao n\xF3 sai, \u0111\u1EC3 ng\u01B0\u1EDDi h\u1ECDc tr\xE1nh ch\u1ECDn nh\u1EA7m \u1EDF l\u1EA7n sau.
  (4) V\u0103n phong r\xF5 r\xE0ng, d\u1EC5 hi\u1EC3u v\u1EDBi ng\u01B0\u1EDDi \u0111ang luy\u1EC7n band 6.5-8.0, \u0111\u1EE7 s\xE2u \u0111\u1EC3 hi\u1EC3u b\u1EA3n ch\u1EA5t ch\u1EE9 kh\xF4ng h\u1ECDc thu\u1ED9c m\xE1y m\xF3c.
  Lu\xF4n b\xE1m s\xE1t n\u1ED9i dung th\u1EADt trong b\xE0i \u0111\u1ECDc/script, tuy\u1EC7t \u0111\u1ED1i kh\xF4ng suy di\u1EC5n hay th\xEAm th\xF4ng tin ngo\xE0i b\xE0i.
