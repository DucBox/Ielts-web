          ...
          <table class="stats-table">
            ...
            <tbody>
              ${P.map(p=>{const v=U(p.submitted,p.total),b=p.on_time_rate!==null?Math.round(p.on_time_rate*100):null;return`<tr>
                  ...
                  <td><span class="stats-score-badge">${D(p.avg_score)}</span></td>
                  ${o?"":`
                    <td style="color:#3b82f6">${D(p.avg_reading)}</td>
                    <td style="color:#f59e0b">${D(p.avg_listening)}</td>
                    <td style="color:#8b5cf6">${D(p.avg_writing)}</td>
                    <td style="color:#22c55e">${D(p.avg_speaking)}</td>`}
