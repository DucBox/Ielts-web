        ...
        \u270F\uFE0F Giao di\u1EC7n ch\u1EA5m v\xE0 nh\u1EADn x\xE9t writing s\u1EBD c\xF3 \u1EDF phi\xEAn b\u1EA3n ti\u1EBFp theo.
          ...
          <div style="${s?"margin-bottom:10px":""}">
            <div style="display:flex;align-items:center;justify-content:space-between;gap:8px">
              ${s?`<div style="font-size:12px;font-weight:600;color:var(--gray-500)">${escapeHtml(l.name||"Ph\u1EA7n "+(r+1))}</div>`:"<div></div>"}
              <button type="button" class="btn-icon" title="T\u1EA3i xu\u1ED1ng" onclick="downloadAudioFile('${escapeHtml(l.url||"")}', '${escapeHtml((t.student_name||"speaking")+"_"+(l.name||"phan"+(r+1)))}', this)">\u{1F4E5}</button>
            </div>
...
`?(n.push(i),i="",e.push(n),n=[]):i+=a)}return(i.length>0||n.length>0)&&(n.push(i),e.push(n)),e.filter(o=>o.some(a=>String(a).trim()!==""))}function vocabHeaderLevenshtein(t,e){const n=t.length,i=e.length;if(n===0)return i;if(i===0)return n;const s=Array.from({length:n+1},()=>new Array(i+1).fill(0));for(let o=0;o<=n;o++)s[o][0]=o;for(let o=0;o<=i;o++)s[0][o]=o;for(let o=1;o<=n;o++)for(let a=1;a<=i;a++)s[o][a]=t[o-1]===e[a-1]?s[o-1][a-1]:1+Math.min(s[o-1][a-1],s[o-1][a],s[o][a-1]);return s[n][i]}const VOCAB_CANONICAL_FIELDS=["word","definition","pronunciation","collocation","example"];function normalizeVocabHeader(t){return String(t??"").toLowerCase().trim().replace(/[^a-z]/g,"")}function mapVocabHeaders(t){const e={word:null,definition:null,pronunciation:null,collocation:null,example:null},n=new Set;return t.forEach((i,s)=>{const o=normalizeVocabHeader(i);if(!o)return;let a=null,l=1/0;for(const r of VOCAB_CANONICAL_FIELDS){if(n.has(r))continue;const c=vocabHeaderLevenshtein(o,r);c<=1&&c<l&&(l=c,a=r)}a&&(e[a]=s,n.add(a))}),e}function setVocabImportStatus(t,e=""){const n=$("#vocab-import-status");n&&(n.className=`pdf-import-status${e?` is-${e}`:""}`,n.textContent=t)}async function handleVocabFileImport(t){const e=t?.files?.[0];if(t&&(t.value=""),!e)return;const n=(e.name.split(".").pop()||"").toLowerCase(),i=n==="csv"||e.type==="text/csv";if(!i&&!(n==="xlsx"||n==="xls")){setVocabImportStatus("Ch\u1EC9 h\u1ED7 tr\u1EE3 file .csv, .xlsx ho\u1EB7c .xls.","error"),toast("File kh\xF4ng h\u1EE3p l\u1EC7","error");return}setVocabImportStatus("\u0110ang \u0111\u1ECDc file...","loading");try{let o;if(i){const d=(await e.text()).replace(/^\uFEFF/,"");o=parseVocabCsvText(d)}else{const d=await ensureXlsxLoaded(),u=await e.arrayBuffer(),m=d.read(new Uint8Array(u),{type:"array"}),h=m.Sheets[m.SheetNames[0]];o=d.utils.sheet_to_json(h,{header:1,defval:"",raw:!1}).filter(g=>Array.isArray(g)&&g.some(v=>String(v).trim()!==""))}if(!o||o.length<2){setVocabImportStatus("File kh\xF4ng c\xF3 d\u1EEF li\u1EC7u (c\u1EA7n d\xF2ng ti\xEAu \u0111\u1EC1 + \xEDt nh\u1EA5t 1 d\xF2ng d\u1EEF li\u1EC7u).","error"),toast("File tr\u1ED1ng","error");return}const a=mapVocabHeaders(o[0]);if(a.word==null||a.definition==null){setVocabImportStatus('Kh\xF4ng t\xECm th\u1EA5y c\u1ED9t "word" v\xE0/ho\u1EB7c "definition" \u1EDF d\xF2ng ti\xEAu \u0111\u1EC1.',"error"),toast("Thi\u1EBFu c\u1ED9t b\u1EAFt bu\u1ED9c: word, definition","error");return}const l=[];let r=0;for(let d=1;d<o.length;d++){const u=o[d]||[],m=String(u[a.word]??"").trim(),h=String(u[a.definition]??"").trim();if(!m||!h){r++;continue}const g={word:m,definition:h};for(const v of["pronunciation","collocation","example"]){const k=a[v];if(k==null)continue;const y=String(u[k]??"").trim();y&&(g[v]=y)}l.push(g)}if(l.length===0){setVocabImportStatus("Kh\xF4ng c\xF3 d\xF2ng d\u1EEF li\u1EC7u h\u1EE3p l\u1EC7 (c\u1EA7n \u0111\u1EE7 word + definition).","error"),toast("Kh\xF4ng import \u0111\u01B0\u1EE3c d\xF2ng n\xE0o","error");return}_vocabItems.push(...l),renderVocabList(),scheduleQuestionDraftSave();const c=r>0?`, b\u1ECF qua ${r} d\xF2ng thi\u1EBFu d\u1EEF li\u1EC7u`:"";setVocabImportStatus(`\u0110\xE3 import ${l.length} t\u1EEB v\u1EF1ng t\u1EEB "${e.name}"${c}.`,"success"),toast(`\u0110\xE3 import ${l.length} t\u1EEB v\u1EF1ng`)}catch(o){console.error("Vocab import failed:",o);const a=o?.message||"Kh\xF4ng th\u1EC3 \u0111\u1ECDc file n\xE0y.";setVocabImportStatus(a,"error"),toast(a,"error")}}function showQuestionForm(){_audioSlots=[_newAudioSlot()],_audioFiles=_audioSlots,_audioFile=null,_audioUploadUrl=null,_audioUploadKey=null,_audioUploadName="",_audioUploadSize=0,_audioUploading=!1,_editingVocabIndex=-1,$("#app").innerHTML=`
    <a class="back-link" onclick="navigate('/questions')">\u2190 Kho \u0111\u1EC1</a>
